	  ...
	  \chapter{Perplex Arithmetic}
		    ...
		    \procedure{thu0602201510}
				...
				\declaration{sun1602200918}
				  The phrases "$a$ and $b$ intersect", "$a$ and $b$ adjoin", and "$a$ and $b$ are disjoint", where $a$ and $b$ are perplex numbers, will be used to paraphrase the relations $\lVert b-\conj{a}\rVert^2\le 0$, $\lVert b-\conj{a}\rVert^2=0$, and $\lVert b-\conj{a}\rVert^2\ge 0$ respectively.
