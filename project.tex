		...
		\procedure{thu2208191859}
		  ...
		  \implementation
		    \begin{instructions}
		      ...
		      \begin{instructions}
		        \item Execute procedure $q_1$ on $\langle x,n,\delta\rangle$.
		        \item Hence verify that $[(1+(1+(-2)(x+1)^{-1}))_n^f\cdot(-f)(1-(1+(-2)(x+1)^{-1}))_n^{-f-1}\cdot(-1)(0+(-2)(-1)(x+1)^{-2}(1+0))]+[f(1+(1+(-2)(x+1)^{-1}))_n^{f-1}\cdot(0+(-2)(-1)(x+1)^{-2}(1+0))\cdot(1-(1+(-2)(x+1)^{-1}))_n^{-f}]$
		        \begin{instructions}
