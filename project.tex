...
\begin{document}
	...
	\begin{minipage}[c]{0.65\textwidth}
		\begin{tikzpicture}[scale=1.25,every node/.style={scale=0.9}]
			...
			\draw (1,-0.100000) node[anchor=north,fill=white]{$1$};
			\draw (-0.100000,1) node[anchor=east,fill=white]{$i$};
			\draw (1.000000,0.000000) node[anchor=south west,fill=white]{$\exp_{30}(\frac{0}{10}\tau_{10}i)$};
			\filldraw (1.000000,0.000000) circle (2pt);
			\draw (0,0) -- (1.000000,0.000000);
			\draw (0.791604,0.623136) node[anchor=south west,fill=white]{$\exp_{30}(\frac{1}{10}\tau_{10}i)$};
			\filldraw (0.791604,0.623136) circle (2pt);
			\draw (0,0) -- (0.791604,0.623136);
			\draw (0.242553,1.001108) node[anchor=south west,fill=white]{$\exp_{30}(\frac{2}{10}\tau_{10}i)$};
			\filldraw (0.242553,1.001108) circle (2pt);
			\draw (0,0) -- (0.242553,1.001108);
			\draw (-0.442850,0.972791) node[anchor=south east,fill=white]{$\exp_{30}(\frac{3}{10}\tau_{10}i)$};
			\filldraw (-0.442850,0.972791) circle (2pt);
			\draw (0,0) -- (-0.442850,0.972791);
			\draw (-0.997912,0.520351) node[anchor=south east,fill=white]{$\exp_{30}(\frac{4}{10}\tau_{10}i)$};
			\filldraw (-0.997912,0.520351) circle (2pt);
			\draw (0,0) -- (-0.997912,0.520351);
			\draw (-1.182928,-0.214887) node[anchor=north east,fill=white]{$\exp_{30}(\frac{5}{10}\tau_{10}i)$};
			\filldraw (-1.182928,-0.214887) circle (2pt);
			\draw (0,0) -- (-1.182928,-0.214887);
			\draw (-0.872691,-0.967418) node[anchor=north east,fill=white]{$\exp_{30}(\frac{6}{10}\tau_{10}i)$};
			\filldraw (-0.872691,-0.967418) circle (2pt);
			\draw (0,0) -- (-0.872691,-0.967418);
			\draw (-0.115353,-1.427214) node[anchor=north east,fill=white]{$\exp_{30}(\frac{7}{10}\tau_{10}i)$};
			\filldraw (-0.115353,-1.427214) circle (2pt);
			\draw (0,0) -- (-0.115353,-1.427214);
			\draw (0.858648,-1.344725) node[anchor=north west,fill=white]{$\exp_{30}(\frac{8}{10}\tau_{10}i)$};
			\filldraw (0.858648,-1.344725) circle (2pt);
			\draw (0,0) -- (0.858648,-1.344725);
			\draw (1.687338,-0.632350) node[anchor=north west,fill=white]{$\exp_{30}(\frac{9}{10}\tau_{10}i)$};
			\filldraw (1.687338,-0.632350) circle (2pt);
			\draw (0,0) -- (1.687338,-0.632350);
		\end{tikzpicture}
	\end{minipage}
	\begin{minipage}[c]{0.35\textwidth}
