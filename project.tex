	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \item For $r\in[2:k]$, verify that $\frac{f(r+1)}{f(r)}$:
	          \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $=\frac{1}{\lVert x+1\rVert^2}(f(k)-f(k)+f(2)+f(2)+f(1)-f(1))^2$
	            \item $=\frac{1}{n^2\lVert x+1\rVert^2}$
	            \item $=\frac{1}{n^2((\Re(x)+1)^2+\Im(x)^2)}$
	            \item $\le\frac{1}{n^2X^2}$
	            \item $=(\frac{A}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle A,p\rangle$.}
