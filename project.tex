...
\begin{document}
	...
	\begin{multicols}{2}
	  ...
	  \procedure{fri2607191801}
		...
		\procedure{3.53}
			\objective
				The objective of the following instructions is to construct positive rational numbers $a,b,c,d,e$ such that $b>1$, and a procedure $p(k,n)$ to show that $\lVert\exp_n(\frac{1}{4}\tau_ki)-i\rVert^2\le(\frac{ab^n}{k}+\frac{c}{n})^2$ when integers $k,n$ such that $n>e$ and $k>d$ are chosen.
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{fri2607191801} on $\langle 1\rangle$ and let $\langle a_4,b,c_4,d,e_4,p_4\rangle$ receive.
					...
					\begin{enumerate}
					  ...
					  \item Execute procedure $p_4$ on $\langle i,k,n\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))-(1+i)\rVert^2\le(\frac{a_4b^n}{k}+\frac{c_4}{n})^2$.
					  \item Execute procedure $p_3$ on $\langle\ln_k(1+i),n\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))\rVert^2\ge a_3$.
					  \item Hence verify that $\lVert\frac{\exp_n(\ln_k(1+i))}{\exp_n(\ln_k(1+i))}-\frac{1+i}{\exp_n(\ln_k(1+i))}\rVert^2\le\frac{1}{{a_3}^2}(\frac{a_4b^n}{k}+\frac{c_4}{n})^2$.
					  \item Also verify that $\lVert\frac{1+i}{\conj{\exp_n(\ln_k(1+i))}}-\frac{1+i}{\conj{1+i}}\rVert^2=\lVert\frac{(1+i)(\conj{(1+i)-\exp_n(\ln_k(1+i))})}{\conj{\exp_n(\ln_k(1+i))(1+i)}}\rVert^2\le\frac{1}{{a_3}^2}(\frac{a_4b^n}{k}+\frac{c_4}{n})^2$.
					  ...
					  \begin{enumerate}
					    ...
					    \item $\le(\frac{a_2}{n}+\frac{2}{a_3}(\frac{a_4b^n}{k}+\frac{c_4}{n}))^2$
					    \item $=(\frac{ab^n}{k}+\frac{c}{n})^2$.
					  \end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,c,d,e,p\rangle$.}
				\end{enumerate}
