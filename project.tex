...
\newglossaryentry{differentialintegral}{name=\ensuremath{\int_r^Rf(\#r,r,dr)},description={Riemann sum}}
...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\procedure{thu2507191307}
		  \objective
		    Choose a rational number $X\ge 0$. The objective of the following instructions is to construct positive rational numbers $a,b$, and a procedure $p(x,y,n)$ to show that $\lVert\exp_n(y)-\exp_n(x)\rVert^2\le\lVert x-y\rVert^2a^2$ when two complex numbers $x,y$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X$ and $\lVert y\rVert^2\le X$ are chosen.
		  \implementation
		    \begin{enumerate}
		...
		\procedure{3.24}
			...
			\implementation
				\begin{enumerate}
					...
					\item Let $p(x,y,n)$ be the following procedure:
					\begin{enumerate}
						\item Verify that $\lVert ix\rVert^2\le X^2$.
						\item Verify that $\lVert iy\rVert^2\le X^2$.
						\item Execute procedure $q$ on $\langle ix,iy,n\rangle$.
						\item Hence verify that $\lVert\exp_n(ix)\exp_n(iy)-\exp_n(ix+iy)\rVert^2\le\frac{a^2\lVert i^2xy\rVert^2}{n^2}=\frac{a^2\lVert xy\rVert^2}{n^2}$.
						\item Verify that $\lVert -ix\rVert^2\le X$.
						\item Verify that $\lVert -iy\rVert^2\le X$.
						\item Execute procedure $q$ on $\langle -ix,-iy,n\rangle$.
						\item Hence verify that $\lVert\exp_n(-ix)\exp_n(-iy)-\exp_n(-ix-iy)\rVert^2\le\frac{a^2\lVert (-i)^2xy\rVert^2}{n^2}=\frac{a^2\lVert xy\rVert^2}{n^2}$.
						...
						\begin{enumerate}
							...
							\item $\le\frac{a^2\lVert xy\rVert^2}{n^2}$.
						\end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
				\end{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence verify that $\lVert\exp_n(ix)\exp_n(-ix)-\exp_n(ix-ix)\rVert^2\le\frac{a^2\lVert-i^2x^2\rVert^2}{n^2}=\frac{a^2\lVert x\rVert^4}{n^2}$.
						...
						\begin{enumerate}
							...
							\item $\le\frac{a^2\lVert x\rVert^4}{n^2}$.
						\end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
				\end{enumerate}
		\procedure{sat0308190647}
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \begin{enumerate}
		        \item Execute procedure $q$ on $\langle y,n\rangle$.
		        \item Hence verify that $\lVert\cos_n(y)^2+\sin_n(y)^2-1\rVert^2\le\frac{a^2\lVert y\rVert^4}{n^2}$.
		        \item Hence using \procedurehr{3.22} and \procedurehr{3.23}, verify that $\lVert\lVert x\exp_n(iy)\rVert^2-\lVert x\rVert^2\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert\lVert x\rVert^2\lVert\exp_n(iy)\rVert^2-\lVert x\rVert^2\rVert^2$
		          \item $=\lVert x\rVert^4\lVert\Re(\exp_n(iy))^2+\Im(\exp_n(iy))^2-1\rVert^2$
		          \item $=\lVert x\rVert^4\lVert\cos_n(y)^2+\sin_n(y)^2-1\rVert^2$
		          \item $\le\frac{a^2\lVert y\rVert^4\lVert x\rVert^4}{n^2}$.
		        \end{enumerate}
		      \end{enumerate}
		    \end{enumerate}
		\procedure{3.29}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence verify that $\lVert\sum_r^{[0:{n+1}]}\frac{(ix)^r}{r!}-\exp_n(ix)\rVert^2\le(\frac{a}{n})^2$.
						\item Verify that $\lVert -ix\rVert^2=\lVert x\rVert^2\le X$.
						\item Execute procedure $q$ on $\langle -ix,n\rangle$.
						\item Hence verify that $\lVert\sum_r^{[0:{n+1}]}\frac{(-ix)^r}{r!}-\exp_n(-ix)\rVert^2\le(\frac{a}{n})^2$.
						\item Hence using \procedurehr{3.04}, verify that $\lVert\sum_r^{[0:{\lceil\frac{n}{2}\rceil}]}\frac{(-1)^rx^{2r}}{(2r)!}-\cos_n(x)\rVert^2$
						\begin{enumerate}
							\item $=\lVert\sum_r^{[0:{n+1}]}\frac{[r\bmod 2=0](-1)^{\frac{r}{2}}x^{r}}{r!}-\cos_n(x)\rVert^2$
							...
							\item $\le\frac{1}{2}((\frac{a}{n})^2+(\frac{a}{n})^2)$
							\item $\le(\frac{a}{n})^2$.
						\end{enumerate}
					\end{enumerate}
				\end{enumerate}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \item Hence verify that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_k^{[1:n]}\sum_r^{[k:n]}\binom{a}{k+n-1-r}\binom{b}{r}x^{k+n-1}\rVert^2$
	            \item $=\lVert\sum_k^{[1:n]}\sum_r^{[k:n]}\binom{a}{k+n-1-r}x^{k+n-1-r}\binom{b}{r}x^r\rVert^2$
	            \item $\le(\sum_k^{[1:n]}\sum_r^{[k:n]}BC^{k+n-1-r}BC^r)^2$
	            \item $=(B^2C^n\sum_k^{[1:n]}\sum_r^{[k:n]}C^{k-1})^2$
	            \item $=(B^2C^n\sum_r^{[1:n]}\sum_k^{[1:r+1]}C^{k-1})^2$
	            \item $\le(B^2C^n\sum_r^{[1:n]}\frac{1}{1-C})^2$
	            \item $<(\frac{B^2}{1-C}\cdot nC^n)^2$
	            \item $\le(\frac{B^2F}{1-C}G^n)^2$
	            \item $=(DG^n)^2$.
	          \end{enumerate}
	        \end{enumerate}
	      \end{enumerate}
	  ...
	  \procedure{tue2008190849}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Let $p(x,a,b,n)$ be the following procedure:
	        \begin{enumerate}
	          \item Execute procedure $p_2$ on $\langle x,b,n\rangle$.
	          \item Hence verify that $\lVert(1+x)_n^b\rVert^2\ge{a_2}^2$.
	          \item Execute procedure $p_1$ on $\langle x,b,-b,n\rangle$.
	          \item Hence verify that $\lVert(1+x)_n^b(1+x)_n^{-b}-1\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert(1+x)_n^b(1+x)_n^{-b}-(1+x)_n^{b-b}\rVert^2$
	            \item $\le(a_1{C}^n)^2$.
	          \end{enumerate}
	          \item Hence verify that $\lVert(1+x)_n^{-b}-\frac{1}{(1+x)_n^b}\rVert^2$
	          \begin{enumerate}
	            \item $=\frac{\lVert(1+x)_n^b(1+x)_n^{-b}-1\rVert^2}{\lVert(1+x)_n^b\rVert^2}$
	            \item $\le(\frac{a_1{C}^n}{a_2})^2$.
	          \end{enumerate}
	          \item Execute procedure $p_3$ on $\langle x,n,a,1\rangle$.
	          \item Hence verify that $\lVert((1+x)_n^a)^1\rVert^2\le{a_3}^2$.
	          \item Execute procedure $p_1$ on $\langle x,a,-b,n\rangle$.
	          \item Hence verify that $\lVert(1+x)_n^a(1+x)_n^{-b}-(1+x)_n^{a-b}\rVert^2\le(a_1{C}^n)^2$.
	          \item Hence verify that $\lVert(1+x)_n^{a-b}-\frac{(1+x)_n^a}{(1+x)_n^b}\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert(1+x)_n^{a-b}-(1+x)_n^a(1+x)_n^{-b}+(1+x)_n^a((1+x)_n^{-b}-\frac{1}{(1+x)_n^b})\rVert^2$
	            \item $\le(a_1{C}^n+a_3\cdot\frac{a_1{C}^n}{a_2})^2$
	            \item $=((1+\frac{a_3}{a_2})a_1{C}^n)^2$
	            \item $=(BC^n)^2$.
	          \end{enumerate}
	        \end{enumerate}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          \item If $k>0$, then for $r\in[1:k]$ do the following:
	          \begin{enumerate}
	            \item Verify that $\lVert ar\rVert^2\le\lVert ak\rVert^2<A^2$.
	            \item Execute procedure $t$ on $\langle x,n,a,r\rangle$.
	            \item Hence verify that $\lVert((1+x)_n^a)^r\rVert^2<D^2$.
	          \end{enumerate}
	          \item For $r$ in $[0:k]$, do the following:
	          \begin{enumerate}
	            \item Verify that $\lVert a\rVert^2\le\lVert ka\rVert^2<A^2$.
	            \item Verify that $\lVert(k-r-1)a\rVert^2\le\lVert ka\rVert^2<A^2$.
	            \item Execute procedure $q$ on $\langle x,a,(k-r-1)a,n\rangle$.
	            \item Hence verify that $\lVert(1+x)_n^a(1+x)_n^{(k-r-1)a}-(1+x)_n^{(k-r)a}\rVert^2\le(BC^n)^2$.
	          \end{enumerate}
	          \item Hence verify that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[0:k]}(((1+x)_n^a)^r(1+x)_n^{(k-r)a}-((1+x)_n^a)^{r+1}(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $=\lVert\sum_r^{[0:k]}((1+x)_n^a)^r((1+x)_n^{(k-r)a}-(1+x)_n^a(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $\le(\sum_r^{[0:k]}DBC^n)^2$
	            \item $=(kDBC^n)^2$
	            \item $=(GkC^n)^2$.
	          \end{enumerate}
	        \end{enumerate}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \end{enumerate}
	          \item Hence using \procedurehr{sun2107191133}, verify that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_k^{[1:n]}\sum_r^{[k:n]}\binom{a}{k+n-1-r}\binom{b}{r}x^{k+n-1}\rVert^2$
	            \item $=\lVert x^n\rVert^2\lVert\sum_r^{[1:n]}\binom{b}{r}\sum_k^{[0:r]}\binom{a}{k+n-r}x^k\rVert^2$
	            \item $=\lVert x^n\rVert^2\lVert\sum_r^{[1:n]}\binom{b}{r}\sum_k^{[0:r]}(\binom{a}{k+1+n-r}(-1)^{k+1}\cdot\frac{(-x)^{k+1}}{-x-1}-\binom{a}{k+n-r}(-1)^k\cdot\frac{(-x)^k}{-x-1}-\frac{(-x)^{k+1}}{-x-1}(\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k))\rVert^2$
	            \item $=\frac{\lVert x^n\rVert^2}{\lVert x+1\rVert^2}\lVert\sum_r^{[1:n]}\binom{b}{r}(\binom{a}{n}x^r-\binom{a}{n-r}-\sum_k^{[0:r]}(-x)^{k+1}(\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k))\rVert^2$
	            \item $\le\frac{1}{\Re(x+1)^2+\Im(x)^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\sum_k^{[0:r]}\lvert\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k\rvert))^2$
	            \item $\le\frac{1}{(1-X)^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\lvert\sum_k^{[0:r]}(\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k)\rvert))^2$
	            \item $=\frac{1}{(1-X)^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\lvert\binom{a}{n}(-1)^r-\binom{a}{n-r}\rvert))^2$
	            \item $=\frac{1}{(1-X)^2}(2\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert\lvert\binom{a}{n-r}\rvert)^2$
	            \item $=(\frac{2}{1-X})^2(\lvert\binom{a+b}{n}\rvert+\lvert\binom{a}{n}\rvert+\lvert\binom{b}{n}\rvert)^2$
	            \item $\le(\frac{B}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	      \end{enumerate}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          \item If $k>0$, then for $r\in[1:k]$ do the following:
	          \begin{enumerate}
	            \item Verify that $\lVert ar\rVert^2\le\lVert ak\rVert^2\le 1$.
	            \item Execute procedure $t$ on $\langle x,n,a,r\rangle$.
	            \item Hence verify that $\lVert((1+x)_n^a)^r\rVert^2\le D^2$.
	          \end{enumerate}
	          \item For $r\in[0:k]$, do the following:
	          \begin{enumerate}
	            \item Verify that $a^2\le(ka)^2\le 1$.
	            \item Verify that $((k-r-1)a)^2\le(ka)^2\le 1$.
	            \item Execute procedure $q$ on $\langle x,a,(k-r-1)a,n\rangle$.
	            \item Hence verify that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2\le(\frac{B}{n})^2$.
	          \end{enumerate}
	          \item Hence verify that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[0:k]}(((1+x)_n^a)^r(1+x)_n^{(k-r)a}-((1+x)_n^a)^{r+1}(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $=\lVert\sum_r^{[0:k]}((1+x)_n^a)^r((1+x)_n^{(k-r)a}-(1+x)_n^a(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $\le(\sum_r^{[0:k]}\frac{DB}{n})^2$
	            \item $=(\frac{Gk}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	  ...
	  \procedure{fri2607191210}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          \item Using \procedurehr{sun2107190619}, verify that $(1+x)_k^1=(1+x)^1=1+x$.
	          \item Execute procedure $p_1$ on $\langle x,k,\frac{1}{n},n\rangle$.
	          \item Hence verify that $\lVert(1+x)_k^1-((1+x)_k^{\frac{1}{n}})^n\rVert^2\le(\frac{an}{k})^2$.
	          \item Hence verify that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert(1+\frac{1}{n}(n((1+x)_k^{\frac{1}{n}}-1)))^n-(1+x)\rVert^2$
	            \item $=\lVert((1+x)_k^{\frac{1}{n}})^n-(1+x)_k^1\rVert^2$
	            \item $\le(\frac{an}{k})^2$.
	           \end{enumerate}
	        \end{enumerate}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \item Hence verify that $\lVert\ln_k(1+x)-n((1+x)_k^{\frac{1}{n}}-1)\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[1:k]}\frac{(-1)^{r-1}}{r}x^r-n(\sum_r^{[0:k]}\binom{\frac{1}{n}}{r}x^r-1)\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\frac{(-1)^{r-1}}{r}x^r-n\sum_r^{[1:k]}\binom{\frac{1}{n}}{r}x^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\frac{(-1)^{\ul{r-1}}}{r!}x^r-\sum_r^{[1:k]}\frac{(\frac{1}{n}-1)^{\ul{r-1}}}{r!}x^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\frac{1}{r!}((-1)^{\ul{r-1}}-(\frac{1}{n}-1)^{\ul{r-1}})x^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\frac{(-1)^{\ul{r-1}}}{r!}(1-\frac{(\frac{1}{n}-1)^{\ul{r-1}}}{(-1)^{\ul{r-1}}})x^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\frac{(-1)^{r-1}}{r}(1-\prod_t^{[1:r]}\frac{\frac{1}{n}-t}{-t})x^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}\omega(r)(-x)^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}(\omega(r+1)\cdot\frac{(-x)^{r+1}}{-x-1}-\omega(r)\cdot\frac{(-x)^r}{-x-1}-(\omega(r+1)-\omega(r))\cdot\frac{(-x)^{r+1}}{-x-1})\rVert^2$
	            \item $=\frac{1}{\lVert x+1\rVert^2}\lVert \omega(k)(-x)^k-\omega(1)(-x)^1-\sum_r^{[1:k]}(\omega(r+1)-\omega(r))(-x)^{r+1}\rVert^2$
	            \item $\le\frac{1}{\lVert x+1\rVert^2}(\omega(k)+\omega(1)+\sum_r^{[2:k]}(\omega(r)-\omega(r+1))+\omega(2)-\omega(1))^2$
	            \item $=\frac{1}{((\Re(x)+1)^2+\Im(x)^2)}(\omega(k)-\omega(k)+\omega(2)+\omega(2)+\omega(1)-\omega(1))^2$
	            \item $\le(\frac{a}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle a,p\rangle$.}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \item Hence verify that $\lVert n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le {a_1}^2$.
	          \item Execute procedure $p_2$ on $\langle x,k\rangle$.
	          \item Hence verify that $\lVert\ln_k(1+x)\rVert^2\le {a_2}^2$.
	          \item Execute procedure $p_4$ on $\langle x,n,k\rangle$.
	          \item Hence verify that $\lVert\ln_k(1+x)-n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le(\frac{a_4}{n})^2$.
	          \item Execute procedure $p_3$ on $\langle\ln_k(1+x),n((1+x)_k^{\frac{1}{n}}-1),n\rangle$.
	          \item Hence verify that $\lVert\exp_n(\ln_k(1+x))-\exp_n(n((1+x)_k^{\frac{1}{n}}-1))\rVert^2\le(\frac{a_4}{n})^2{a_3}^2=(\frac{c}{n})^2$.
	          \item Execute procedure $p_5$ on $\langle x,n,k\rangle$.
	          \item Hence verify that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{an}{k})^2$.
	          \item Hence verify that $\lVert\exp_n(\ln_k(1+x))-(1+x)\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\exp_n(\ln_k(1+x))-\exp_n(n((1+x)_k^{\frac{1}{n}}-1))+\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2$
	            \item $\le(\frac{c}{n}+\frac{an}{k})^2$.
	          \end{enumerate}
	        \end{enumerate}
		...
		\procedure{3.53}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
					  \item Execute procedure $p_1$ on $\langle i,k\rangle$.
					  \item Hence verify that $\lVert\ln_k(1+i)\rVert^2\le {a_1}^2$.
					  \item Execute procedure $p_2$ on $\langle\ln_k(1+i),\conj{\ln_k(1+i)},n\rangle$.
					  \item Hence  verify that $\lVert\exp_n(\ln_k(1+i)-\conj{\ln_k(1+i)})-\frac{\exp_n(\ln_k(1+i))}{\exp_n(\conj{\ln_k(1+i)})}\rVert^2\le\frac{{a_2}^2}{n^2}$.
					  \item Execute procedure $p_4$ on $\langle i,n,k\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))-(1+i)\rVert^2\le(\frac{a_4n}{k}+\frac{c_4}{n})^2$.
					  \item Execute procedure $p_3$ on $\langle\ln_k(1+i),n\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))\rVert^2\ge a_3$.
					  \item Hence verify that $\lVert\frac{\exp_n(\ln_k(1+i))}{\exp_n(\ln_k(1+i))}-\frac{1+i}{\exp_n(\ln_k(1+i))}\rVert^2\le\frac{1}{{a_3}^2}(\frac{a_4n}{k}+\frac{c_4}{n})^2$.
					  \item Also verify that $\lVert\frac{1+i}{\conj{\exp_n(\ln_k(1+i))}}-\frac{1+i}{\conj{1+i}}\rVert^2=\lVert\frac{(1+i)(\conj{(1+i)-\exp_n(\ln_k(1+i))})}{\conj{\exp_n(\ln_k(1+i))(1+i)}}\rVert^2\le\frac{1}{{a_3}^2}(\frac{a_4n}{k}+\frac{c_4}{n})^2$.
					  \item Hence verify that $\lVert\exp_n(\frac{1}{4}\tau_ki)-i\rVert^2$
					  \begin{enumerate}
					    \item $=\lVert\exp_n(2\Im(\ln_k(1+i))i)-i\rVert^2$
					    \item $=\lVert\exp_n(\ln_k(1+i)-\conj{\ln_k(1+i)})-i\rVert^2$
					    \item $=\lVert\exp_n(\ln_k(1+i)-\conj{\ln_k(1+i)})-\frac{\exp_n(\ln_k(1+i))}{\exp_n(\conj{\ln_k(1+i)})}+\frac{\exp_n(\ln_k(1+i))}{\exp_n(\conj{\ln_k(1+i)})}-\frac{1+i}{\conj{\exp_n(\ln_k(1+i))}}+\frac{1+i}{\conj{\exp_n(\ln_k(1+i))}}-\frac{1+i}{\conj{1+i}}\rVert^2$
					    \item $\le(\frac{a_2}{n}+\frac{2}{a_3}(\frac{a_4n}{k}+\frac{c_4}{n}))^2$
	...
	\begin{multicols}{2}
	  \procedure{tue2008191129}
	    \objective
	      ...
	      \begin{enumerate}
	        \item A procedure $q_1(x,n)$ to show that $\lVert p_n(x)\rVert^2\le{a_1}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>c_1$ are chosen.
	        \item A procedure $q_2(x,n)$ to show that $\lVert t_n(x)\rVert^2\le{a_2}^2$ when a complex number $x$ and a positive integer $n$ such that $R(x)$ and $n>c_2$ are chosen.
	      \end{enumerate}
	      The objective of the following instructions is to construct the following:
	      \begin{enumerate}
	        \item Rational numbers $a_3,b_3$.
	        \item A procedure $q_3(x,n)$ to show that $\lVert p_n(x)+t_n(x)\rVert^2\le{a_3}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$, $R(x)$, and $n>b_3$ are chosen.
	      \end{enumerate}
	    \implementation
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \item Hence verify that $\lVert p_n(x)\rVert^2\le{a_1}^2$.
	          \item Execute procedure $q_2$ on $\langle x,n\rangle$.
	          \item Hence verify that $\lVert t_n(x)\rVert^2\le{a_2}^2$.
	          \item Hence verify that $\lVert p_n(x)+t_n(x)\rVert^2\le(a_1+a_2)^2={a_3}^2$.
	        \end{enumerate}
	  ...
	  \declaration{3.29}
		...
		\procedure{mon1908191506}
		  \objective
		    Choose the following:
		    \begin{enumerate}
		      \item A procedure $q_0(x,n)$ to show that $\lVert p'_n(x)\rVert^2\le{a_0}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_0$ are chosen.
		      ...
		      \item A procedure $q_2(x,n)$ to show that $\lVert t'_n(x)\rVert^2\le{a_2}^2$ when a complex number $x$ and a positive integer $n$ such that $R(x)$ and $n>b_2$ are chosen.
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_4(x,n)$ to show that $\lVert p'_n(x)+t'_n(x)\rVert^2\le{a_4}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$, $R(x)$, and $n>b_4$ are chosen.
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \begin{enumerate}
		        ...
		        \item Hence verify that $\lVert\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x)\rVert^2\le(\frac{a_1}{n}+b_1\{\delta\})^2$.
		        \item Execute procedure $q_3$ on $\langle x,n,\delta\rangle$.
		        \item Hence verify that $\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)\rVert^2\le(\frac{a_3}{n}+b_3\{\delta\})^2$.
		        \item Hence verify that $\lVert\frac{(p_n(x+\delta)+t_n(x+\delta))-(p_n(x)+t_n(x))}{\delta}-(p'_n(x)+t'_n(x))\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert(\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x))+(\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x))\rVert^2$
		          \item $\le((\frac{a_1}{n}+b_1\{\delta\})+(\frac{a_3}{n}+b_3\{\delta\}))^2$
		          \item $=(\frac{a_5}{n}+b_5\{\delta\})^2$.
		        \end{enumerate}
		      \end{enumerate}
		      \item Let $q_4(x,n)$ be the following procedure:
		      \begin{enumerate}
		        \item Execute procedure $q_0$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert p'_n(x)\rVert^2\le {a_0}^2$.
		        \item Execute procedure $q_2$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t'_n(x)\rVert^2\le {a_2}^2$.
		        \item Hence verify that $\lVert p'_n(x)+t'_n(x)\rVert^2\le(a_0+a_2)^2$.
		      \end{enumerate}
		...
		\procedure{sat0308191134}
		  \objective
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_5(x,n)$ to show that $\lVert p'_n(t_n(x))t'_n(x)\rVert^2\le{a_5}^2$ when a complex number $x$ such that $R(x)$, and $n>b_5$ are chosen.
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \begin{enumerate}
		        ...
		        \item Verify that $\lVert t_n(x+\delta)-t_n(x)\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}\rVert^2\lVert\delta\rVert^2$
		          \item $=\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)+t'_n(x)\rVert^2\lVert\delta\rVert^2$
		          \item $\le(\frac{a_3}{n}+b_3\{\delta\}+a_2)^2\lVert\delta\rVert^2$
		          \item $\le(a_3+2b_3c_3+a_2)^2{c_6}^2$
		          \item $\le{c_1}^2$.
		        \end{enumerate}
		        \item Execute procedure $q_4$ on $\langle x,n\rangle$.
		        \item Hence verify that $P(t_n(x))$.
		        \item Execute procedure $q_1$ on $\langle t_n(x),n,t_n(x+\delta)-t_n(x)\rangle$.
		        \item Hence verify that $\lVert\frac{p_n(t_n(x)+(t_n(x+\delta)-t_n(x)))-p_n(t_n(x))}{t_n(x+\delta)-t_n(x)}-p'_n(t_n(x))\rVert^2\le(\frac{a_1}{n}+b_1\{\delta\})^2$.
		        \item Execute procedure $q_0$ on $\langle t_n(x),n\rangle$.
		        \item Hence verify that $\lVert p'_n(t_n(x))\rVert^2\le{a_0}^2$.
		        \item Verify that $\lVert\frac{p(t(x+\delta))-p(t(x))}{\delta}-p'(t(x))t'(x)\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}\cdot\frac{t(x+\delta)-t(x)}{\delta}-p'(t(x))t'(x)\rVert^2$
		          \item $=\lVert(\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}-p'(t(x)))\cdot\frac{t(x+\delta)-t(x)}{\delta}+p'(t(x))(\frac{t(x+\delta)-t(x)}{\delta}-t'(x))\rVert^2$
		          \item $=\lVert(\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}-p'(t(x)))\cdot(\frac{t(x+\delta)-t(x)}{\delta}-t'(x))+(\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}-p'(t(x)))\cdot t'(x)+p'(t(x))(\frac{t(x+\delta)-t(x)}{\delta}-t'(x))\rVert^2$
		          \item $\le((\frac{a_1}{n}+b_1\{\delta\})(\frac{a_3}{n}+b_3\{\delta\})+(\frac{a_1}{n}+b_1\{\delta\})a_2+a_0(\frac{a_3}{n}+b_3\{\delta\}))^2$
		          \item $\le(\frac{a_6}{n}+b_6\{\delta\})^2$.
		        \end{enumerate}
		      \end{enumerate}
		      ...
		      \begin{enumerate}
		        ...
		        \item Execute procedure $q_2$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t'_n(x)\rVert^2\le {a_2}^2$.
		        \item Hence verify that $\lVert p'_n(t_n(x))t'_n(x)\rVert^2\le(a_0a_2)^2={a_5}^2$.
		      \end{enumerate}
		...
		\procedure{tue2008191001}
		  \objective
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_1(x,n)$ to show that $\lVert p'_n(x)\rVert^2\le {a_1}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_1$ are chosen.
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_3(x,n)$ to show that $\lVert Bp'_n(x)\rVert^2\le{a_3}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_3$ are chosen.
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \begin{enumerate}
		        \item Execute procedure $q_1$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert Bp'_n(x)\rVert^2\le\{B\}^2{a_1}^2={a_3}^2$.
		      \end{enumerate}
		      \item Let $q_4(x,n,\delta)$ be the following procedure:
		      \begin{enumerate}
		        \item Execute procedure $q_4$ on $\langle x,n,\delta\rangle$.
		        \item Hence verify that $\lVert\frac{Bp_n(x+\delta)-Bp_n(x)}{\delta}-Bp'_n(x)\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert B\rVert^2\lVert\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x)\rVert^2$
		          \item $\le\{B\}^2(\frac{a_2}{n}+b_2\{\delta\})^2$
		          \item $=(\frac{a_4}{n}+b_4\{\delta\})^2$.
		        \end{enumerate}
		      \end{enumerate}
		...
		\procedure{mon1908191207}
		  \objective
		    Choose the following:
		    \begin{enumerate}
		      \item A procedure $q_0(x,n)$ to show that $\lVert p_n(x)\rVert^2\le{a_0}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_0$ are chosen.
		      \item A procedure $q_1(x,n)$ to show that $\lVert p'_n(x)\rVert^2\le {a_1}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_0$ are chosen.
		      ...
		      \item A procedure $q_3(x,n)$ to show that $\lVert t_n(x)\rVert^2\le{a_3}^2$ when a complex number $x$ and a positive integer $n$ such that $R(x)$ and $n>b_3$ are chosen.
		      \item A procedure $q_4(x,n)$ to show that $\lVert t'_n(x)\rVert^2\le {a_4}^2$ when a complex number $x$ and a positive integer $n$ such that $R(x)$ and $n>b_3$ are chosen.
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_6(x,n)$ to show that $\lVert p_n(x)t'_n(x)+p'_n(x)t_n(x)\rVert^2\le {a_6}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$, $R(x)$, and $n>b_6$ are chosen.
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \item Let $a_7=a_0a_5+a_6a_2$.
		      \item Let $b_7=a_2a_5+a_1a_5+a_4a_2+a_1a_4+a_0b_5+a_6b_2+2c_7(a_2b_5+b_2a_5+a_1b_5+a_4b_2)+4b_2b_5{c_7}^2$.
		      ...
		      \begin{enumerate}
		        ...
		        \item Hence verify that $\lVert\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x)\rVert^2\le(\frac{a_2}{n}+b_2\{\delta\})^2$.
		        \item Execute procedure $q_1$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert p'_n(x)\rVert^2\le {a_1}^2$.
		        \item Execute procedure $q_5$ on $\langle x,n,\delta\rangle$.
		        \item Hence verify that $\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)\rVert^2\le(\frac{a_5}{n}+b_5\{\delta\})^2$.
		        \item Execute procedure $q_4$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t'_n(x)\rVert^2\le {a_4}^2$.
		        \item Execute procedure $q_0$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert p_n(x)\rVert^2\le {a_0}^2$.
		        \item Execute procedure $q_3$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t_n(x)\rVert^2\le {a_6}^2$.
		        \item Hence verify that $\lVert\frac{p_n(x+\delta)t_n(x+\delta)-p_n(x)t_n(x)}{\delta}-p_n(x)t'_n(x)-p'_n(x)t_n(x)\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert p_n(x+\delta)\cdot\frac{t_n(x+\delta)-t_n(x)}{\delta}+t_n(x)\cdot\frac{p_n(x+\delta)-p_n(x)}{\delta}-p_n(x)t'_n(x)-p'_n(x)t_n(x)\rVert^2$
		          \item $=\lVert\delta\cdot\frac{p_n(x+\delta)-p_n(x)}{\delta}\cdot\frac{t_n(x+\delta)-t_n(x)}{\delta}+p_n(x)\cdot\frac{t_n(x+\delta)-t_n(x)}{\delta}-p_n(x)t'_n(x)+t_n(x)(\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x))\rVert^2$
		          \item $=\lVert\delta(\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x))(\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x))+\delta p'_n(x)(\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x))+\delta t'_n(x)(\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x))-\delta p'_n(x)t'_n(x)+p_n(x)(\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x))+ t_n(x)(\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x))\rVert^2$
		          \item $\le(\{\delta\}(\frac{a_2}{n}+b_2\{\delta\})(\frac{a_5}{n}+b_5\{\delta\})+\{\delta\}a_1(\frac{a_5}{n}+b_5\{\delta\})+\{\delta\}a_4(\frac{a_2}{n}+b_2\{\delta\})+\{\delta\}a_1a_4+a_0(\frac{a_5}{n}+b_5\{\delta\})+a_6(\frac{a_2}{n}+b_2\{\delta\}))^2$
		          \item $\le(\frac{a_7}{n}+b_7\{\delta\})^2$.
		        \end{enumerate}
		      \end{enumerate}
		      \item Let $q_6(x,n)$ be the following procedure:
		      \begin{enumerate}
		        ...
		        \item Hence verify that $\lVert p_n(x)\rVert^2\le{a_0}^2$.
		        \item Execute procedure $q_3$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t_n(x)\rVert^2\le{a_3}^2$.
		        \item \textbf{Hence verify that $\lVert p_n(x)t'_n(x)+p'_n(x)t_n(x)\rVert^2\le(a_0a_4+a_1a_3)^2={a_6}^2$.}
		      \end{enumerate}
		...
		\procedure{fri2308191803}
		  \objective
		    ...
		    \begin{enumerate}
		      \item Rational numbers $a_3,b_3,a_4,b_4,c_4$.
		      \item A procedure $q_3(x,n)$ to show that $\lVert q'_n(x)\rVert^2\le{a_3}^2$ when a complex number $x$ and a positive integer $n$ such that $P(x)$ and $n>b_3$ are chosen.
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \begin{enumerate}
		        \item Execute procedure $q_0$ on $\langle x,n\rangle$.
		        \item Execute procedure $q_1$ on $\langle x,n,\delta\rangle$.
		        \item Verify that $\lVert q'_n(x)\rVert^2$
		        \begin{enumerate}
		          \item $=\lVert p'_n(x)+(q'_n(x)-p'_n(x))\rVert^2$
		          \item $\le(a_1+\frac{a_0}{n})^2$
		          \item $\le{a_3}^2$.
		        \end{enumerate}
		      \end{enumerate}
		      \item Let $q_4(x,n,\delta)$ be the following procedure:
		...
		\procedure{thu2208191859}
		  ...
		  \implementation
		    ...
		    \end{instructions}
		\declaration{3.30}
			The notation \gls{differentialintegral}, where $R$ is a non-empty list of complex numbers and $f[\#r,r,dr]$ is a function of $\#r,r,dr$, will be used as a shorthand for $\sum_t^{[0:\lvert R\rvert-1]}f(t,R_t,R_{t+1}-R_{t})$.
		\procedure{3.86}
			\objective
