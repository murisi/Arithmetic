...
\begin{document}
	...
	\section{Matrix Arithmetic}\label{sec:body}
		...
		Let us use the notation $\mathcal{D}_{m,n}(A)$ as a shorthand for "$\mathcal{M}_{m,n}(A)$ with only $A$s on the diagonal, and $0$s everywhere else".
