...
\begin{document}
	...
	\begin{multicols}{2}
	  ...
	  \procedure{wed2407191611}
	    \objective
	      Choose two rational numbers $A>0$, $1>X>0$. The objective of the following instructions is to construct a rational number $D$ and a procedure $p(a,x,n)$ to show that $\lVert(1+x)_n^a\rVert^2<D^2$ when complex numbers $\lVert x\rVert^2<X^2$, $\lVert a\rVert^2<A^2$, and a positive integer $n$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{sun2107191247} on $\langle A,X\rangle$ and let $\langle B,C,q\rangle$ receive.
	        \item Let $D=\frac{B}{1-C}$.
	        \item Let $p(a,x,n)$ be the following procedure:
	        \begin{enumerate}
	          \item For each $r\in[1:n]$, do the following:
	          \begin{enumerate}
	            ...
	            \item Hence verify that $\lVert\binom{a}{r}x^r\rVert^2\le(BC^r)^2$.
	          \end{enumerate}
	          \item Hence verify that $\lVert(1+x)_n^a\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[0:n]}\binom{a}{r}x^r\rVert^2$
	            \item $\le(\sum_r^{[0:n]}BC^r)^2$
	            \item $\le(\frac{B}{1-C})^2=D^2$.
	          \end{enumerate}
	        \end{enumerate}
	  ...
	  \procedure{wed2407191627}
	    \objective
	      Choose two rational numbers $A>0$, $1>X>0$. The objective of the following instructions is to construct rational numbers $G>0$, $0<C<1$, $D>1$, and a procedure $p(x,a,k,n)$ to show that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2\le(GC^nD^k)^2$ when a non-negative integer $k$ and complex numbers $x,a$ such that $\lVert x\rVert^2\le X^2$ and $\lVert ka\rVert^2<A^2$ are chosen.
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Let $G=\frac{B}{D-1}$.
	        \item Let $p(x,a,k,n)$ be the following procedure:
	        \begin{enumerate}
	          \item If $k>0$, then do the following:
	          \begin{enumerate}
	            \item Execute procedure $t$ on $\langle a,x,n\rangle$.
	            \item Hence verify that $\lVert(1+x)_n^a\rVert^2<D^2$.
	          \end{enumerate}
	          \item For $r$ in $[0:k]$, do the following:
	          \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(\sum_r^{[0:k]}D^rBC^n)^2$
	            \item $=(BC^n\sum_r^{[0:k]}D^r)^2$
	            \item $=(B\cdot\frac{D^k-1}{D-1}\cdot C^n)^2$
	            \item $=(GC^nD^k)^2$.
	          \end{enumerate}
	        \end{enumerate}
	  ...
	  \procedure{thu2507190752}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Let $p(x,n,a,k)$ be the following procedure:
	        \begin{enumerate}
	          \item If $k>0$, then for $r\in[0:k]$ do the following:
	          \begin{enumerate}
	            \item Execute procedure $t$ on $\langle x,n,a,k\rangle$.
	            \item Hence verify that $\lVert((1+x)_n^a)^k\rVert^2\le D^2$.
	          \end{enumerate}
	          \item For $r\in[0:k]$, do the following:
	          \begin{enumerate}
	  ...
	  \declaration{fri0108191325}
	    The notation $f(r)$ will be used as a shorthand notation for $\frac{1}{r}(1-\prod_t^{[1:r]}(1-\frac{1}{nt}))$.
	  \procedure{thu0108191318}
	    \objective
	      Choose two positive integers $r,n$ such that $r>1$. The objective of the following instructions is to show that $\frac{f(r+1)}{f(r)}\le 1$.
	    \implementation
	      \begin{enumerate}
	        \item Using \procedurehr{2.07}, verify that $\frac{f(r+1)}{f(r)}$
          \begin{enumerate}
    ...
    \declaration{fri2607191453}
	  ...
	  \procedure{fri2607191450}
	    ...
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Let $p(x,n,k)$ be the following procedure:
	        \begin{enumerate}
	          \item For $r\in[2:k]$, use \procedurehr{thu0108191318} to verify that $\frac{f(r+1)}{f(r)}\le 1$.
	          ...
	          \begin{enumerate}
	            ...
	            \item $=\lVert\sum_r^{[1:k]}f(r)(-x)^r\rVert^2$
	            \item $=\lVert\sum_r^{[1:k]}(f(r+1)\cdot\frac{(-x)^{r+1}}{-x-1}-f(r)\cdot\frac{(-x)^r}{-x-1}-(f(r+1)-f(r))\cdot\frac{(-x)^{r+1}}{-x-1})\rVert^2$
	            \item $=\frac{1}{\lVert x+1\rVert^2}\lVert f(k)(-x)^k-f(1)(-x)^1-\sum_r^{[1:k]}(f(r+1)-f(r))(-x)^{r+1}\rVert^2$
	            \item $\le\frac{1}{\lVert x+1\rVert^2}(f(k)+f(1)+\sum_r^{[2:k]}(f(r)-f(r+1))+f(2)-f(1))^2$
	            \item $=\frac{1}{((\Re(x)+1)^2+\Im(x)^2)}(f(k)-f(k)+f(2)+f(2)+f(1)-f(1))^2$
	            \item $\le(\frac{a}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle a,p\rangle$.}
	  ...
	  \procedure{fri2607191801}
		...
		\procedure{3.89}
			\objective
				Choose a positive integer $K$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,k,m)$, to show that $\lVert\exp_n(\frac{k}{K}\tau_m i)^K-1\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and positive integers $n,m$ such that $0\le k<K$, $n\ge c$, and $m>d$ are chosen.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.50} and let $\langle a_1,b_1,p_1\rangle$ receive.
