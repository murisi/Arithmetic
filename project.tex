...
\begin{document}
    ...
    \subsection*{Comparing Procedural Mathematics}
      What follows is a table of the similarities and differences between the four methods of doing mathematics presented above. Note that they are not all trying to do exactly the same thing, as is evidenced by the variations in their grammatical moods. Also note that while procedural mathematics is strictly less expressive than classical mathematics, it may just be expressive enough to conduct most fields of applied mathemtics within.
      
      \begin{tabular}{|p{3.6cm}|p{3.6cm}|p{3.6cm}|p{3.6cm}|p{3.6cm}|p{3.6cm}|}
        \hline & \textbf{Classical Mathematics} & \textbf{Transparent Proofs / Proof Without Words} & \textbf{Procedural Mathematics} \\
        \hline \textbf{Grammatical Mood} & Factual. Mathematicians mainly produce theorems, which are facts about abstract objects. & Factual because the theorems being proved are identical to their equivalents in classical mathematics. & Intentional. Mathematicians produce procedures to achieve given objectives. But no claim is made that procedures achieve the objectives on every member of a domain. \\
        ...
        \hline \textbf{Constructivity} & Optional. The existence of objects can be proven by showing that the lack of existence would be contradictory. & Required because a theorem is proven only on an explicitly selected object. & Required as there is no concept of existence. \\
        ...
        \hline \textbf{Expressiveness} & Full. Sufficient for doing pure and applied mathematics and includes topics like transfinite set theory. & Subset of classical mathematics where existential statements have witnesses because proofs are done on explicitly chosen witnesses. & Subset of classical mathematics. Captures topics like trigonometry and calculus on complex variables. Fails to express topics like transfinite set theory. \\
        \hline \textbf{Imports} & Universal and existential quantification, transfinite set theory, inference rules, and axioms. & Inference rules and axioms. Universal and existential quantification are made implicit. & Data structures, procedures, lambdas, recursion, and static analysis. \\
      \end{tabular}
