...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\procedure{3.16}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c$ such that $c>1$ and a procedure, $p(x,k,n)$, to show that $\lVert\exp_n(kx)-\exp_n(x)^k\rVert^2\le(\frac{ac^k}{n})^2$ when a complex number $x$, a non-negative integer $k$, and a positive integer $n$ such that $n>b$, $\lVert kx\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
					  ...
					  \begin{enumerate}
						...
						\begin{enumerate}
							...
							\item $\le(\sum_r^{[0:k]}c^r\frac{eX^2}{n})^2$
							\item $=(\frac{eX^2}{n}\cdot\frac{c^k-1}{c-1})^2$
							\item \textbf{$\le(\frac{ac^k}{n})^2$.}
						\end{enumerate}
					\end{enumerate}
	...
	\begin{multicols}{2}
	  ...
	  \procedure{thu2507190646}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct rational numbers $B>0$, $N>0$, and a procedure $p(x,a,b,n)$ to show that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2\le(\frac{B}{n})^2$ when a complex number $x$, two rational numbers $a,b$, and a positive integer $n$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $0<a<1$, and $0<b<1$ are chosen.
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Let $p(x,a,b,n)$ be the following procedure:
	        \begin{enumerate}
	          \item For $r\in[1:n]$, for $k\in[0:r]$, verify the following in order:
	          \begin{enumerate}
	            \item $1\le r-k\le r<n$
	            \item $1<n+k-r+1$
	            \item $0<\frac{1}{n+k-r+1}<1$
	            \item $0<\frac{a}{n+k-r+1}<a$
	            \item $-1<\frac{a}{n+k-r+1}-1<a-1\le 0$
	            \item $-\lvert\binom{a}{k+n-r}\rvert<(\frac{a}{n+k-r+1}-1)\lvert\binom{a}{k+n-r}\rvert=-\lvert\binom{a}{k+1+n-r}\rvert\le 0$
	            \item $\sgn(\binom{a}{k+1+n-r})=\sgn((\frac{a}{k+1+n-r}-1)\binom{a}{k+n-r})=-\sgn(\binom{a}{k+n-r})$
	            \item $\lvert\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k\rvert=\lvert\binom{a}{k+1+n-r}+\binom{a}{k+n-r}\rvert=\lvert\binom{a}{k+n-r}\rvert-\lvert\binom{a}{k+1+n-r}\rvert$
	          \end{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le\frac{1}{X^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\sum_k^{[0:r]}(\lvert\binom{a}{k+n-r}\rvert-\lvert\binom{a}{k+1+n-r}\rvert)))^2$
	            \item $=\frac{1}{X^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\lvert\binom{a}{n-r}\rvert-\lvert\binom{a}{n}\rvert))^2$
	  ...
	  \procedure{thu2507191017}
	    \objective
	      Choose a rational number $0<X<2$, and a positive integer $A$. The objective of the following instructions is to construct rational numbers $D>1$, $N>0$, and a procedure $p(a,x,n)$ to show that $\lVert(1+x)_n^a\rVert^2<D^2$ when a complex number $x$, a rational number $a$, and a positive integer $n$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $A>a>1$, and $n>N$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $D=\frac{2+M^{A+1}+M^{A+2}}{X}$.
	        \item Execute \procedurehr{wed2407191824} on $\langle A\rangle$ and let $\langle M,N,q\rangle$ receive.
	        \item Let $p(a,x,n)$ be the following procedure:
	        \begin{enumerate}
	          \item For $r\in[0:n]$, do the following:
	          \begin{enumerate}
	            \item Execute procedure $q$ on $\langle a+1,r+1\rangle$.
	            \item Hence verify that $\lVert\binom{a+1}{r+1}\rVert^2\le(\frac{M}{r+1})^{\lfloor a\rfloor+2}$
	          \end{enumerate}
	          \item Hence verify that $\lVert(1+x)_n^a\rVert^2$
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[0:n]}\binom{a}{r}x^r\rVert^2$
	            \item $=\lVert\sum_r^{[0:n]}\binom{a}{r}(-1)^r(-x)^r\rVert^2$
	            \item $=\lVert\sum_r^{[0:n]}(\binom{a}{r+1}(-1)^{r+1}\frac{(-x)^{r+1}}{-x-1}-\binom{a}{r}(-1)^r\frac{(-x)^r}{-x-1}-\frac{(-x)^{r+1}}{-x-1}(\binom{a}{r+1}(-1)^{r+1}-\binom{a}{r}(-1)^r))\rVert^2$
	            \item $=\frac{1}{\lVert x+1\rVert^2}\lVert\binom{a}{n}x^n-\binom{a}{0}x^0-\sum_r^{[0:n]}x^{r+1}(\binom{a}{r+1}+\binom{a}{r})\rVert^2$
	            \item $\le\frac{1}{\Re(x+1)^2+\Im(x)^2}(\lvert\binom{a}{n}\rvert+1+\sum_r^{[0:n]}\lvert\binom{a+1}{r+1}\rvert)^2$
	            \item $\le\frac{1}{X^2}((\frac{M}{n})^{\lfloor a\rfloor+1}+1+\sum_r^{[0:n]}(\frac{M}{r+1})^{\lfloor a\rfloor+2})^2$
	            \item $\le\frac{1}{X^2}(\frac{M^{A+1}}{n}+1+\sum_r^{[0:n]}\frac{M^{A+2}}{(r+1)^2})^2$
	            \item $\le\frac{1}{X^2}(M^{A+1}+M^{A+2}+1+\sum_r^{[1:n]}\frac{1}{(r+1)r})^2$
	            \item $=\frac{1}{X^2}(M^{A+1}+M^{A+2}+1+\sum_r^{[1:n]}(\frac{1}{r}-\frac{1}{r+1}))^2$
	            \item $=\frac{1}{X^2}(M^{A+1}+M^{A+2}+2-\frac{1}{n})^2$
	            \item $\le D^2$.
	          \end{enumerate}
	        \end{enumerate}
	  ...
	  \procedure{thu2507190752}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct rational numbers $G>0$, $D>1$, $N>0$ and a procedure $p(x,a,k,n)$ to show that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2\le(\frac{GD^k}{n})^2$ when a positive integer $n$, a non-negative integer $k$, a rational number $a$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x+1)\ge X$, $0<a<1$, $(ka)^2\le 1$, and $n>N$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{thu2507191017} on $\langle 1,1\rangle$ and let $\langle D,M,t\rangle$ receive.
	        \item Execute \procedurehr{thu2507190646} on $\langle X\rangle$ and let $\langle B,Q,q\rangle$ receive.
	        \item Let $N=\max(M,Q)$.
	        \item Let $G=\frac{B}{D-1}$.
	        \item Let $p(x,a,k,n)$ be the following procedure:
	        \begin{enumerate}
	          ...
	          \begin{enumerate}
	            \item Execute procedure $t$ on $\langle a,x,n\rangle$.
	            \item Hence verify that $\lVert(1+x)_n^a\rVert^2\le D^2$.
	          \end{enumerate}
	          \item For $r\in[0:k]$, do the following:
	          \begin{enumerate}
	          ...
	          \begin{enumerate}
	            \item $=\lVert\sum_r^{[0:k]}(((1+x)_n^a)^r(1+x)_n^{(k-r)a}-((1+x)_n^a)^{r+1}(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $=\lVert\sum_r^{[0:k]}((1+x)_n^a)^r((1+x)_n^{(k-r)a}-(1+x)_n^a(1+x)_n^{(k-r-1)a})\rVert^2$
	            \item $\le(\sum_r^{[0:k]}D^r\cdot\frac{B}{n})^2$
	            \item $=(\frac{B}{n}\cdot\frac{D^k-1}{D-1})^2$
	            \item $\le(\frac{GD^k}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	  ...
	  \procedure{fri2607191210}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct positive rational numbers $a,b,c$ such that $b>1$, and a procedure $p(x,k,n)$ to show that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{ab^n}{k})^2$ when a complex number $x$, and positive integers $n,k$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $n>1$, and $k>c$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{thu2507190752} on $\langle X\rangle$ and let $\langle a,b,c,p_1\rangle$ receive.
	        \item Let $p(x,k,n)$ be the following procedure:
	        \begin{enumerate}
	          \item Using \procedurehr{sun2107190619}, verify that $(1+x)_k^1=(1+x)^1=1+x$.
	          \item Execute procedure $p_1$ on $\langle x,\frac{1}{n},n,k\rangle$.
	          \item Hence verify that $\lVert(1+x)_k^1-((1+x)_k^{\frac{1}{n}})^n\rVert^2\le(\frac{ab^n}{k})^2$.
	   ...
	   \procedure{fri2607191243}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a rational number $a>0$ and a procedure $p(x,k,n)$ to show that $\lVert n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le a^2$ when positive integers $n,k$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $a=\frac{2}{X}$.
	        \item Let $p(x,k,n)$ be the following procedure:
	  ...
	  \procedure{fri2607191450}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a positive rational number $a$ and a procedure $p(x,k,n)$ to show that $\lVert\ln_k(1+x)-n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le(\frac{a}{n})^2$ when positive integers $n,k$ and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $a=\frac{1}{X}$.
	        \item Let $p(x,k,n)$ be the following procedure:
	  ...
	  \procedure{fri2607191801}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct positive rational numbers $a,b,c,d,e$ such that $b>1$, and a procedure $p(x,k,n)$ to show that $\lVert\exp_n(\ln_k(1+x))-(1+x)\rVert^2\le(\frac{ab^n}{k}+\frac{c}{n})^2$ when positive integers $k,n$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $k>d$, and $n>e$ are chosen.
	    \implementation
	      \begin{enumerate}
	        ...
	        \item Execute \procedurehr{fri2607191210} on $\langle X\rangle$ and let $\langle a,b,d,p_5\rangle$ receive.
	        \item Let $c=a_4a_3$.
	        \item Let $p(x,k,n)$ be the following procedure:
	        \begin{enumerate}
	          \item Execute procedure $p_1$ on $\langle x,k,n\rangle$.
	          ...
	          \item Execute procedure $p_4$ on $\langle x,k,n\rangle$.
	          ...
	          \item Execute procedure $p_5$ on $\langle x,k,n\rangle$.
	          \item Hence verify that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{ab^n}{k})^2$.
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(\frac{c}{n}+\frac{ab^n}{k})^2$.
	          \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle a,b,c,d,e,p\rangle$.}
	      \end{enumerate}
		\declaration{3.33}
		...
		\procedure{3.53}
			\objective
				The objective of the following instructions is to construct positive rational numbers $G,D,L,K,N$ such that $D>1$, and a procedure $p(k,n)$ to show that $\lVert\exp_n(\frac{1}{4}\tau_ki)-i\rVert^2\le(\frac{GD^n}{k}+\frac{L}{n})^2$ when integers $k,n$ such that $n>N$ and $k>K$ are chosen.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{fri2607191736} on $\langle 1\rangle$ and let $\langle A,q\rangle$ receive.
					\item Execute \procedurehr{thu2507191359} on $\langle A\rangle$ and let $\langle B,C,r\rangle$ receive.
					\item Execute \procedurehr{3.14} on $\langle A\rangle$ and let $\langle E,F,t\rangle$ receive.
					\item Execute \procedurehr{fri2607191801} on $\langle 1\rangle$ and let $\langle H,J,M,Q,R,u\rangle$ receive.
					\item Let $G=\frac{2H}{E}$.
					\item Let $D=J$.
					\item Let $L=\frac{2Q}{E}+B$.
					\item Let $N=\max(C,F,R)$.
					\item Let $K=M$.
					\item Let $p(k,n)$ be the following procedure:
					\begin{enumerate}
					  \item Execute procedure $q$ on $\langle i,k\rangle$.
					  \item Hence verify that $\lVert\ln_k(1+i)\rVert^2\le A^2$.
					  \item Execute procedure $r$ on $\langle\ln_k(1+i),\conj{\ln_k(1+i)},n\rangle$.
					  \item Hence  verify that $\lVert\exp_n(\ln_k(1+i)-\conj{\ln_k(1+i)})-\frac{\exp_n(\ln_k(1+i))}{\exp_n(\conj{\ln_k(1+i)})}\rVert^2\le\frac{B^2}{n^2}$.
					  \item Execute procedure $u$ on $\langle i,k,n\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))-(1+i)\rVert^2\le(\frac{HJ^n}{k}+\frac{Q}{n})^2$.
					  \item Execute procedure $t$ on $\langle\ln_k(1+i),n\rangle$.
					  \item Hence verify that $\lVert\exp_n(\ln_k(1+i))\rVert^2\ge E$.
					  \item Hence verify that $\lVert\frac{\exp_n(\ln_k(1+i))}{\exp_n(\ln_k(1+i))}-\frac{1+i}{\exp_n(\ln_k(1+i))}\rVert^2\le\frac{1}{E^2}(\frac{HJ^n}{k}+\frac{Q}{n})^2$.
					  \item Also verify that $\lVert\frac{1+i}{\conj{\exp_n(\ln_k(1+i))}}-\frac{1+i}{\conj{1+i}}\rVert^2=\lVert\frac{(1+i)(\conj{(1+i)-\exp_n(\ln_k(1+i))})}{\conj{\exp_n(\ln_k(1+i))(1+i)}}\rVert^2\le\frac{1}{E^2}(\frac{HJ^n}{k}+\frac{Q}{n})^2$.
					  ...
					  \begin{enumerate}
					    ...
					    \item $\le(\frac{B}{n}+\frac{2}{E}(\frac{HJ^n}{k}+\frac{Q}{n}))^2$
					    \item $=(\frac{GD^n}{k}+\frac{L}{n})^2$.
					  \end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle G,D,L,K,N,p\rangle$.}
				\end{enumerate}
		\procedure{3.54}
			\objective
