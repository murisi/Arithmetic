...
\newglossaryentry{perplexj}{name=\ensuremath{j},description={perplex imaginary unit}}
\newglossaryentry{perplexj+}{name=\ensuremath{j_+},description={}}
\newglossaryentry{perplexj-}{name=\ensuremath{j_-},description={}}
...
\newglossaryentry{complexi}{name=\ensuremath{i},description={complex imaginary unit}}
	  ...
	  \chapter{Integer Arithmetic}
	    \begin{multicols*}{2}
		    ...
		    \procedure{1.81}
			    ...
			    \implementation
				    \begin{enumerate}
					    \item Show that $\Po(a)+\Ne(b)<\Ne(a)+\Po(b)$ using \declarationhr{1.30} given that $a<b$.
					    \item \textbf{Hence show that $a\ne b$ using \declarationhr{1.25} given that $\Po(a)+\Ne(b)\ne\Ne(a)+\Po(b)$.}
					    \item \textbf{Also show that $b\not<a$ using \declarationhr{1.30} given that $\Ne(a)+\Po(b)\not<\Po(a)+\Ne(b)$.}
				    \end{enumerate}
		    \procedure{1.82}
			    \objective
				    Choose two integers $a,b$ such that $a=b$. The objective of the following instructions is to show that $a\not<b$ and $b\not<a$.
		    ...
		    \procedure{1.83}
			    ...
			    \implementation
				    \begin{enumerate}
					    \item Show that $\Po(a)+\Ne(b)\ne\Ne(a)+\Po(b)$ using \declarationhr{1.25} given that $a\ne b$.
					    \item If $\Po(a)+\Ne(b)<\Ne(a)+\Po(b)$, then do the following:
					    \begin{enumerate}
						    \item \textbf{Show that $a<b$ using \declarationhr{1.30}.}
					    \end{enumerate}
					    \item Otherwise do the following:
					    \begin{enumerate}
						    \item \textbf{Show that $b<a$ using \declarationhr{1.30} given that $\Ne(a)+\Po(b)<\Po(a)+\Ne(b)$.}
					    \end{enumerate}
				    \end{enumerate}
		    \procedure{1.84}
			    \objective
	...
	\part{Rational Arithmetic}
	    ...
	    \begin{multicols*}{2}
		    ...
		    \procedure{2.45}
			    ...
			    \implementation
				    \begin{enumerate}
					    \item Show that $\Nu(a)\De(b)<\De(a)\Nu(b)$ using \declarationhr{2.22} given that $a<b$.
					    \item \textbf{Hence show that $a\ne b$ using \declarationhr{2.15} given that $\Nu(a)\De(b)\ne\De(a)\Nu(b)$.}
					    \item \textbf{Also show that $b\not<a$ using \declarationhr{2.22} given that $\Nu(b)\De(a)\not<\De(b)\Nu(a)$.}
				    \end{enumerate}
		    \procedure{2.46}
			    \objective
				    Choose two rational numbers $a,b$ such that $a=b$. The objective of the following instructions is to show that $a\not<b$ and $b\not<a$.
		    ...
		    \procedure{2.47}
			    ...
			    \implementation
				    \begin{enumerate}
					    \item Show that $\Nu(a)\De(b)\ne\De(a)\Nu(b)$ using \declarationhr{2.15} given that $a\ne b$.
					    \item If $\Nu(a)\De(b)<\De(a)\Nu(b)$, then do the following:
					    \begin{enumerate}
						    \item \textbf{Show that $a<b$ using \declarationhr{2.22}.}
					    \end{enumerate}
					    \item Otherwise do the following:
					    \begin{enumerate}
						    \item \textbf{Show that $b<a$ using \declarationhr{2.22} given that $\Nu(b)\De(a)<\De(b)\Nu(a)$.}
					    \end{enumerate}
				    \end{enumerate}
		    \procedure{2.48}
			    \objective
	  ...
	  \chapter{Perplex Arithmetic}
		    ...
		    \declaration{wed0502201719}
			    The notation $a<b$, where $a,b$ are perplex numbers, will be used as a shorthand for $0<\Re(b-a)$ and $\lVert\Im(b-a)\rVert\le\Re(b-a)$.
			  \procedure{sat0802200648}
			    ...
			    \implementation
				    \begin{enumerate}
					    \item Show that $\Re(a)=\Re(c)$ and $\Im(a)=\Im(c)$ using \declarationhr{2.15} given that $a=c$.
					    \item Show that $\Re(b)=\Re(d)$ and $\Im(b)=\Im(d)$ using \declarationhr{2.15} given that $b=d$.
					    \item Show that $0<\Re(b-a)$ and $\lVert\Im(b-a)\rVert\le\Re(b-a)$ using \declarationhr{wed0502201719} given that $a<b$.
					    \item Hence show that $\Re(d-c)=\Re(b-a)>0$.
					    \item Also show that $\lVert\Im(d-c)\rVert=\lVert\Im(b-a)\rVert\le\Re(b-a)=\Re(d-c)$.
		    ...
		    \procedure{2.44}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \item Also show that $\lVert\Im((b+c)-(a+c))\rVert=\lVert\Im(b-a)\rVert\le\Re(b-a)=\Re((b+c)-(a+c))$.
					    \item \textbf{Hence show that $a+c<b+c$ using \declarationhr{wed0502201719}.}
				    \end{enumerate}
		    \procedure{2.45}
			    \objective
				    Choose two perplex numbers $a,b$ such that $a<b$. The objective of the following instructions is to show that $a\ne b$ and $b\not<a$.
			    \implementation
				    \begin{enumerate}
					    \item Show that $0<\Re(b-a)$ and $\lVert\Im(b-a)\rVert\le\Re(b-a)$ using \declarationhr{wed0502201719} given that $a<b$.
					    \item \textbf{Hence show that $a\ne b$}
					    \begin{enumerate}
					      \item given that $\Re(a)\ne\Re(b)$
					      \item given that $0<\Re(b-a)$.
					    \end{enumerate}
					    \item \textbf{Also using \declarationhr{wed0502201719}, show $b\not<a$}
					    \begin{enumerate}
					      \item given that $0\not<\Re(a-b)$
					      \item given that $0<\Re(b-a)$.
					    \end{enumerate}
		    ...
		    \procedure{2.49}
			    ...
			    \implementation
				    \begin{enumerate}
				      \item Show that $0<\Re(a)$ and $\lVert\Im(a)\rVert\le\Re(a)$ using \declarationhr{wed0502201719} given that $0<a$.
				      \item Show that $0<\Re(b)$ and $\lVert\Im(b)\rVert\le\Re(b)$ using \declarationhr{wed0502201719} given that $0<b$.
				      \item Hence show that $\Re(a+b)=\Re(a)+\Re(b)>0$ given that $0<\Re(a)$ and $0<\Re(b)$.
				      \item Also show that $\lVert\Im(a+b)\rVert=\lVert\Im(a)+\Im(b)\rVert\le\lVert\Im(a)\rVert+\lVert\Im(b)\rVert\le\Re(a)+\Re(b)=\Re(a+b)$ given that $\lVert\Im(a)\rVert\le\Re(a)$ and $\lVert\Im(b)\rVert\le\Re(b)$.
					    \item \textbf{Hence show that $0<a+b$ using \declarationhr{wed0502201719} given that $\Re(a+b)>0$ and $\lVert\Im(a+b)\rVert\le\Re(a+b)$.}
				    \end{enumerate}
		    \procedure{2.50}
			    \objective
			    ...
			    \implementation
				    \begin{enumerate}
				      ...
				      \item Given that $\lVert\Im(a)\rVert\le\Re(a)$ and $\lVert\Im(b)\rVert\le\Re(b)$, show $\Re(ab)-\Im(ab)$
				      \begin{enumerate}
				        \item $=\Re(a)\Re(b)+\Im(a)\Im(b)-\Re(a)\Im(b)-\Im(a)\Re(b)$
				        \item $=(\Re(a)-\Im(a))(\Re(b)-\Im(b))$
				        \item $\ge 0$.
				      \end{enumerate}
				      \item Hence show that $\Re(ab)\ge\Im(ab)$.
				      \item Given that $\lVert\Im(a)\rVert\le\Re(a)$ and $\lVert\Im(b)\rVert\le\Re(b)$, show $\Re(ab)+\Im(ab)$
				      \begin{enumerate}
				        \item $=\Re(a)\Re(b)+\Im(a)\Im(b)+\Re(a)\Im(b)+\Im(a)\Re(b)$
				        \item $=(\Re(a)+\Im(a))(\Re(b)+\Im(b))$
				        \item $\ge 0$.
				      \end{enumerate}
				      \item Hence show that $\Im(ab)\ge-\Re(ab)$.
					    \item Hence show that $\lVert\Im(ab)\rVert\le\Re(ab)$ given that
					    \begin{enumerate}
					      \item $\Re(ab)\ge 0$
					      \item and $\Re(ab)\ge\Im(ab)$
					      \item and $\Im(ab)\ge-\Re(ab)$.
					    \end{enumerate}
					    \item If $\Re(ab)=0$, then do the following:
					    \begin{enumerate}
					      \item \textbf{Show that $ab=0$ using \declarationhr{sat0802201051} given that $\Im(ab)=0$ given that $\lVert\Im(ab)\rVert\le\Re(ab)=0$.}
					    \end{enumerate}
					    \item Otherwise do the following:
					    \begin{enumerate}
					      \item \textbf{Show that $ab>0$ using \declarationhr{wed0502201719} given that $\Re(ab)>0$ and $\lVert\Im(ab)\rVert\le\Re(ab)$.}
					    \end{enumerate}
				    \end{enumerate}
			  \declaration{wed0502201655}
			    The notations $a\subseteq b$ and $b\supseteq a$, where $a,b$ are perplex numbers, will be used as shorthands for $\lVert\Re(b)-\Re(a)\rVert\le\Im(b)-\Im(a)$.
			  \procedure{sat0802201148}
			    \objective
			      Choose a perplex number $a$. The objective of the following instructions is to show that $a\subseteq a$.
			    \implementation
			      \begin{enumerate}
			        \item Show that $a\subseteq a$ using \declarationhr{wed0502201655} given that $\lVert\Re(a)-\Re(a)\rVert=0=\Im(a)-\Im(a)$.
			      \end{enumerate}
			  \procedure{sat0802201153}
			    \objective
			      Choose perplex numbers $a,b$ such that $a\subseteq b$ and $b\subseteq a$. The objective of the following instructions is to show that $a=b$.
			    \implementation
			      \begin{enumerate}
			        \item Show that $\lVert\Re(b)-\Re(a)\rVert\le\Im(b)-\Im(a)$ given that $a\subseteq b$.
			        \item Show that $\lVert\Re(a)-\Re(b)\rVert\le\Im(a)-\Im(b)$ given that $b\subseteq a$.
			        \item Hence show that $\Im(b)=\Im(a)$
			        \begin{enumerate}
			          \item given that $\Im(b)-\Im(a)=0$
			          \item given that $\Im(b)-\Im(a)\le 0\le\Im(b)-\Im(a)$.
			        \end{enumerate}
			        \item Hence show that $\Re(b)=\Re(a)$
			        \begin{enumerate}
			          \item given that $\Re(b)-\Re(a)=0$
			          \item given that $\lVert\Re(b)-\Re(a)\rVert\le 0$.
			        \end{enumerate}
			        \item Hence show that $a=b$ using \declarationhr{sat0802201051}.
			      \end{enumerate}
			  \procedure{sat0802201213}
			    \objective
			      Choose perplex numbers $a,b,c$ such that $a\subseteq b$ and $b\subseteq c$. The objective of the following instructions is to show that $a\subseteq c$.
			    \implementation
			      \begin{enumerate}
			        \item Show that $\lVert\Re(b)-\Re(a)\rVert\le\Im(b)-\Im(a)$ given that $a\subseteq b$.
			        \item Show that $\lVert\Re(c)-\Re(b)\rVert\le\Im(c)-\Im(b)$ given that $b\subseteq c$.
			        \item Hence show that $\lVert\Re(c)-\Re(a)\rVert$
			        \begin{enumerate}
			          \item $=\lVert(\Re(c)-\Re(b))+(\Re(b)-\Re(a))\rVert$
			          \item $\le\lVert\Re(c)-\Re(b)\rVert+\lVert\Re(b)-\Re(a)\rVert$
			          \item $\le(\Im(b)-\Im(a))+(\Im(c)-\Im(b))$
			          \item $=\Im(c)-\Im(a)$.
			        \end{enumerate}
			        \item Hence show that $a\subseteq c$ using \declarationhr{wed0502201655}.
			      \end{enumerate}
			  \procedure{sat0802201250}
			    \objective
			      Choose perplex numbers $a,b,c$ such that $a\subseteq b$. The objective of the following instructions is to show that $a+c\subseteq b+c$.
			    \implementation
			      \begin{enumerate}
			        \item Show that $\lVert\Re(b)-\Re(a)\rVert\le\Im(b)-\Im(a)$ given that $a\subseteq b$.
			        \item Now show that $\lVert\Re(b+c)-\Re(a+c)\rVert$
			        \begin{enumerate}
			          \item $=\lVert\Re(b)-\Re(a)\rVert$
			          \item $\le\Im(b)-\Im(a)$
			          \item $=\Im(b+c)-\Im(a+c)$.
			        \end{enumerate}
			        \item Hence show that $a+c\subseteq b+c$ using \declarationhr{wed0502201655}.
			      \end{enumerate}
			  \declaration{3.03}
		    ...
		    \procedure{3.81}
			    ...
			    \implementation
				    ...
				    \end{enumerate}
		    \declaration{3.28}
			    The notations \gls{perplexj}, \gls{perplexj+}, and \gls{perplexj-} will be used as a shorthand for the perplex numbers $\langle 0,1\rangle$, $\langle\frac{1}{2},\frac{1}{2}\rangle$, and $\langle\frac{1}{2},-\frac{1}{2}\rangle$ respectively.
		    \procedure{thu0602201510}
			    \objective
				    The objective of the following instructions is to show that $j^{2}=1$, ${j_+}^2=j_+$, ${j_-}^2=j_-$, $j_+j_-=0$, and $j_++j_-=1$.
			    \implementation
				    \begin{enumerate}
					    \item \textbf{Show that $j^2=1$}.
					    \item \textbf{Show that ${j_+}^2=j_+$}.
					    \item \textbf{Show that ${j_-}^2=j_-$}.
					    \item \textbf{Show that $j_+j_-=0$}.
					    \item \textbf{Show that $j_++j_-=1$.}
				    \end{enumerate}
				\procedure{sat0802201559}
			    \objective
				    Choose rational numbers $a,b,c,d$. The objective of the following instructions is to show that $(aj_++bj_-)+(cj_++dj_-)=(a+c)j_++(b+d)j_-$.
			    \implementation
				    \begin{enumerate}
				      \item Show that $(aj_++bj_-)+(cj_++dj_-)=(a+c)j_++(b+d)j_-$.
				    \end{enumerate}\procedure{sat0802201559}
			    \objective
				    Choose rational numbers $a,b,c,d$. The objective of the following instructions is to show that $(aj_++bj_-)(cj_++dj_-)=acj_++bdj_-$.
			    \implementation
				    \begin{enumerate}
				      \item Show that $(aj_++bj_-)(cj_++dj_-)$
				      \begin{enumerate}
				        \item $=aj_+(cj_++dj_-)+bj_-(cj_++dj_-)$
				        \item $=aj_+cj_++aj_+dj_-+bj_-cj_++bj_-dj_-$
				        \item $=acj_+0ad+0bc+bdj_-$
				        \item $=acj_++bdj_-$.
				      \end{enumerate}
				    \end{enumerate}
	    \end{multicols*}
	  \chapter{Polynomial Sign Changes}
	    \begin{multicols*}{2}
		    ...
		    \procedure{2.15}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    \item Show that $\lvert\Lambda(p,z)-\Lambda(p,y)\rvert$
						    \begin{enumerate}
            ...
            \procedure{thu3001201111}
                \objective
                    Choose a polynomial $p$ and a rational number $X$. The objective of the following instructions is to construct a rational number $a>0$ and a procedure $q(y,z)$ to show that $\lVert\Lambda(p,z)\rVert\le a\lVert z-y\rVert$ and $\lVert\Lambda(p,y)\rVert\le a\lVert z-y\rVert$ when two rational numbers $y,z$ such that $\lVert y\rVert\le X$, $\lVert z\rVert\le X$, and $\Lambda(p,y)\Lambda(p,z)\le 0$ are chosen.
                \implementation
                    \begin{enumerate}
                        \item Use \procedurehr{2.15} on $\langle p,X\rangle$ to construct $\langle a,q_1\rangle$.
                        \item Let $q(y,z)$ be the following procedure:
                        \begin{enumerate}
                            \item Show that $\lVert\Lambda(p,z)-\Lambda(p,y)\rVert\le a\lVert z-y\rVert$ using procedure $q_1$.
                            \item Hence using \procedurehr{thu3001201131} show that $\lVert\Lambda(p,z)\rVert$
                            \begin{enumerate}
                                \item $\le\lVert\Lambda(p,z)\rVert+\lVert\Lambda(p,y)\rVert$
                                \item $=\lVert\Lambda(p,z)-\Lambda(p,y)\rVert$
                                \item $\le a\lVert z-y\rVert$.
                            \end{enumerate}
                            \item Also using \procedurehr{thu3001201131} show that $\lVert\Lambda(p,y)\rVert$
                            \begin{enumerate}
                                \item $\le\lVert\Lambda(p,z)\rVert+\lVert\Lambda(p,y)\rVert$
                                \item $=\lVert\Lambda(p,z)-\Lambda(p,y)\rVert$
                                \item $\le a\lVert z-y\rVert$.
        ...
        \procedure{sat0102201050}
			    \objective
				    Choose a polynomial $f$ and rational numbers $c,d,B$ such that $c\le d$, $\Lambda(f,c)\Lambda(f,d)\le 0$ and $B>0$. The objective of the following instructions is to construct rational numbers $e,h$ such that $c\le e\le h\le d$, $\lVert h-e\rVert<B$ and $\Lambda(f,e)\Lambda(f,h)\le 0$.
			    \implementation
				    \begin{enumerate}
					    \item If $\lVert d-c\rVert<B$, then do the following:
					    \begin{enumerate}
					      \item \textbf{Yield the tuple $\langle c,d\rangle$.}
					    \end{enumerate}
					    \item Otherwise do the following:
					    \begin{enumerate}
						    \item Let $g=\frac{c+d}{2}$.
						    \item \textbf{Show that $c<g<d$.}
						    \item Show that $\lVert g-c\rVert=\lVert d-g\rVert=\frac{d-c}{2}$.
						    \item If $\Lambda(f,c)\Lambda(f,g)\le 0$, then do the following:
						    \begin{enumerate}
							    \item Use \procedurehr{sat0102201050} on $\langle f,c,g,B\rangle$ to construct $\langle e,h\rangle$ and show that:
							    \begin{enumerate}
							      \item $c\le e\le h\le g<d$
							      \item $\Lambda(f,e)\Lambda(f,h)\le 0$.
							    \end{enumerate}
						    \end{enumerate}
						    \item Otherwise do the following:
						    \begin{enumerate}
						      \item Show that $\Lambda(f,g)\Lambda(f,d)=\frac{\Lambda(f,g)}{\Lambda(f,c)}\Lambda(f,c)\Lambda(f,d)\le 0$ given that
						      \begin{enumerate}
						        \item $\Lambda(f,c)\Lambda(f,g)>0$
						        \item and $\Lambda(f,c)\Lambda(f,d)\le 0$.
						      \end{enumerate}
							    \item Hence use \procedurehr{sat0102201050} on $\langle f,g,d,B\rangle$ to construct $\langle e,h\rangle$ and show that:
							    \begin{enumerate}
							      \item $c<g\le e\le h\le d$
							      \item $\Lambda(f,e)\Lambda(f,h)\le 0$.
							    \end{enumerate}
						    \end{enumerate}
						    \item \textbf{Yield the tuple $\langle e,h\rangle$.}
					    \end{enumerate}
				    \end{enumerate}
		    \procedure{2.17}
			    \objective
				    Choose a polynomial $f$ and rational numbers $a,b,B$ such that $a\le b$, $\Lambda(f,a)\Lambda(f,b)\le 0$, and $B>0$. The objective of the following instructions is to construct a rational number $d$ such that $a\le d\le b$ and $\lVert \Lambda(f,d)\rVert<B$.
			    \implementation
				    \begin{enumerate}
					    \item Use \procedurehr{thu3001201111} on $\langle f,\max(\lvert a\rvert,\lvert b\rvert)\rangle$ to construct $\langle G,q\rangle$.
					    \item Use \procedurehr{sat0102201050} on $\langle f,a,b,\frac{B}{G}\rangle$ to construct $\langle c,d\rangle$ and show that:
					    \begin{enumerate}
					      \item $a\le c\le d\le b$
					      \item $\lVert d-c\rVert\le\frac{B}{G}$
					      \item $\Lambda(f,a)\Lambda(f,b)\le 0$.
					    \end{enumerate}
					    \item \textbf{Use procedure $q$ on $\langle c,d\rangle$ to show that $\lVert\Lambda(f,d)\rVert\le G\lVert d-c\rVert\le G\frac{B}{G}=B$.}
				    \end{enumerate}
		    \procedure{2.18}
			    \objective
		    ...
		    \procedure{sat0308190647}
		      ...
		      \implementation
		        \begin{enumerate}
		          ...
		          \item Let $p(x,y,n)$ be the following procedure:
		          \begin{enumerate}
		            \item Using procedure $q$, \procedurehr{3.22}, and \procedurehr{3.23}, show that $\lVert x\exp_n(iy)\rVert^2$
		            \begin{enumerate}
		            ...
		            \end{enumerate}
		            \item \textbf{Hence show that $\lVert x\exp_n(iy)\rVert^2\equiv\lVert x\rVert^2\err{\frac{a\lVert xy\rVert^2}{n}}\err{\frac{a\lVert x\rVert^2X^2}{n}}$.}
		          \end{enumerate}
		        \end{enumerate}
		    \procedure{3.29}
			    \objective
		    ...
		    \procedure{3.53}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
					      \item Show that $\lVert\ln_k(1+i)\rVert^2\le {a_1}^2$ using procedure $p_1$.
					      \item Hence using procedures $p_2,p_3,p_4$, show that $\exp_n(\frac{1}{4}\tau_ki)$
					      \begin{enumerate}
					        ...
					        \item $=i$.
					      \end{enumerate}
					      \item \textbf{Hence show that $\exp_n(\frac{1}{4}\tau_ki)\equiv i\err{\frac{a_2}{n}+\frac{2}{a_3}(\frac{a_4n}{k}+\frac{c_4}{n})}\err{\frac{an}{k}+\frac{c}{n}}$.}
					    \end{enumerate}
					    \item \textbf{Yield the tuple $\langle a,c,d,e,p\rangle$.}
				    \end{enumerate}
		    \procedure{3.54}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \item Hence show that $\lVert\frac{1}{4}\tau_m i\rVert^2=\lVert\frac{1}{4}\tau_m\rVert^2\le(\frac{a_1}{4})^2$.
						    \item Hence show that $\lVert\exp_n(\frac{1}{4}\tau_m i)-i\rVert^2\le(\frac{a_3n}{m}+\frac{b_3}{n})^2$ using procedure $p_3$.
						    \item Hence show that $\lVert\exp_n(\frac{1}{4}\tau_m i)\rVert^2\le a_4$ using procedure $p_4$.
						    \item Hence using procedures $p_2,p_5$, show that $\exp_n(\frac{k}{4}\tau_m i)$
						    \begin{enumerate}
						      ...
						      \end{enumerate}
						    \end{enumerate}
						    \item \textbf{Hence show that $\exp_n(\frac{k}{4}\tau_m i)\equiv i^k\err{\frac{a_2K}{n}+a_5(\frac{a_3n}{m}+\frac{b_3}{n})}\err{\frac{an}{m}+\frac{b}{n}}$.}
					    \end{enumerate}
				    ...
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \begin{enumerate}
						      ...
						      \item $=\frac{i^k+i^{-k}}{2}$.
						    \end{enumerate}
						    \item \textbf{Hence show that $\cos_n(\frac{k}{4}\tau_m)\equiv\frac{i^k+i^{-k}}{2}\err{\frac{an}{m}+\frac{b}{n}}$.}
					    \end{enumerate}
					    \item \textbf{Yield the tuple $\langle a,b,c,d,p\rangle$.}
				    \end{enumerate}
		    \procedure{3.58}
		    ...
		    \procedure{3.59}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    \item Show that $\tau_m\le a_1$ using procedure $p_1$.
						    \item Hence show that $\lVert\frac{k}{4}\tau_m i\rVert^2=(\frac{k{\tau_m}}{4})^2$.
						    \item Hence using procedures $p_2,p_3,p_4$, show that $\exp_n(x+\frac{k}{4}\tau_m i)$
						    \begin{enumerate}
						      \item $\equiv\exp_n(\frac{k}{4}\tau_m i)\exp_n(x)\err{\frac{a_2H^2}{n}}$
						      \item $\equiv i^k\exp_n(x)\err{a_3(\frac{a_4n}{m}+\frac{b_4}{n})}$
						    \end{enumerate}
						    \item \textbf{Hence show that $\exp_n(x+\frac{k}{4}\tau_m i)\equiv i^k\exp_n(x)\err{\frac{a_2H^2}{n}+a_3(\frac{a_4n}{m}+\frac{b_4}{n})}\err{\frac{an}{m}+\frac{b}{n}}$.}
					    \end{enumerate}
					    \item \textbf{Yield the tuple $\langle a,b,c,d,p\rangle$.}
				    \end{enumerate}
		    \procedure{3.89}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    \item Show that $\tau_m\le a_1$ using procedure $p_1$.
						    \item Hence show that $\lVert K\frac{k}{K}\tau_mi\rVert=\lVert k\tau_m\rVert^2\le(Ka_1)^2$.
						    \item Now using procedures $p_2,p_3$, show that $\exp_n(\frac{k}{K}\tau_mi)^K$
						    \begin{enumerate}
						      \item $\equiv\exp_n(K\frac{k}{K}\tau_mi)\err{\frac{a_2K}{n}}$
						      \item $=\exp_n(\frac{4k}{4}\tau_mi)$
						      \item $\equiv i^{4k}\err{\frac{a_3n}{m}+\frac{b_3}{n}}$
						    \end{enumerate}
						    \item \textbf{Hence show that $\exp_n(\frac{k}{K}\tau_mi)^K\equiv i^{4k}\err{\frac{a_2K}{n}+\frac{a_3n}{m}+\frac{b_3}{n}}\err{\frac{an}{m}+\frac{b}{n}}$.}
					    \end{enumerate}
					    \item \textbf{Yield the tuple $\langle a,b,c,d,p\rangle$.}
				    \end{enumerate}
	    \end{multicols}
	    ...
	    \begin{multicols*}{2}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \item Using \procedurehr{3.22}, show that $\lVert\exp_n(\frac{k}{K}\tau_mi)-1\rVert^2$
						    \begin{enumerate}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \end{enumerate}
						    \item Hence show that $\lVert\frac{j}{K}\tau_mi\rVert^2=\lVert\frac{j}{K}\rVert^2\lVert\tau_m\rVert^2\le\lVert\tau_m\rVert^2\le{a_1}^2$ using procedure $p_1$.
						    \item Hence show that $\lVert\exp_n(\frac{j}{K}\tau_mi)\rVert^2\ge{a_2}^2>0$ using procedure $p_2$.
						    \item Hence show that $\lVert\exp_n(\frac{k-j}{K}\tau_mi)-1\rVert^2\ge{a_3}^2>0$ using procedure $p_3$.
						    \item Show that $\lVert\frac{k-j}{K}\tau_mi\rVert^2\le\lVert\frac{k-j}{K}\rVert^2\lVert\tau_m\rVert^2\le\lVert\tau_m\rVert^2\le{a_1}^2$ given that $0<\frac{k-j}{K}\le\frac{1}{2}$.
						    \item Show that $n\ge b\ge\frac{2a_4{a_1}^2}{a_2a_3}$.
						    \item Hence show that $\lVert\exp_n(\frac{k-j}{K}\tau_mi)\exp_n(\frac{j}{K}\tau_mi)-\exp_n(\frac{k-j}{K}\tau_mi+\frac{j}{K}\tau_mi)\rVert^2\le\frac{{a_4}^2\lVert\frac{k-j}{K}\tau_mi\rVert^2\lVert\frac{j}{K}\tau_mi\rVert^2}{n^2}\le\frac{{a_4}^2{a_1}^4}{n^2}\le(\frac{a_2a_3}{2})^2$ using procedure $p_4$.
						    \item Hence using \procedurehr{sat1708191238}, show that $\lVert\exp_n(\frac{k}{K}\tau_mi)-\exp_n(\frac{j}{K}\tau_mi)\rVert^2$
						    \begin{enumerate}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \item Hence show that $\lVert\exp_n(\frac{j}{K}\tau_mi)-\exp_n(\frac{k-K}{K}\tau_mi)\rVert^2\ge{a_1}^2$ using procedure $p_1$.
						    \item Show that $m\ge cn\ge\frac{b_2}{b}b=b_2$.
						    \item Hence show that $\tau_m\le a_2$ using procedure $p_2$.
						    \item Hence show that $\lVert\frac{k}{K}\tau_mi\rVert^2=\lVert\frac{k}{K}\rVert^2\lVert\tau_m\rVert^2\le\lVert\tau_m\rVert^2\le{a_2}^2$.
						    \item Also show that $m\ge cn\ge\frac{d_3}{b}b=d_3$.
						    \item Hence show that $\lVert i^{-4}\exp_n(\frac{k}{K}\tau_mi)-\exp_n(\frac{k}{K}\tau_mi-\frac{4}{4}\tau_mi)\rVert^2\le(\frac{a_3n}{m}+\frac{b_3}{n})^2\le(\frac{a_1}{2})^2$ using procedure $p_3$.
						    \item Now show that $\lVert\exp_n(\frac{k}{K}\tau_mi)-\exp_n(\frac{j}{K}\tau_mi)\rVert^2$
						    \begin{enumerate}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \begin{enumerate}
						      \item Show that $m\ge cn\ge\frac{c_1}{b}b=c_1$.
							    \item \textbf{Hence show that $\lVert\exp_n(\frac{k}{K}\tau_mi)-\exp_n(\frac{j}{K}\tau_mi)\rVert^2\ge a_1\ge a$ using procedure $p_1$.}
						    \end{enumerate}
						    \item Otherwise if $k-j>\frac{K}{2}$, then do the following:
						    \begin{enumerate}
							    \item \textbf{Show that $\lVert\exp_n(\frac{k}{K}\tau_mi)-\exp_n(\frac{j}{K}\tau_mi)\rVert^2\ge a_2\ge a$ using procedure $p_2$.}
						    \end{enumerate}
					    \end{enumerate}
					    \item \textbf{Yield the tuple $\langle a,b,c,p\rangle$.}
				    \end{enumerate}
		    ...
		    \procedure{3.64}
			    \objective
				    ...
				    \begin{enumerate}
					    \item $z_k=\exp_n(\frac{K-k-1}{K}\tau_mi)$ for $k\in[0:K]$
					    \item $q_K=\lambda^K-1$
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \begin{enumerate}
							    \item \textbf{Let $z_k=\exp_n(\frac{K-k-1}{K}\tau_mi)$.}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \begin{enumerate}
							    \item Show that $\lVert\frac{j}{K}\tau_mi\rVert^2=\lVert\frac{j}{K}\rVert^2\lVert\tau_m\rVert^2\le\lVert\tau_m\rVert^2\le a_2$.
							    \item Hence show that $\lVert z_j\rVert^2=\lVert\exp_n(\frac{j}{K}\tau_mi)\rVert^2\le a_3$ using procedure $p_3$.
						    \end{enumerate}
		    ...
		    \procedure{3.66}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \item Let $p(x,n,m)$ be the following procedure:
					    \begin{enumerate}
						    \item Show that $\lVert\sum_r^{[0:K]}x^r-\prod_r^{[1:K]}(x-\exp_n(\frac{r}{K}\tau_mi))\rVert^2\le(\frac{a_1n}{m}+\frac{b_1}{n})^2$ using procedure $p_1$.
						    \item Hence show that $\lVert x^K-1-\prod_r^{[0:K]}(x-\exp_n(\frac{r}{K}\tau_mi))\rVert^2$
						    \begin{enumerate}
			    ...
			    \implementation
				    \begin{enumerate}
					    ...
					    \begin{enumerate}
						    ...
						    \item Hence show that $\lVert(1+\frac{x}{K})^K-1-\prod_r^{[0:K]}(1+\frac{x}{K}-\exp_n(\frac{r}{K}\tau_mi))\rVert^2\le(\frac{a_1n}{m}+\frac{b_1}{n})^2$ using procedure $p_1$.
						    \item Hence show that $\lVert K-\prod_r^{[1:K]}(1-\exp_n(\frac{r}{K}\tau_mi))\rVert^2=\sum_r^{[0:K]}1^r-\prod_r^{[1:K]}(1-\exp_n(\frac{r}{K}\tau_mi))\rVert^2\le(\frac{a_2n}{m}+\frac{b_2}{n})^2$ using procedure $p_2$.
						    \item For $j\in[1:K]$, do the following:
						    \begin{enumerate}
							    \item Show that $\lVert\exp_n(\frac{j}{K}\tau_mi)-1\rVert^2\ge{a_3}^2$ using procedure $p_3$.
					      ...
					      \begin{instructions}
					        ...
					        \begin{instructions}
					          ...
					          \begin{instructions}
					            ...
					            \begin{instructions}
					              \item Show that $\lVert ix\rVert^2=\lVert x\rVert^2\le X^2$.
					            \end{instructions}
					          \end{instructions}
		      ...
		      \implementation
		        \begin{enumerate}
		          ...
		          \begin{enumerate}
		            ...
		            \begin{enumerate}
		              \item Show that $\lVert\frac{x}{i}\rVert^2=\lVert x\rVert^2\ge X^2$.
		              \item Show that $\Re(\frac{x}{i})=\Re(\Im(x)-\Re(x)i)=\Im(x)\ge 0$.
		              \item Hence show that $\lVert\ln_k(\frac{x}{i})\rVert^2\le{a_1}^2$ using procedure $p_1$.
		              \item \textbf{Hence show that $\lVert\ln_k(x)\rVert^2=\lVert\ln_k(\frac{x}{i})+\frac{\tau_k}{4}i\rVert^2\le(a_1+\frac{a_2}{4})^2=a^2$.}
		            \end{enumerate}
		            \item Otherwise do the following:
		            \begin{enumerate}
		              \item Show that $\lVert xi\rVert^2=\lVert x\rVert^2\ge X^2$.
		              \item Show that $\Re(xi)=\Re(-\Im(x)+\Re(x)i)=-\Im(x)>0$.
		              \item Hence show that $\lVert\ln_k(xi)\rVert^2\le{a_1}^2$ using procedure $p_1$.
		              \item \textbf{Hence show that $\lVert\ln_k(x)\rVert^2=\lVert\ln_k(xi)-\frac{\tau_k}{4}i\rVert^2\le(a_1+\frac{a_2}{4})^2=a^2$.}
		            \end{enumerate}
		          \end{enumerate}
		          \item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
		        \end{enumerate}
		        ...
		        \begin{enumerate}
		          ...
		          \begin{enumerate}
		            ...
		            \begin{enumerate}
		              \item Show that $\lVert\frac{x}{i}\rVert^2=\lVert x\rVert^2\ge X^2$.
		              \item Show that $\Re(\frac{x}{i})=\Re(\Im(x)-\Re(x)i)=\Im(x)\ge 0$.
		              \item Hence show that $\exp_n(\ln_k(\frac{x}{i}))\equiv\frac{x}{i}\err{\frac{a_2n}{k}+\frac{b_1}{n}}$ using procedure $p_1$.
		              \item Hence show that $\lVert\ln_k(\frac{x}{i})\rVert^2\le{a_2}^2$ using procedure $p_2$.
		            ...
		            \begin{enumerate}
		              \item Show that $\lVert xi\rVert^2=\lVert x\rVert^2\ge X^2$.
		              \item Show that $\Re(xi)=\Re(-\Im(x)+\Re(x)i)=-\Im(x)>0$.
		              \item Hence show that $\exp_n(\ln_k(xi))\equiv xi\err{\frac{a_2n}{k}+\frac{b_1}{n}}$ using procedure $p_1$.
		              \item Hence show that $\lVert\ln_k(xi)\rVert^2\le{a_2}^2$ using procedure $p_2$.
		              \item Hence using procedure $p_3$, show that $\exp_n(\ln_k(x))$
		              \begin{enumerate}
