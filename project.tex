...
\newcommand{\procedure}[1]{
	...
	\subsection*{Procedure \theproceduretemp}
...
\newglossaryentry{differentialdiff}{name=\ensuremath{\diff_{x=y}^zf(x)},description={differentiation}}
\newglossaryentry{differentialintegral}{name=\ensuremath{\int_r^Rf(\#r,r,dr)},description={complex integral}}
...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\procedure{3.15}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct rational numbers $a,b$ such that $a>0$, and a procedure, $p$, to show that $\lVert\exp_n(x)\exp_n(y)-\exp_n(x+y)\rVert^2\le\frac{a^2\lVert xy\rVert^2}{n^2}$ when two complex numbers $x,y$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X^2$, $\lVert y\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{thu2507191359}
		  \objective
		    Choose a rational number $X\ge 0$. The objective of the following instructions is to construct rational numbers $a,b$ such that $a>0$ and a procedure $p(x,y,n)$ to show that $\lVert\exp_n(x-y)-\frac{\exp_n(x)}{\exp_n(y)}\rVert^2\le(\frac{a}{n})^2$ when two complex numbers $x,y$ and a positive integer $n$ such that $\lVert x\rVert^2\le X$, $\lVert y\rVert^2\le X$, and $n>b$ are chosen.
		  \implementation
		    \begin{enumerate}
		...
		\procedure{3.16}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct positive rational numbers $a,b$ and a procedure, $p(x,k,n)$, to show that $\lVert\exp_n(kx)-\exp_n(x)^k\rVert^2\le(\frac{ak}{n})^2$ when a complex number $x$, and non-negative integers $k,n$ such that $n>b$ and $\lVert kx\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.21}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,N$, and a procedure, $p(x,n)$, to show that $\lVert\sum_r^{[0:{n+1}]}\frac{x^r}{r!}-\exp_n(x)\rVert^2\le(\frac{a}{n})^2$ when a complex number $x$ and an integer $n>N$ such that $\lVert x\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
	...
	\begin{multicols}{2}
		...
		\procedure{3.24}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,b$, and a procedure, $p(x,y,n)$, to show that $\lVert\cos_n(x)\cos_n(y)-\sin_n(x)\sin_n(y)-\cos_n(x+y)\rVert^2\le\frac{a^2\lVert xy\rVert^2}{n^2}$ when two complex numbers $x,y$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X^2$ and $\lVert y\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.25}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,b$, and a procedure, $p(x,y,n)$, to show that $\lVert\sin_n(x)\cos_n(y)-\cos_n(x)\sin_n(y)-\sin_n(x+y)\rVert^2\le\frac{a^2\lVert xy\rVert^2}{n^2}$ when two complex numbers $x,y$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X^2$ and $\lVert y\rVert^2\le X^2$ are chosen.
			\implementation
				Implementation is analogous to that of \procedurehr{3.24}.
		\procedure{3.26}
			\objective
				 Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,b$, and a procedure, $p(x,n)$, to show that $\lVert\cos_n(x)^2+\sin_n(x)^2-1\rVert^2\le\frac{a^2\lVert x\rVert^4}{n^2}$ when a complex number $x$ and a positive integer $n$ such that $\lVert x\rVert^2\le X^2$ and $n>b$ are chosen.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.15} on $\langle X\rangle$ and let $\langle a,b,q\rangle$ receive.
					\item Let $p(x,n)$ be the following procedure:
		...
		\procedure{sat0308190647}
		  \objective
		    Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,b$, and a procedure, $p(x,y,n)$, to show that $\lVert\lVert x\exp_n(iy)\rVert^2-\lVert x\rVert^2\rVert^2\le\frac{a^2\lVert x\rVert^4\lVert y\rVert^4}{n^2}$ when a complex number $x$, a rational number $y$, and a positive integer $n$ such that $\lVert y\rVert^2\le X^2$ and $n>b$ are chosen.
		  \implementation
		    \begin{enumerate}
		...
		\procedure{3.29}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,N$, and a procedure, $p(x,n)$, to show that $\lVert\sum_r^{[0:\lceil\frac{n}{2}\rceil]}\frac{(-1)^rx^{2r}}{(2r)!}-\cos_n(x)\rVert^2\le(\frac{a}{n})^2$ when a complex number $x$ and an integer $n>N$ such that $\lVert x\rVert^2\le X^2$ is chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.30}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,N$, and a procedure, $p(x,n)$, to show that $\lVert\sum_r^{[0:\lfloor\frac{n+1}{2}\rfloor]}\frac{(-1)^rx^{2r+1}}{(2r+1)!}-\sin_n(x)\rVert^2\le(\frac{a}{n})^2$ when a complex number $x$ and an integer $n>N$ such that $\lVert x\rVert^2\le X^2$ is chosen.
			\implementation
	  ...
	  \procedure{wed2407191521}
	    \objective
	      Choose two rational numbers $A>0$, $1>X>0$. The objective of the following instructions is to construct rational numbers $D>0$, $0<G<1$, and a procedure $p(x,a,b,n)$ to show that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2\le(DG^n)^2$ when $\lVert x\rVert^2\le X$, and $\lVert a\rVert^2,\lVert b\rVert^2<A$.
	    \implementation
	      \begin{enumerate}
	  ...
	  \procedure{wed2407191627}
	    \objective
	      Choose two rational numbers $A>0$, $1>X>0$. The objective of the following instructions is to construct rational numbers $G>0$, $0<C<1$, and a procedure $p(x,n,a,k)$ to show that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2\le(GkC^n)^2$ when a non-negative integer $k$ and complex numbers $x,a$ such that $\lVert x\rVert^2\le X^2$ and $\lVert ka\rVert^2<A^2$ are chosen.
	    \implementation
	      \begin{enumerate}
	  ...
	  \procedure{thu2507190646}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct rational numbers $B>0$, $N>0$, and a procedure $p(x,a,b,n)$ to show that $\lVert(1+x)_n^a(1+x)_n^b-(1+x)_n^{a+b}\rVert^2\le(\frac{B}{n})^2$ when a complex number $x$, two rational numbers $a,b$, and a positive integer $n$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $0<a<1$, $0<b<1$, and $n>N$ are chosen.
	    \implementation
	      \begin{enumerate}
	  ...
	  \procedure{thu2507190752}
	    \objective
	      Choose a rational number $0<X<2$. The objective of the following instructions is to construct positive rational numbers $G,N$ and a procedure $p(x,n,a,k)$ to show that $\lVert(1+x)_n^{ka}-((1+x)_n^a)^k\rVert^2\le(\frac{Gk}{n})^2$ when positive integers $n,k$, a rational number $a$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x+1)\ge X$, $k>1$, $0<ka\le 1$, and $n>N$ are chosen.
	    \implementation
	      \begin{enumerate}
	  ...
	  \procedure{fri2607191210}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct positive rational numbers $a,c$ such that $b>1$, and a procedure $p(x,n,k)$ to show that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{an}{k})^2$ when a complex number $x$, and positive integers $n,k$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $n>1$, and $k>c$ are chosen.
	    \implementation
	      \begin{enumerate}
    ...
    \declaration{fri2607191453}
	  ...
	  \procedure{fri2607191450}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a positive rational number $a$ and a procedure $p(x,n,k)$ to show that $\lVert n((1+x)_k^{\frac{1}{n}}-1)-\ln_k(1+x)\rVert^2\le(\frac{a}{n})^2$ when positive integers $n,k$ and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $a=\frac{1}{X}$.
	        \item Let $p(x,n,k)$ be the following procedure:
	  ...
	  \procedure{fri2607191801}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct positive rational numbers $a,c,d,e$ such that $b>1$, and a procedure $p(x,n,k)$ to show that $\lVert\exp_n(\ln_k(1+x))-(1+x)\rVert^2\le(\frac{an}{k}+\frac{c}{n})^2$ when positive integers $n,k$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $k>d$, and $n>e$ are chosen.
	    \implementation
	      \begin{enumerate}
		...
		\procedure{3.53}
			\objective
				The objective of the following instructions is to construct positive rational numbers $a,c,d,e$, and a procedure $p(n,k)$ to show that $\lVert\exp_n(\frac{1}{4}\tau_ki)-i\rVert^2\le(\frac{an}{k}+\frac{c}{n})^2$ when integers $k,n$ such that $n>e$ and $k>d$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.54}
			\objective
				The objective of the following instructions is to construct positive rational numbers $a,c,d,e$ such that $b>1$, and a procedure, $p(n,k)$, to show that $\lVert\exp_n(-\frac{1}{4}\tau_ki)+i\rVert^2\le(\frac{an}{k}+\frac{c}{n})^2$ when integers $k,n$ such that $n>e$ and $k>d$ are chosen.
			\implementation
				Implementation is analogous to that of \procedurehr{3.53}.
		\procedure{3.55}
			\objective
				Choose an integer $K\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,m,k)$, to show that $\lVert\exp_n(\frac{k}{4}\tau_m i)-i^k\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when a non-negative integer $k$ and two positive integers $n,m$ such that $k\le K$, $n>c$, and $m>d$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.56}
			\objective
				Choose an integer $K\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,m,k)$, to show that $\lVert\exp_n(\frac{k}{4}\tau_m i)-i^k\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and two positive integers $n,m$ such that $\lvert k\rvert\le K$, $n>c$, and $m>d$ are chosen.
			\implementation
				Implementation is an extension of that of \procedurehr{3.55} using \procedurehr{3.54}.
		\procedure{3.57}
			\objective
				Choose an integer $K\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,m,k)$, to show that $\lVert\cos_n(\frac{k}{4}\tau_m)-\frac{i^k+(-i)^k}{2}\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and two positive integers $n,m$ such that $\lvert k\rvert\le K$, $n>c$, and $m>d$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.58}
			\objective
				Choose an integer $K\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,m,k)$, to show that $\lVert\sin_n(\frac{k}{4}\tau_m)-\frac{i^k-(-i)^k}{2i}\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and two positive integers $n,m$ such that $\lvert k\rvert\le K$, $n>c$, and $m>d$ are chosen.
			\implementation
				Implementation is analogous to that of \procedurehr{3.57}.
		\procedure{3.59}
			\objective
				Choose two integers $X\ge 0,K\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(x,n,m,k)$, to show that $\lVert\exp_n(x+\frac{k}{4}\tau_m i)-i^k\exp_n(x)\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and two positive integers $n,m$ such that $\lVert x\rVert^2\le X$, $\lvert k\rvert\le K$, $n>c$, and $m>d$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.89}
			\objective
				Choose a positive integer $K$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(n,m,k)$, to show that $\lVert\exp_n(\frac{k}{K}\tau_m i)^K-1\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when an integer $k$ and positive integers $n,m$ such that $0\le k<K$, $n\ge c$, and $m>d$ are chosen.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.50} and let $\langle a_1,b_1,p_1\rangle$ receive.
	...
	\begin{multicols}{2}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence verify that $\lVert\exp_n(\frac{k-j}{K}\tau_mi)\exp_n(\frac{j}{K}\tau_mi)-\exp_n(\frac{k-j}{K}\tau_mi+\frac{j}{K}\tau_mi)\rVert^2\le\frac{{a_4}^2\lVert\frac{k-j}{K}\tau_mi\rVert^2\lVert\frac{j}{K}\tau_mi\rVert^2}{n^2}\le\frac{{a_4}^2{a_1}^4}{n^2}$.
						...
						\begin{enumerate}
							...
							\item $\ge\frac{1}{2}{a_2}^2{a_3}^2-\frac{{a_4}^2{a_1}^4}{n^2}$
							\item $\ge a^2$.
						\end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,c,p\rangle$.}
		...
		\procedure{3.64}
			\objective
				...
				\begin{enumerate}
					...
					\item $\lVert\Lambda(q_k,z_j)\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ for $j\in[0:k]$, for $k\in[0:K+1]$
				\end{enumerate}
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Let $r_k=q_{k+1}\mod(\lambda-z_k)$.
			...
			\subsubsection*{Auxilliary procedure}\label{sec:procedure 77 auxilliary procedure}
			  \paragraph{Objective}
			    Choose a non-negative integer $k$, a complex polynomial $q_{k+1}$, and a list of complex numbers $z$ such that $z_j=\exp_n(\frac{j}{K}\tau_mi)$ and $\lVert\Lambda(q_{k+1},z_j)\rVert^2\le(\frac{2}{a_2})^{K-(k+1)}$ for $j\in[k+1:0]$. Let $q_k=q_{k+1}\div(\lambda-z_k)$. The objective of the following instructions is to show that $\lVert\Lambda(q_{k},z_j)\rVert^2\le(\frac{2}{a_2})^{K-k}(\frac{a_1n}{m}+\frac{b_1}{n}))^2\le(\frac{an}{m}+\frac{b}{n})^2$ for $j\in[k:0]$.
			  \paragraph{Implementation}
			    \begin{enumerate}
		...
		\procedure{3.65}
			\objective
				Choose a rational number $X$ and a positive integer $K$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(x,n,m)$, to show that $\lVert \sum_r^{[0:K]}x^r-\prod_r^{[1:K]}(x-\exp_n(\frac{r}{K}\tau_mi))\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when a complex number $x$ and positive integers $n,m$ such that $n>c$, $\frac{m}{n}>d$, and $\lVert x\rVert^2\le X$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.66}
			\objective
				Choose a rational number $X$ and a positive integer $K$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(x,n,m)$, to show that $\lVert x^K-1-\prod_r^{[0:K]}(x-\exp_n(\frac{r}{K}\tau_mi))\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when a complex number $x$ and positive integers $n,m$ such that $n>c$, $\frac{m}{n}>d$, and $\lVert x\rVert^2\le X$ are chosen.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.67}
			\objective
				Choose a rational number $X$ and a positive integer $K$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, and a procedure, $p(x,n,m)$, to show that $\lVert\exp_K(x)-1-x\prod_r^{[1:K]}(1-\frac{x}{K(\exp_n(\frac{r}{K}\tau_mi)-1)})\rVert^2\le(\frac{an}{m}+\frac{b}{n})^2$ when a complex number $x$ and positive integers $n,m$ such that $n>c$, $\frac{m}{n}>d$, and $\lVert x\rVert^2\le X$ are chosen.
			\implementation
				\begin{enumerate}
	  ...
	  \declaration{3.29}
		...
		\procedure{sat0308191134}
		  \objective
		    ...
		    \begin{enumerate}
		      \item A procedure $q_1(x,n,\delta)$ to show that $\lVert\frac{p_n(x+\delta)-p_n(x)}{\delta}-p'_n(x)\rVert^2\le\frac{a_1}{n^2}+b_1\lVert\delta\rVert^2$ when two complex numbers $x,\delta$ and a positive integer $n$ such that $P(x)$, $n>c_1$, and $\lVert\delta\rVert^2<d_1$ are chosen
		      \item A procedure $q_2(x,n)$ to show that $\lVert p'_n(x)\rVert^2\le a_2$ when a complex number $x$ and a positive integer $n$ such that $Q(x)$, and $n>b_2$ are chosen
		      \item A procedure $q_3(x,n,\delta)$ to show that $\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)\rVert^2\le\frac{a_3}{n^2}+b_3\lVert\delta\rVert^2$ when two complex numbers $x,\delta$ and a positive integer $n$ such that $R(x)$, $n>c_3$, and $\lVert\delta\rVert^2<d_3$ are chosen
		      \item A procedure $q_4(x,n)$ to show that $\lVert t'_n(x)\rVert^2\le a_4$ when a complex number $x$ and a positive integer $n$ such that $S(x)$, and $n>b_4$ are chosen.
		    \end{enumerate}
		    The objective of the following instructions is to construct the following:
		    \begin{enumerate}
		      \item Rational numbers $a_5,b_5,c_5,d_5,a_6,b_6$.
		      \item Predicates $T(x), U(x)$.
		      \item A procedure $q_5(x,n,\delta)$ to show that $\lVert\frac{p_n(t_n(x+\delta))-p_n(t_n(x))}{\delta}-p'_n(t_n(x))t'_n(x)\rVert^2\le \frac{a_5}{n^2}+b_5\lVert\delta\rVert^2$ when two complex numbers $x,dx$ such that $T(x)$, $n>c_5$, and $\lVert\delta\rVert^2<d_5$ are chosen
		      \item A procedure $q_6(x,n)$ to show that $\lVert p'_n(t_n(x))t'_n(x)\rVert^2\le a_6$ when a complex number $x$ such that $U(x)$, and $n>b_6$ are chosen.
		    \end{enumerate}
		  \implementation
		    \begin{enumerate}
		      \item Let $a_5=3(a_1a_3+a_1a_4+a_2a_3)$.
		      \item Let $b_5=3(a_1b_3+b_1a_3+b_1b_3+b_1a_4+a_1b_3)$.
		      \item Let $c_5=\max(c_1,b_2,c_3,b_4)$.
		      \item Let $d_5=\min(1,d_3,\frac{d_1}{2(a_3+b_3+a_4)})$.
		      \item Let $a_6=a_2a_4$.
		      \item Let $b_6=\max(c_1,b_2,c_3,b_4)$.
		      \item Let $T(x)$ be $R(x),S(x),P(t_n(x)),Q(t_n(x))$.
		      \item Let $U(x)$ be $Q(t_n(x)),S(x)$.
		      \item Let $q_5(x,n,\delta)$ be the following procedure:
		      \begin{enumerate}
		        \item Execute procedure $q_3$ on $\langle x,n,\delta\rangle$.
		        \item Hence verify that $\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)\rVert^2\le\frac{a_3}{n^2}+b_3\lVert\delta\rVert^2$.
		        \item Execute procedure $q_4$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t'_n(x)\rVert^2\le a_4$.
		        ...
		        \begin{enumerate}
		          ...
		          \item $\le 2(\lVert\frac{t_n(x+\delta)-t_n(x)}{\delta}-t'_n(x)\rVert^2+\lVert t'_n(x)\rVert^2)\lVert\delta\rVert^2$
		          \item $\le 2(\frac{a_3}{n^2}+b_3\lVert\delta\rVert^2+a_4)\lVert\delta\rVert^2$
		          \item $\le 2(a_3+b_3+a_4)d_5$
		          \item $\le d_1$.
		        \end{enumerate}
		        \item Execute procedure $q_1$ on $\langle t_n(x),n,t_n(x+\delta)-t_n(x)\rangle$.
		        \item Hence verify that $\lVert\frac{p_n(t_n(x)+(t_n(x+\delta)-t_n(x)))-p_n(t_n(x))}{t_n(x+\delta)-t_n(x)}-p'_n(t_n(x))\rVert^2\le\frac{a_1}{n^2}+b_1\lVert\delta\rVert^2$.
		        \item Execute procedure $q_2$ on $\langle t_n(x)\rangle$.
		        \item Hence verify that $\lVert p'_n(t_n(x))\rVert^2\le a_2$.
		        ...
		        \begin{enumerate}
		          ...
		          \item $\le 3(\lVert\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}-p'(t(x))\rVert^2\lVert\frac{t(x+\delta)-t(x)}{\delta}-t'(x)\rVert^2+\lVert\frac{p(t(x)+(t(x+\delta)-t(x)))-p(t(x))}{t(x+\delta)-t(x)}-p'(t(x))\rVert^2\lVert t'(x)\rVert^2+\lVert p'(t(x))\rVert^2\lVert\frac{t(x+\delta)-t(x)}{\delta}-t'(x)\rVert^2)$
		          \item $\le 3((\frac{a_1}{n^2}+b_1\lVert\delta\rVert^2)(\frac{a_3}{n^2}+b_3\lVert\delta\rVert^2)+(\frac{a_1}{n^2}+b_1\lVert\delta\rVert^2)a_4+a_2(\frac{a_3}{n^2}+b_3\lVert\delta\rVert^2))$.
		          \item $\le\frac{a_5}{n^2}+b_5\lVert\delta\rVert^2$.
		        \end{enumerate}
		      \end{enumerate}
		      \item Let $q_6(x,n)$ be the following procedure:
		      \begin{enumerate}
		        \item Execute procedure $q_2$ on $\langle t_n(x),n\rangle$.
		        \item Hence verify that $\lVert p'_n(t_n(x))\rVert^2\le a_2$.
		        \item Execute procedure $q_4$ on $\langle x,n\rangle$.
		        \item Hence verify that $\lVert t'_n(x)\rVert^2\le a_4$.
		        \item Hence verify that $\lVert p'_n(t_n(x))t'_n(x)\rVert^2\le a_2a_4=a_6$.
		      \end{enumerate}
		      \item \textbf{Yield the tuple $\langle q_5,q_6\rangle$.}
		    \end{enumerate}
		\procedure{3.17}
			\objective
