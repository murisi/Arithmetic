...
\begin{document}
	...
	\section{Introduction}
		...
		\textbf{One way to use this exposition to understand linear algebra is to go through the algorithms in order and execute each one on one or two inputs.} At any rate, please be taking the following into consideration:
		\begin{enumerate}
