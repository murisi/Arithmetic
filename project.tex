...
\begin{document}
	...
	\begin{minipage}[c]{0.35\textwidth}
		A plot of the list of complex numbers $(1+\frac{6i}{10})^{[0:11]}$. Notice that each multiplication of a complex number by $1+\frac{6i}{10}$ results in an anti-clockwise rotation about the origin and a small radial movement outwards. This can be seen to reflect the computation $(1+\frac{6i}{10})a=a+\frac{6}{10}(ai)$ after one notes that $ai$ is perpendicular to $a$.
	\end{minipage}
	\begin{multicols}{2}
		\declaration{3.17}
