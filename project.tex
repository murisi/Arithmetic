	...
	\begin{multicols}{2}
	  ...
	  \procedure{tue2008190849}
	    ...
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{wed2407191521} on $\langle A,X\rangle$ and let $\langle a_1,b_1,p_1\rangle$ receive.
	        \item Execute \procedurehr{tue2008190712} on $\langle A,X\rangle$ and let $\langle a_2,b_2,p_2\rangle$ receive.
	        \item Execute \procedurehr{wed2407191611} on $\langle A,X\rangle$ and let $\langle a_3,p_3\rangle$ receive.
	        ...
	        \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(\frac{a_1{b_1}^n}{a_2})^2$.
	          \end{enumerate}
	          \item Execute procedure $p_3$ on $\langle x,n,a,1\rangle$.
	          \item Hence verify that $\lVert((1+x)_n^a)^1\rVert^2\le{a_3}^2$.
	          \item Execute procedure $p_1$ on $\langle x,a,-b,n\rangle$.
	          \item Hence verify that $\lVert(1+x)_n^a(1+x)_n^{-b}-(1+x)_n^{a-b}\rVert^2\le(a_1{b_1}^n)^2$.
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(a_1{b_1}^n+a_3\cdot\frac{a_1{b_1}^n}{a_2})^2$
	            \item $=((1+\frac{a_3}{a_2})a_1{b_1}^n)^2$
	            \item $=(BC^n)^2$.
	          \end{enumerate}
	        \end{enumerate}
