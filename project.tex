...
\newcommand{\declaration}[2][]{\subsubsection*{Declaration #2}\ifthenelse{\equal{#1}{}}{}{\label{sec:declaration #1}\expandafter\newcommand\csname declaration#1\endcsname{#2}}}
\newcommand{\procedure}[2][]{\subsection*{Procedure #2}\ifthenelse{\equal{#1}{}}{}{\label{sec:procedure #1}\expandafter\newcommand\csname procedure#1\endcsname{#2}}}
...
\begin{document}
	...
	\twocolumn[\part{Integer Arithmetic}]
		\declaration[1.22]{1.00}
			The phrase "integer" will be used as a shorthand for an ordered pair of natural numbers.
		\declaration[1.23]{1.01}
			The phrase "the positive part of $a$" and the notation $\Po(a)$, where $a$ is an integer, will be used as a shorthand for the first entry of $a$.
		\declaration[1.24]{1.02}
			The phrase "the negative part of $a$" and the notation $\Ne(a)$, where $a$ is an integer, will be used as a shorthand for the second entry of $a$.
		\declaration[1.25]{1.03}
			The phrase "$a=b$", where $a,b$ are integers, will be used as a shorthand for "$\Po(a)+\Ne(b)=\Ne(a)+\Po(b)$".
		\procedure[1.65]{1.00}
			\objective
		...
		\procedure[1.67]{1.02}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[1.26]{1.04}
			The notation $a+b$, where $a,b$ are integers, will be used as a shorthand for the pair $\langle\Po(a)+\Po(b),\Ne(a)+\Ne(b)\rangle$.
		\procedure[1.68]{1.03}
			\objective
		...
		\procedure[1.71]{1.06}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[1.28]{1.06}
			The notation $-a$, where $a$ is an integer, will be used as a shorthand for the pair $\langle\Ne(a),\Po(a)\rangle$.
		\procedure[1.72]{1.07}
			\objective
		...
		\procedure[1.73]{1.08}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[1.29]{1.07}
			The notation $ab$, where $a,b$ are integers, will be used as a shorthand for the pair $\langle\Po(a)\Po(b)+\Ne(a)\Ne(b),\Po(a)\Ne(b)+\Ne(a)\Po(b)\rangle$.
		\procedure[1.74]{1.09}
			\objective
		...
		\procedure[1.78]{1.13}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[1.30]{1.08}
			The phrase "$a<b$", where $a,b$ are rational numbers, will be used as a shorthand for "$\Po(a)+\Ne(b)<\Ne(a)+\Po(b)$".
		\procedure[1.79]{1.14}
			\objective
		...
		\procedure[1.59]{1.79}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[1.20]{1.31}
			The notation $a^{\ul{b}}$ will be used as a shorthand for $\prod_i^{[0:b]}(a-i)$.
		\declaration[1.33]{1.32}
			The notation $a^{\ol{b}}$ will be used as a shorthand for $\prod_i^{[0:b]}(a+i)$.
		\procedure[1.60]{1.80}
			\objective
	...
	\twocolumn[\part{Rational Arithmetic}]
		...
		\declaration[2.13]{2.01}
			The phrase "the numerator of $a$" and the notation $\Nu(a)$, where $a$ is a rational number, will be used as a shorthand for the first entry of $a$.
		\declaration[2.14]{2.02}
			The phrase "the denominator of $a$" and the notation $\De(a)$, where $a$ is a rational number, will be used as a shorthand for the second entry of $a$.
		\declaration[2.15]{2.03}
			The phrase "$a=b$", where $a,b$ are rational numbers, will be used as a shorthand for "$\Nu(a)\De(b)=\De(a)\Nu(b)$".
		\procedure[2.27]{2.00}
			\objective
		...
		\procedure[2.29]{2.02}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Hence verify that $a=c$.}
				\end{enumerate}
		\declaration[2.16]{2.04}
			The notation $a+b$, where $a,b$ are rational numbers, will be used as a shorthand for the pair $\langle\Nu(a)\De(b)+\De(a)\Nu(b),\De(a)\De(b)\rangle$.
		\procedure[2.30]{2.03}
			\objective
		...
		\procedure[2.33]{2.06}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.18]{2.06}
			The notation $-a$, where $a$ is a rational number, will be used as a shorthand for the pair $\langle-\Nu(a),\De(a)\rangle$.
		\procedure[2.34]{2.07}
			\objective
		...
		\procedure[2.35]{2.08}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.19]{2.07}
			The notation $ab$, where $a,b$ are rational numbers, will be used as a shorthand for the pair $\langle\Nu(a)\Nu(b),\De(a)\De(b)\rangle$.
		\procedure[2.36]{2.09}
			\objective
		...
		\procedure[2.50]{2.23}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Hence verify that $0<ab$.}
				\end{enumerate}
		\declaration[2.02]{2.11}
			The notation $\lfloor a\rfloor$, where $a$ is a rational number, will be used as a shorthand for $\Nu(a)\div\De(a)$.
		\declaration[2.03]{2.12}
			The notation $\lceil a\rceil$, where $a$ is a rational number, will be used as a shorthand for $(\Nu(a)\div\De(a))+1$.
		\procedure[2.04]{2.24}
			\objective
		...
		\declaration[2.23]{2.14}
			The notation $\min_{r}^R c_r$, where $R$ is a list, will be used as a shorthand for $\min(c(R))$.
		\declaration[2.11]{2.15}
		...
		\declaration[2.24]{2.16}
			The notation $\max_{r}^R c_r$, where $R$ is a list, will be used as a shorthand for $\max(c(R))$.
		\declaration[2.25]{2.17}
			The phrase "polynomial" will be used as a shorthand for a list of rational numbers.
		\declaration[2.26]{2.18}
			The notation $a_i$, where $a$ is a polynomial and $i$ is a natural number such that $i\ge\lvert a\rvert$, will be used as a shorthand for $0$.
		\declaration[2.27]{2.19}
			The phrase "$a=b$", where $a,b$ are polynomials, will be used as a shorthand for "$a_i=b_i$ for each $i\in[0:\max(\lvert a\rvert,\lvert b\rvert)]$".
		\declaration[2.28]{2.20}
			The notation $\Lambda(a,b)$, where $a$ is a polynomial and $b$ is a rational number, will be used as a shorthand for $\sum_r^{[0:\lvert a\rvert]}a_rb^r$.
		\procedure[2.51]{2.28}
			\objective
		...
		\procedure[2.55]{2.32}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Hence verify that $a=c$.}
				\end{enumerate}
		\declaration[2.29]{2.21}
			The notation $a+b$, where $a,b$ are polynomials, will be used as a shorthand for the list $\langle a_i+b_i\for i\in[0:\max(\lvert a\rvert,\lvert b\rvert)]\rangle$.
		\procedure[2.56]{2.33}
			\objective
		...
		\procedure[2.60]{2.37}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.30]{2.22}
			The notation $a$, where $a$ is a rational number, will contextually be used as a shorthand for the list $\langle a\rangle$.
		\procedure[2.61]{2.38}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.31]{2.23}
			The notation $-a$, where $a$ is a polynomial, will be used as a shorthand for the list $\langle-a_i\for i\in[0:\lvert a\rvert]\rangle$.
		\procedure[2.62]{2.39}
			\objective
		...
		\procedure[2.63]{2.40}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.32]{2.24}
			The notation $ab$, where $a,b$ are integers, will be used as a shorthand for the list $\langle\sum_r^{[0:i+1]}a_rb_{i-r}\for i\in[0:\lvert a\rvert+\lvert b\rvert-1]\rangle$.
		\procedure[2.64]{2.41}
			\objective
		...
		\procedure[2.25]{2.56}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[2.35]{2.27}
			The notation $a\div b$, where $a,b$ are polynomials, will be used to refer to the first part of the pair yielded by executing \procedurehr{2.25} on $\langle a,b\rangle$.
		\declaration[2.36]{2.28}
			The notation $a\mod b$, where $a,b$ are polynomials, will be used to refer to the second part of the pair yielded by executing \procedurehr{2.25} on $\langle a,b\rangle$.
		\procedure[2.79]{2.57}
			\objective
		...
		\procedure[2.19]{2.63}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[2.10]{2.29}
			The notation $J_{s}(x)$, where $s$ is a list of polynomials and $x$ is a rational number, will be used as a shorthand for the number of changes observed when the list $\sgn(\Lambda(s,x))$ is iterated through linearly.
		\procedure[2.20]{2.64}
			\objective
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Using (a), verify that $\lvert J_m(d)-J_m(c)\rvert=1$.
	...
	\twocolumn[\part{Complex Arithmetic}]
		\declaration[3.19]{3.00}
			The phrase "complex number" will be used as a shorthand for an ordered pair of rational numbers.
		\declaration[3.20]{3.01}
			The phrase "the real part of $a$" and the notation $\Re(a)$, where $a$ is a complex number, will be used as a shorthand for the first entry of $a$.
		\declaration[3.21]{3.02}
			The phrase "the imaginary part of $a$" and the notation $\Im(a)$, where $a$ is a complex number, will be used as a shorthand for the second entry of $a$.
		\declaration[3.22]{3.03}
			The phrase "$a=b$", where $a,b$ are complex numbers, will be used as a shorthand for "$\Re(a)=\Re(b)$ and $\Im(a)=\Im(b)$".
		\procedure[3.68]{3.00}
			\objective
		...
		\procedure[3.70]{3.02}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Hence verify that $a=c$.}
				\end{enumerate}
		\declaration[3.23]{3.04}
			The notation $a+b$, where $a,b$ are complex numbers, will be used as a shorthand for the pair $\langle\Re(a)+\Re(b),\Im(a)+\Im(b)\rangle$.
		\procedure[3.71]{3.03}
			\objective
		...
		\procedure[3.73]{3.05}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[3.24]{3.05}
			The notation $a$, where $a$ is a rational number, will contextually be used as a shorthand for the pair $\langle a,0\rangle$.
		\procedure[3.74]{3.06}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[3.25]{3.06}
			The notation $-a$, where $a$ is a complex number, will be used as a shorthand for the pair $\langle-\Re(a),-\Im(a)\rangle$.
		\procedure[3.75]{3.07}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[3.26]{3.07}
			The notation $ab$, where $a,b$ are complex numbers, will be used as a shorthand for the pair $\langle\Re(a)\Re(b)-\Im(a)\Im(b),\Re(a)\Im(b)+\Im(a)\Re(b)\rangle$.
		\procedure[3.76]{3.08}
			\objective
		...
		\procedure[3.79]{3.11}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[3.02]{3.08}
			The notation $\conj{a}$, where $a$ is a complex number, will be used as a shorthand for $\langle\Re(a),-\Im(a)\rangle$.
		\procedure[3.00]{3.12}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item $=\sum_r^{[0:{\lvert a\rvert}]}\lVert a_r\rVert^2+2\sum_{0\le r<k<\lvert a\rvert}(\Re(a_r)\Re(a_k)+\Im(a_r)\Im(a_k))$
						\item $=\sum_r^{[0:{\lvert a\rvert}]}\lVert a_r\rVert^2+2\sum_{0\le r<k<\lvert a\rvert}(\Re(a_r)^2-(\Re(a_r)-\Re(a_k))^2+\Re(a_k)^2+\Im(a_r)^2-(\Im(a_r)-\Im(a_k))^2+\Im(a_k)^2)$
						\item $\le\sum_r^{[0:{\lvert a\rvert}]}\lVert a_r\rVert^2+\sum_{0\le r<k<\lvert a\rvert}(\Re(a_r)^2+\Re(a_k)^2+\Im(a_r)^2+\Im(a_k)^2)$
						\item $\le\sum_r^{[0:{\lvert a\rvert}]}\lVert a_r\rVert^2+\sum_{0\le r<k<\lvert a\rvert}(\lVert a_r\rVert^2+\lVert a_k\rVert^2)$
						\item $\le\sum_r^{[0:{\lvert a\rvert}]}\lVert a_r\rVert^2+\frac{1}{2}\sum_{r\ne k}(\lVert a_r\rVert^2+\lVert a_k\rVert^2)$
		...
		\procedure[3.05]{3.15}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[3.03]{3.09}
			The notation $\lVert a\rVert^2$, where $a$ is a complex number, will be used as a shorthand for $\Re(a)^2+\Im(a)^2$.
		\procedure[3.02]{3.16}
			\objective
			...
			\implementation
				...
				\end{enumerate}
		\declaration[3.27]{3.10}
			The notation $\frac{1}{a}$, where $a$ is a complex number, will be used as a shorthand for the pair $\frac{1}{\lVert a\rVert^2}\conj{a}$.
		\procedure[3.81]{3.17}
			\objective
		...
		\procedure[3.16]{3.28}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
				\end{enumerate}
		\declaration[3.29]{3.13}
			The notation $\diff_{x=y}^zf(x)$, where $x,z$ are complex numbers such that $z\ne 0$ and $f[x]$ is a function of $x$, will be used as a shorthand for $\frac{f(y+z)-f(y)}{z}$.
		\procedure[3.83]{3.29}
			\objective
		...
		\procedure[3.20]{3.34}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Yield the tuple $\langle a,c,p\rangle$.}
				\end{enumerate}
		\declaration[3.15]{3.14}
			The notation $\lceil\sqrt{x}\rceil$, where $x$ is a non-negative rational number, will be used as a shorthand for the result of executing the following instructions:
			\begin{enumerate}
		...
		\procedure[3.21]{3.35}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[3.17]{3.15}
			The notation $\cos_n(z)$, where $z$ is a complex number and $n$ is a positive integer, will be used as a shorthand for $\frac{\exp_n(iz)+\exp_n(-iz)}{2}$.
		\procedure[3.22]{3.36}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[3.18]{3.16}
			The notation $\sin_n(z)$, where $z$ is a complex number and $n$ is a positive integer, will be used as a shorthand for $\frac{\exp_n(iz)-\exp_n(-iz)}{2i}$.
		\procedure[3.23]{3.37}
			\objective
		...
		\declaration[3.30]{3.17}
			The notation $\int_r^R f(\#r,r,dr)$, where $R$ is a non-empty list of complex numbers and $f[\#r,r,dr]$ is a function of $\#r,r,dr$, will be used as a shorthand for $\sum_t^{[0:\lvert R\rvert-1]}f(t,R_t,R_{t+1}-R_{t})$.
		\procedure[3.86]{3.45}
			\objective
		...
		\procedure[3.41]{3.50}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Yield the tuple $\langle a,b,d,p\rangle$.}
				\end{enumerate}
		\declaration[3.31]{3.18}
			The notation $\Delta X$, where $X$ is a list, will be used as a shorthand for $\langle X_1-X_0,X_2-X_1,\cdots,X_{\lvert X\rvert-1}-X_{\lvert X\rvert-2}\rangle$.
		\procedure[3.42]{3.51}
			\objective
		...
		\procedure[3.43]{3.52}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[3.32]{3.19}
			The notation $\mu(a,b,n)$, where $a,b$ are complex numbers and $n$ is a positive integer, will be used as a shorthand for $\langle a+0b,a+1b,\cdots,a+(n-1)b\rangle$.
		\declaration[3.33]{3.20}
			The notation $\tau_n$, where $n$ is a positive integer, will be used as a shorthand for $\frac{4}{i}\int_r^{\mu(1,\frac{i-1}{n},n+2)}\frac{dr}{r}$.
		\procedure[3.47]{3.53}
			\objective
		...
		\procedure[3.63]{3.70}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Yield the tuple $\langle a,b,c,p\rangle$.}
				\end{enumerate}
		\declaration[3.34]{3.21}
			The phrase "complex polynomial" will be used to indicate that the declarations and procedures pertaining to polynomials are being used but with the provison that all uses of rational numbers therein are substituted with uses of complex numbers.
		\procedure[3.64]{3.71}
			\objective
	...
	\twocolumn[\part{Matrix Arithmetic}]
		\declaration[4.28]{4.00}
			The phrase "$m\times n$ matrix" will be used as a shorthand for a length-$m$ list of length-$n$ lists of polynomials.
		\declaration[4.29]{4.01}
			The notation $A_{I,J}$, where $A$ is a matrix and $I,J$ are lists of indicies, will be used as a shorthand for $\langle(A_j)_J\for j\in I\rangle$.
		\declaration[4.30]{4.02}
		...
		\procedure[4.74]{4.01}
			\objective
				Choose two $m\times n$ matricies $A,B$ such that $A=B$. The objective of the following instructions is to show that $B=A$.
			\implementation
				\begin{enumerate}
		...
		\procedure[4.75]{4.02}
			\objective
				Choose three $m\times n$ matricies $A,B,C$ such that $A=B$ and $B=C$. The objective of the following instructions is to show that $A=C$.
			\implementation
				\begin{enumerate}
					\item Verify that $A_{i,j}=B_{i,j}$ for $j\in[0:n]$, for $i\in[0:m]$.
					...
					\item \textbf{Hence verify that $A=C$.}
				\end{enumerate}
		\declaration[4.31]{4.03}
			The notation $A+B$, where $A,B$ are $m\times n$ matricies, will be used as a shorthand for the list $\langle\langle A_{i,j}+B_{i,j}\for j\in[0:n]\rangle\for i\in[0:m]\rangle$.
		\procedure[4.76]{4.03}
			\objective
				Choose four $m\times n$ matricies $A,B,C,D$ such that $A=C$ and $B=D$. The objective of the following instructions is to show that $A+B=C+D$.
			\implementation
				\begin{enumerate}
		...
		\procedure[4.77]{4.04}
			\objective
				Choose three $m\times n$ matricies $A,B,C$. The objective of the following instructions is to show that $(A+B)+C=A+(B+C)$.
			\implementation
				\begin{enumerate}
					\item Verify that $(A+B)+C$
					\begin{enumerate}
		...
		\procedure[4.78]{4.05}
			\objective
				Choose two $m\times n$ matricies $A,B$. The objective of the following instructions is to show that $A+B=B+A$.
			\implementation
				\begin{enumerate}
					\item $A+B$
					\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.32]{4.04}
			The notation $0_{m\times n}$ will contextually be used as a shorthand for the list $\langle\langle 0\for j\in[0:n]\rangle\for i\in[0:m]\rangle$ where the natural numbers $m,n$ are determined by the context.
		\procedure[4.79]{4.06}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.33]{4.05}
			The notation $-A$, where $A$ is an $m\times n$ matrix, will be used as a shorthand for the list $\langle\langle -A_{i,j}\for j\in[0:n]\rangle\for i\in[0:m]\rangle$.
		\procedure[4.80]{4.07}
			\objective
				Choose two $m\times n$ matricies $A,B$ such that $A=B$. The objective of the following instructions is to show that $-A=-B$.
			\implementation
				\begin{enumerate}
					\item Verify that $A_{i,j}=B_{i,j}$ for $j\in[0:n]$, for $i\in[0:m]$.
					\item Hence verify that $-A$
		...
		\procedure[4.81]{4.08}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.34]{4.06}
			The notation $AB$, where $A$ is an $m\times n$ matrix and $B$ is an $n\times k$ matrix, will be used as a shorthand for the list $\langle\langle\sum_r^{[0:n]}A_{i,r}B_{r,j}\for j\in[0:k]\rangle\for i\in[0:m]\rangle$.
		\procedure[4.82]{4.09}
			\objective
		...
		\procedure[4.85]{4.12}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.36]{4.08}
			The phrase "row $i$ of $A$" and the notation $A_{i,*}$, where $A$ is an $m\times n$ matrix and $0\le i<m$, will be used as a shorthand for $A_{i,[0:n]}$.
		\declaration[4.37]{4.09}
			The phrase "column $i$ of $A$" and the notation $A_{*,i}$, where $A$ is an $m\times n$ matrix and $0\le i<n$, will be used as a shorthand for $A_{[0:m],i}$.
		\procedure[4.00]{4.13}
			\objective
			...
			\implementation
				...
				\end{enumerate}
		\declaration[4.01]{4.10}
			The phrase "diagonal" will be used as a shorthand for matrix positions such that the row index equals the column index.
		\declaration[4.02]{4.11}
			The phrase "$m\times n$ diagonal matrix" will be used to refer to $m\times n$ matrices with $0$s in all its off-diagonal positions.
		\procedure[4.01]{4.14}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Yield the tuple $\langle A\rangle$.}
				\end{enumerate}
		\declaration[4.04]{4.12}
			The phrase "$m\times m$ tilt" will be used to refer to $m\times m$ matrices with only $1$s on the diagonal, a single polynomial off the diagonal, and $0$s everywhere else.
		\procedure[4.03]{4.15}
			\objective
		...
		\procedure[4.09]{4.21}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[4.06]{4.14}
			The phrase "number of rows of $A$" and the notation $\rows(A)$, where $A$ is an $m\times n$ matrix, will be used as a shorthand for $m$.
		\declaration[4.07]{4.15}
			The phrase "number of columns of $A$" and the notation $\cols(A)$, where $A$ is an $m\times n$ matrix, will be used as a shorthand for $n$.
		\declaration[4.08]{4.16}
			The notation $\bdiag(C)$, where $C$ is a list of rational square matrices, will be used to refer to the result yielded by executing the following instructions:
			\begin{enumerate}
		...
		\procedure[4.10]{4.22}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.09]{4.17}
			The notation $\det(A)$, where $A$ is a $m\times m$ matrix, will be used to refer to the result yielded by executing the following instructions:
			\begin{enumerate}
		...
		\procedure[4.11]{4.23}
			\objective
				Choose a polynomial $p$. Choose two $1\times m$ matrixs, $B$ and $C$. Choose an integer $0\le i<m$. Choose a $m\times m$ matrix, $A$, such that its $i^{th}$ row is $B+pC$. Let $A'$ be $A$ but with the $i^{th}$ row replaced by $B$ and let $A''$ be $A$ but with the $i^{th}$ row replaced by $C$. The objective of the following instructions is to show that $\det(A)=\det(A')+p\det(A'')$.
			\implementation
				\begin{enumerate}
		...
		\procedure[4.12]{4.24}
			\objective
				Choose a polynomial $p$. Choose two $m\times 1$ matrixs, $B$ and $C$. Choose an integer $0\le i<m$. Choose a $m\times m$ matrix, $A$, such that its $i^{th}$ column is $B+pC$. Let $A'$ be $A$ but with the $i^{th}$ column replaced by $B$ and let $A''$ be $A$ but with the $i^{th}$ column replaced by $C$. The objective of the following instructions is to show that $\det(A)=\det(A')+p\det(A'')$.
			\implementation
				\begin{enumerate}
		...
		\declaration[4.10]{4.18}
			The notation $C_k(A)$, where $A$ is a $m\times n$ matrix and $k$ is an integer such that $0\le k\le\min(m,n)$, will be used to refer to the $\binom{m}{k}\times\binom{n}{k}$ matrix with the following specification:
			\begin{enumerate}
		...
		\procedure[4.27]{4.39}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.12]{4.20}
			The notation $A^T$, where $A$ is a $m\times n$ matrix, will be used to refer to the $n\times m$ matrix such that ${A^T}_{i,j}=A_{j,i}$ for $i$ in $[0:n]$, for $j$ in $[0:m]$.
		\procedure[4.28]{4.40}
			\objective
		...
		\procedure[4.31]{4.43}
			...
			\implementation
				\begin{enumerate}
					...
					\item Verify that ${M^{-1}}_*$, $D$, and ${N^{-1}}_*$ are rational matrixs.
					...
					\item \textbf{Yield the tuple $\langle E\rangle$.}
				\end{enumerate}
		\declaration[4.13]{4.21}
			The notation $A\backslash B$ will be used to refer to the result yielded by executing \procedurehr{4.31} on $\langle A,B\rangle$.
		\procedure[4.32]{4.44}
			\objective
		...
		\declaration[4.14]{4.22}
			The notation $B/A$ will be used to refer to the result yielded by executing \procedurehr{4.32} on $\langle A,B\rangle$.
		\procedure[4.33]{4.45}
			\objective
		...
		\procedure[4.35]{4.47}
			\objective
				Choose two $m\times m$ rational matrixs, $A$ and $B$, such that $AB=1_m$. The objective of the following instructions is to show that either $0=1$ or $BA=1_m$.
			\implementation
				\begin{enumerate}
		...
		\procedure[4.36]{4.48}
			...
			\implementation
				\begin{enumerate}
					\item Let $M_0\lambda^b+M_1\lambda^{b-1}+\cdots+M_b\lambda^0=M$, where the $M_i$ are $m\times m$ rational matrixs.
		...
		\procedure[4.38]{4.50}
			\objective
				Choose two $m\times m$ rational matrixs, $B,A$, and two lists of $m\times m$ tilts such that $\lambda 1_m-B=M(\lambda 1_m-A)N$. The objective of the following instructions is to either show that $0=1$ or to construct $m\times m$ rational matrixs $R_1$ and $R_3$ such that $1_m=R_1R_3$ and $B=R_1AR_3$.
			\implementation
				\begin{enumerate}
		...
		\procedure[4.42]{4.54}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[4.15]{4.23}
			The phrase "$p$ is monic", where $p$ is a polynomial, will be used as a shorthand for "$p_{\deg(p)}=1$".
		\procedure[4.43]{4.55}
			\objective
		...
		\procedure[4.44]{4.56}
			...
			\implementation
				\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.19]{4.24}
			The notation $e_{i,k}$ will be used to refer to the $k\times 1$ rational matrix such that its $i^{th}$ entry, $1$, is the only non-zero entry.
		\declaration[4.22]{4.25}
			The notation $\mat_t(p)$ will be used as a shorthand for $\sum_j^{[0:t]}p_je_j$.
		\declaration[4.16]{4.26}
			The notation $\rcan(p)$, where $p\ne 0$ is a monic polynomial such that $\deg(p)>0$, will be used as a shorthand for the $\deg(p)\times\deg(p)$ rational matrix of the following constitution:
			\begin{enumerate}
		...
		\procedure[4.45]{4.57}
			\objective
				Choose a monic polynomial, $p$ such that $\deg(p)>0$. Let $k=\deg(p)$. Choose a $k\times k$ matrix, $D$, such that $D=\lambda 1_k-\rcan(p)$. The objective of the following instructions is to transform $D$ into $\bdiag(1,\cdots,1,p)$ by a sequence of elementary operations.
			\implementation
				\begin{enumerate}
				...
				\end{enumerate}
		\declaration[4.17]{4.27}
			The notation $\mon(p)$, where $p$ is a polynomial such that $p\ne 0$, will be used as a shorthand for $\frac{p}{p_{\deg(p)}}$.
		\procedure[4.46]{4.58}
			\objective
				Choose a positive integer $m$ and an $m\times m$ rational matrix, $A$. Execute \procedurehr{4.03} on the polynomial matrix $\lambda 1_m-A$ and let $\langle,B,,\rangle$ receive the result. Execute \procedurehr{4.44} on $A$ and let $\langle a\rangle$ receive the result. Let $E_i=\rcan(\mon(B_{a+i,a+i}))$ for $i$ in $[0:m-a]$. The objective of the following instructions is to first show that $\cols(\bdiag(E))=m$, and second to apply a sequence of elementary operations on $\lambda 1_m-\bdiag(E)$ to obtain the matrix $B$.
			\implementation
				\begin{enumerate}
					\item Verify that the diagonal of $B$ comprises $a$ rationals followed by $B_{a,a},B_{a+1,a+1},\cdots,B_{m-1,m-1}$.
					\item \textbf{Using \procedurehr{4.45}, verify that $\cols(\bdiag(E))=\sum_i^{[0:{\lvert E\rvert}]}\cols(E_i)=\sum_i^{[0:{\lvert E\rvert}]}\cols(\rcan(\mon(B_{a+i,a+i})))=\sum_i^{[0:{\lvert E\rvert}]}\deg(\mon(B_{a+i,a+i}))=\sum_i^{[0:{m-a}]}\deg(B_{a+i,a+i})=\sum_i^{[a:m]}\deg(B_{i,i})=m$.}
					\item Let $F=\lambda 1_m-\bdiag(E)$.
					...
					\end{enumerate}
					\item Now verify that $\det(F)_{m}=\det(\lambda 1_m-\bdiag(E))_m=1=\det(\lambda 1_m-A)_m=\det(B)_m$.
		...
		\procedure[4.47]{4.59}
			\objective
				Choose a $m\times m$ rational matrix, $A$. Execute \procedurehr{4.44} on $A$ and let $\langle a\rangle$ receive the result. Let $E_i=\rcan(\mon(B_{a+i,a+i}))$ for $i$ in $[0:m-a]$. The objective of the following instructions is to either show that $0=1$ or to construct $m\times m$ rational matrixs $R,T$ such that $A=R\bdiag(E)T$, $RT=1_m$, and $TR=1_m$.
			\implementation
				\begin{enumerate}
					...
					\item Execute procedure $Z$ on the matrix $\lambda 1_m-\bdiag(E)$ and let $\langle M,,,N\rangle$ receive the result.
					\item Verify that $M_*(\lambda 1_m-\bdiag(E))N_*=B$.
					\item Verify that $\lambda 1_m-A={P^{-1}}_*B{Q^{-1}}_*={P^{-1}}_*M(\lambda 1_m-\bdiag(E))N{Q^{-1}}_*$.
					\item Execute \procedurehr{4.38} on the matrices $\langle A,{P}^{-1}M,\bdiag(E),N{Q}^{-1}\rangle$. Let the tuple $\langle R,T\rangle$ be the result.
		...
		\procedure[4.49]{4.61}
			\objective
				Choose a list of $m\times m$ rational matrixs, $A$, and a polynomial, $r$. The objective of the following instructions is to show that $\Lambda(r,\bdiag(A))=\bdiag(\Lambda(r,A))$.
			\implementation
				\begin{enumerate}
					\item For $i=0$ up to $i=t$, by repeated applications of \procedurehr{4.09}, verify that $\bdiag(A)^i$ evaluates to $\bdiag(A^i)$.
					\item Therefore verify that $\Lambda(r,\bdiag(A))$
					\begin{enumerate}
						\item $=\sum_j^{[0:\lvert r\rvert]}r_j\bdiag(A)^j$
						\item $=\sum_j^{[0:\lvert r\rvert]}r_j\bdiag(A^j)$
						\item $=\sum_j^{[0:\lvert r\rvert]}\bdiag(r_jA^j)$
						\item $=\bdiag(\sum_j^{[0:\lvert r\rvert]}r_jA^j)$
						\item \textbf{$=\bdiag(\Lambda(r,A))$.}
					\end{enumerate}
				\end{enumerate}
		\procedure[4.50]{4.62}
			\objective
				Choose a $m\times m$ rational matrix, $A$, and a polynomial, $r$. Execute \procedurehr{4.47} on the matrix $A$ and let the tuple $\langle R_1,E,R_3\rangle$ receive the result. The objective of the following instructions is to show that $\Lambda(r,A)=R_1\bdiag(\Lambda(r,E))R_3$.
			\implementation
				\begin{enumerate}
					\item Verify that $R_3R_1=1_m$.
					\item Using \procedurehr{4.48}, verify that $\Lambda(r,A)=\Lambda(r,R_1\bdiag(E)R_3)=R_1\Lambda(r,\bdiag(E))R_3$.
					\item Using \procedurehr{4.49}, verify that $\Lambda(r,\bdiag(E))=\bdiag(\Lambda(r,E))$.
					\item \textbf{Therefore verify that $\Lambda(r,A)=R_1\bdiag(\Lambda(r,E))R_3$.}
				\end{enumerate}
		\procedure[4.51]{4.63}
			\objective
				Choose a monic polynomial $p\ne 0$ such that $\deg(p)>0$. The objective of the following instructions is to show that $\Lambda(p,\rcan(p))=0_{\deg(p)\times\deg(p)}$.
			\implementation
				\begin{enumerate}
					\item Let $G=\rcan(p)$.
					...
					\begin{enumerate}
						...
						\end{enumerate}
					\end{enumerate}
					\item \textbf{Therefore verify that $\Lambda(p,\rcan(p))=\Lambda(p,G)=0_{\deg(p)\times\deg(p)}$.}
				\end{enumerate}
		\declaration[4.20]{4.28}
			The notation $\last_A$, where $A$ is an $m\times m$ rational matrix, will be used as a shorthand for the polynomial yielded by executing the following instructions:
			\begin{enumerate}
		...
		\procedure[4.53]{4.65}
			\objective
				Choose a $m\times m$ rational matrix, $A$. The objective of the following instructions is to either show that $0<0$ or to show that $\last_A(A)=0_{m\times m}$.
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Therefore using \procedurehr{4.51} verify that $\last_A(E_j)=B_{m-1,m-1}(E_j)=B_{a+j,a+j}(\rcan(\mon(B_{a+j,a+j})))\prod_r^{[a+j+1:m]} v_r(E_j)=0_{k\times k}\prod_r^{[a+j+1:m]} v_r(E_j)=0_{k\times k}$.
					\end{enumerate}
					\item \textbf{Therefore using \procedurehr{4.50} verify that $\last_A(A)=R\bdiag(\last_A(E))T=R\bdiag(B_{m-1,m-1}(E))T=R0_{m\times m}T=0_{m\times m}$.}
				\end{enumerate}
		\procedure[4.54]{4.66}
			\objective
				Choose a monic polynomial $p$ such that $\deg(p)>0$. Choose a polynomial $g\ne 0$ such that $\deg(g)<\deg(p)$. The objective of the following instructions is to show that $\Lambda(g,\rcan(p))\ne 0_{\deg(p)\times\deg(p)}$.
			\implementation
				\begin{enumerate}
					\item Let $G=\rcan(p)$.
		...
		\procedure[4.55]{4.67}
			\objective
				Choose a polynomial $g$ and a monic polynomial $p$ such that $\deg(p)=\deg(g)>0$ and $\Lambda(g,\rcan(p))=0_{\deg(g)\times\deg(g)}$. The objective of the following instructions is to show that $g=g_{\deg(g)}p$.
			\implementation
				\begin{enumerate}
					\item Let $G=\rcan(p)$.
		...
		\procedure[4.56]{4.68}
			...
			\implementation
				\begin{enumerate}
					\item Let $F$ be a $1\times 2$ matrix matrix consisting in-order of $p$ and $\last_A$.
					...
					\item Using \procedurehr{4.50}, and \procedurehr{4.47}, verify that $\bdiag(\Lambda(g,E))=1_m\bdiag(\Lambda(g,E))1_m=R_3R_1\bdiag(\Lambda(g,E))R_3R_1=R_3\Lambda(g,A)R_1=R_30_{m\times m}R_1=0_{m\times m}$.
					\item Let $G=\rcan(\mon(\last_A))$.
					\item Verify that $\Lambda(g,G)=\Lambda(g,E_{\lvert E\rvert-1})=\bdiag(\Lambda(g,E))_{[m-u:m],[m-u:m]}=0_{u\times u}$.
		...
		\procedure[4.60]{4.72}
			...
			\implementation
				...
				\end{enumerate}
		\declaration[4.26]{4.30}
			The notation $\tr(X)$ will be used as a shorthand for the sum of the diagonal entries of the square matrix $X$.
		\declaration[4.27]{4.31}
			The phrase "$A$ is symmetric" will be used as a shorthand for "$A^T=A$".
		\procedure[4.61]{4.73}
			\objective
				Choose a symmetric $m\times m$ rational matrix, $A$. Let $t=\deg(\last_A)$. Choose two polynomials $u,w$ such that $\deg(u)<t$ and $\deg(w)<t$. The objective of the following instructions is to show that $\tr(\Lambda(u,A)\Lambda(w,A))=\mat(u)^T\pows(A)^T\pows(A)\mat_t(w)$.
			\implementation
				\begin{enumerate}
					\item Verify that $\tr(\Lambda(u,A)\Lambda(w,A))$
					\begin{enumerate}
					...
					\end{enumerate}
				\end{enumerate}
		\declaration[4.24]{4.32}
			The notation $\lVert A\rVert^2$ will be used as a shorthand for $\sum_i^{[0:{\rows(A)}]}\sum_j^{[0:{\cols(A)}]}{A_{i,j}}^2$.
		\declaration[4.25]{4.33}
			The notation $\sel_A$, where $A$ is an $m\times m$ rational matrix, will be used as a shorthand for the result yielded by executing the following instructions:
			\begin{enumerate}
				\item Using \procedurehr{4.30} and \procedurehr{4.60}, verify that $C_t(\pows(A)^T\pows(A))=C_t(\pows(A)^T)C_t(\pows(A))={C_t(\pows(A))}^TC_t(\pows(A))=\lVert C_t(\pows(A))\rVert^2>0$.
				\item Let $t=\deg(\last_A)$.
		...
		\procedure[4.62]{4.74}
			\objective
				Choose a symmetric $m\times m$ rational matrix, $A$. Let $t=\deg(\last_A)$. Choose a polynomial $u$ such that $\deg(u)<t$. The objective of the following instructions is to show that $\tr(\Lambda(u,A)\Lambda(\sel_A,A))=\frac{u_{t-1}}{(\last_A)_t}$.
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{4.61}, verify that $\tr(u(A)\sel_A(A))$
					\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence verify that $(\last_A)_t\tr(\Lambda(u,A)\Lambda(\sel_A,A))=u_{t-1}=b_z\ne 0$.
						\item Also verify that $\tr(\Lambda(u,A)\Lambda(\sel_A,A))$
						\begin{enumerate}
							\item $=\tr(A^{z-1}\Lambda(b,A)\Lambda(c,A)\Lambda(D_{0,0},A))$
							\item $=\tr(A^{z-1}\Lambda(c,A)\Lambda(b,A)\Lambda(D_{0,0},A))$
							\item $=\tr(A^{z-1}\Lambda(c,A)\Lambda(\last_A,A))$
							\item $=\tr(A^{z-1}\Lambda(c,A)0_{m\times m})$
							\item $=\tr(0_{m\times m})$
							\item $=0$.
						\end{enumerate}
						\item \textbf{Therefore verify that $0\ne 0$.}
		...
		\procedure[4.64]{4.76}
			\objective
				Choose a symmetric $m\times m$ rational matrix, $A$. Let $t=\deg(\last_A)$. The objective of the following instructions is to either show that $0\ne 0$ or to construct lists of polynomials $s,q$ such that
				\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\item Therefore verify that $s_{t-1}(A)\sel_A(A)=u(A)s_t(A)+(q_t(A)s_t(A)+s_{t-1}(A))\sel_A(A)=1_{m}$.
					\item Therefore using \procedurehr{4.62}, verify that $\frac{(s_{t-1})_{t-1}}{(s_t)_t}=\tr(s_{t-1}(A)\sel_A(A))=\tr(1_{m})=m>0$.
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Verify that $p(A)s_{t-1}(A)\sel_A(A)=p(A)1_{m}=p(A)\ne0_{m\times m}$.
						...
						\begin{enumerate}
							...
							\item Verify that $s_{i-1}(A)\sel_A(A)s_{t-1}(A)=s_{i-1}(A)1_{m}=s_{i-1}(A)\ne 0$.
							\item Therefore verify that $0\ne 0$.
							\item \textbf{Abort procedure.}
						\end{enumerate}
						\item Otherwise, do the following:
						\begin{enumerate}
							...
							\item Hence verify that $\frac{(s_{i-1})_{i-1}}{(s_i)_i}=\tr(s_{i-1}(A)^2\sel_A(A)^2)=\tr((s_{i-1}(A)\sel_A(A))^2)=\lVert s_{i-1}(A)\sel_A(A)\rVert^2>0$.
			...
			\subsubsection*{Auxilliary procedure}\label{sec:procedure 73 auxilliary procedure}
				\paragraph{Objective}
					Choose an integer $0\le k\le t$ such that polynomial $s_k$ is defined. Choose a polynomial $g$ such that $\deg(g)\le\min(k,t-1)$. The objective of the following instructions is to show that $\tr(g(A)s_k(A)\sel_A(A)^2)=\frac{g_k}{(s_{k+1})_{k+1}}$.
				\paragraph{Implementation}
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Now verify that $\tr((g(A)q_{k+1}(A))s_{k+1}(A)\sel_A(A)^2)=\frac{\frac{(s_{k+2})_{k+2}}{(s_{k+1})_{k+1}}g_k}{(s_{k+2})_{k+2}}=\frac{g_k}{(s_{k+1})_{k+1}}$.
							...
							\item Now verify that $\tr(g(A)s_{k+2}(A)\sel_A(A)^2)=\frac{g_{k+2}}{(s_{k+3})_{k+3}}=\frac{0}{(s_{k+3})_{k+3}}=0$.
		...
		\procedure[4.65]{4.77}
			\objective
				Choose a symmetric $m\times m$ rational matrix, $A$. Let $t=\deg(\last_A)$. The objective of the following instructions is to either show that $0<0$ or to construct two lists of rational numbers $c,d$ such that $c_0<d_0\le c_1<d_1\le\cdots\le c_{t-1}<d_{t-1}$ and $\sgn(\last_A(c_i))=-\sgn(\last_A(d_i))$ for $i$ in $[0:t]$.
			\implementation
				\begin{enumerate}
