	...
	\part{Rational Arithmetic}
	  ...
	  \chapter{Perplex Arithmetic}
		    ...
		    \procedure{thu0602201510}
				...
				\declaration{sun1602200918}
				  The phrases "$a$ and $b$ intersect" will be used to paraphrase $\conj{a}\subseteq b$ or $b\subseteq\conj{a}$., "$a$ and $b$ adjoin", and "$a$ and $b$ are disjoint", where $a$ and $b$ are perplex numbers, will be used to paraphrase the relations $\lVert b-\conj{a}\rVert^2\le 0$, $\lVert b-\conj{a}\rVert^2=0$, and $\lVert b-\conj{a}\rVert^2\ge 0$ respectively.
				\procedure{sun1602200941}
				  \objective
				    Choose a perplex number $a$. The objective of the following instructions is to show that $a$ intersects $a$.
				  \implementation
				    \begin{enumerate}
				      \item Show that $a$ intersects $a$ given that $\lVert a-\conj{a}\rVert^2=\lVert 2\Im(a)\ju\rVert^2=-4\Im(a)^2\le 0$.
				    \end{enumerate}
				\procedure{sun1602200933}
				  \objective
				    Choose two perplex numbers $a,b$ such that $a$ and $b$ intersect. The objective of the following instructions is to show that $b$ and $a$ intersect.
				  \implementation
				    \begin{enumerate}
				      \item Show that $\lVert b-\conj{a}\rVert^2\le 0$ given that $a$ and $b$ intersect.
				      \item Show that $b$ and $a$ intersect given that $\lVert a-\conj{b}\rVert^2=\lVert\conj{b}-a\rVert^2=\lVert b-\conj{a}\rVert^2\le 0$.
				    \end{enumerate}
				\procedure{sun1602200959}
				  \objective
				    Choose two perplex numbers $a,b$ such that $a$ and $b$ adjoin. The objective of the following instructions is to show that $b$ and $a$ adjoin.
				  \implementation
				    The implementation is analogous to that of \procedurehr{sun1602200933}.
				\procedure{sun1602201001}
				  \objective
				    Choose two perplex numbers $a,b$ such that $a$ and $b$ are disjoint. The objective of the following instructions is to show that $b$ and $a$ are disjoint.
				  \implementation
				    The implementation is analogous to that of \procedurehr{sun1602200933}.
	    \end{multicols*}
	  ...
	  \chapter{Polynomial Sign Changes}
        ...
        \procedure{sat0102201050}
			    \objective
				    Choose a polynomial $f$, a perplex number $c$, and a rational number $B$ such that $\lVert\Lambda(f,c)\rVert^2\le 0$ and $B>0$. The objective of the following instructions is to construct a perplex number $e$ such that $e\subseteq c$, $\lVert\Im(e)\rVert<B$ and $\lVert\Lambda(f,e)\rVert^2\le 0$.
			    \implementation
				    \begin{enumerate}
		    ...
		    \procedure{2.17}
			    \objective
				    Choose a polynomial $f$, a perplex number $a$, and a rational number $B$ such that $\lVert\Lambda(f,a)\rVert^2\le 0$ and $B>0$. The objective of the following instructions is to construct a rational number $d$ such that $d\subseteq a$ and $\lVert\Lambda(f,d)\rVert<B$.
			    \implementation
				    \begin{enumerate}
					    ...
					    \end{enumerate}
					    \item Let $d=\Re(c)+\Im(c)$.
					    \item \textbf{Use procedure $q$ on $\langle c\rangle$ to show that $\lVert\Lambda(f,d)\rVert\le G\lVert\Im(c)\rVert\le G\frac{B}{G}=B$.}
					    \item \textbf{Yield the tuple $\langle d\rangle$.}
				    \end{enumerate}
		    \procedure{2.18}
			    \objective
