...
\begin{document}
	...
	\begin{multicols}{2}
	      ...
	      \begin{enumerate}
	        ...
	        \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le\frac{1}{X^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\lvert\sum_k^{[0:r]}(\binom{a}{k+1+n-r}(-1)^{k+1}-\binom{a}{k+n-r}(-1)^k)\rvert))^2$
	            \item $=\frac{1}{X^2}(\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert(\lvert\binom{a}{n}\rvert+\lvert\binom{a}{n-r}\rvert+\lvert\binom{a}{n}(-1)^r-\binom{a}{n-r}\rvert))^2$
	            \item $=\frac{1}{X^2}(2\sum_r^{[1:n]}\lvert\binom{b}{r}\rvert\lvert\binom{a}{n-r}\rvert)^2$
	            \item $=(\frac{2}{X})^2(\lvert\binom{a+b}{n}\rvert+\lvert\binom{a}{n}\rvert+\lvert\binom{b}{n}\rvert)^2$
	            \item $\le(\frac{B}{n})^2$.
	          \end{enumerate}
	        \end{enumerate}
	      \end{enumerate}
	  \procedure{thu2507191017}
	    \objective
	      Choose a rational number $0<X<2$. The objective of the following instructions is to construct a positive rational number $D$ such that $D>1$, and a procedure $p(x,n,a,k)$ to show that $\lVert((1+x)_n^a)^k\rVert^2<D^2$ when a complex number $x$, a rational number $a$, and positive integers $n,k$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, and $(ka)^2<1$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{3.13} on $\langle\frac{2}{X}\rangle$ and let $\langle E,N,q\rangle$ receive.
	        \item Let $D=\max(E,(1+\frac{2}{X})^{\lfloor N\rfloor})$.
	        \item Let $p(x,n,a,k)$ be the following procedure:
	        \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le\frac{k^2}{X^2}(\lvert\binom{a}{n}\rvert+a+\sum_t^{[1:n]}(\binom{a}{t+1}(-1)^{t+1}-\binom{a}{t}(-1)^t))^2$
	            \item $=\frac{k^2}{X^2}(\lvert\binom{a}{n}\rvert+a+\binom{a}{n}(-1)^n-\binom{a}{1}(-1)^1)^2$
	            \item $=\frac{k^2}{X^2}(\lvert\binom{a}{n}\rvert+a-\lvert\binom{a}{n}\rvert+a)^2$
	            \item $=(\frac{2ak}{X})^2$
	            \item $\le(\frac{2}{X})^2$.
	          \end{enumerate}
	          \item If $k>N$, then do the following:
	  ...
	  \procedure{thu2507190752}
	    \objective
	      Choose a rational number $0<X<2$. The objective of the following instructions is to construct positive rational numbers $G,N$ and a procedure $p(x,n,a,k)$ to show that $(1+x)_n^{ka}\equiv((1+x)_n^a)^k\err{\frac{Gk}{n}}$ when positive integers $n,k$, a rational number $a$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x+1)\ge X$, $k>1$, $0<ka\le 1$, and $n>N$ are chosen.
	    \implementation
	      \begin{enumerate}
	  ...
	  \procedure{fri2607191210}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct positive rational numbers $a,c$ such that $b>1$, and a procedure $p(x,n,k)$ to show that $\exp_n(n((1+x)_k^{\frac{1}{n}}-1))\equiv 1+x\err{\frac{an}{k}}$ when a complex number $x$, and positive integers $n,k$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $n>1$, and $k>c$ are chosen.
	    \implementation
	      \begin{enumerate}
	   ...
	   \procedure{fri2607191243}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a rational number $a>0$ and a procedure $p(x,n,k)$ to show that $\lVert n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le a^2$ when positive integers $n,k$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $a=\frac{2}{X}$.
	        \item Let $p(x,n,k)$ be the following procedure:
	        \begin{enumerate}
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le\frac{n^2}{X^2}(\frac{2}{n})^2$
	            \item $=a^2$.
	          \end{enumerate}
	        \end{enumerate}
    ...
    \declaration{fri2607191453}
	  ...
	  \procedure{fri2607191736}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a rational number $a>0$ and a procedure $p(x,k)$ to show that $\lVert\ln_k(1+x)\rVert^2\le a^2$ when a positive integer $k$ and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $a=\frac{2}{X}$.
	  ...
	  \procedure{fri2607191801}
		...
		\procedure{3.53}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{fri2607191736} on $\langle 1\rangle$ and let $\langle a_1,p_1\rangle$ receive.
					...
					\item Execute \procedurehr{fri2607191801} on $\langle 1\rangle$ and let $\langle a_4,c_4,d,e_4,p_4\rangle$ receive.
