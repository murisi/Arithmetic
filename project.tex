...
\begin{document}
	...
	\begin{multicols}{2}
	  ...
	  \procedure{tue2008190849}
	    \objective
	      Choose two rational numbers $A>0$ and $1>X>0$. The objective of the following instructions is to construct positive rational numbers $B,C,D$, and a procedure $p(x,a,b,n)$ to show that $\lVert(1+x)_n^{a-b}-\frac{(1+x)_n^a}{(1+x)_n^b}\rVert^2\le(BC^n)^2$ when complex numbers $x,a,b$ and an integer $n$ such that $\lVert x\rVert^2\le X^2$, $\lVert a\rVert^2\le A^2$, $\lVert b\rVert^2\le A^2$, and $n>D$ are chosen.
	    \implementation
	      \begin{enumerate}
