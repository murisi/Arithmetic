			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							\item Execute \procedurehr{3.00} on the submatrix of $A'$ formed by selecting columns $1$ and $j$ as if there were nothing in between.
						\end{enumerate}
		...
		\procedure{3.13}
			...
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{3.12} on $\langle A, i\rangle$.
