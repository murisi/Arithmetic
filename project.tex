...
\setlist[instructions,1]{label=\roman*)}
\setlist[instructions,2]{label=\alph*),leftmargin=0.3cm}
\setlist[instructions,3]{label=\arabic*),leftmargin=0.3cm}
\setlist[instructions,4]{label=(\roman*),leftmargin=0.3cm}
\setlist[instructions,5]{label=(\alph*),leftmargin=0.3cm}
\setlist[instructions,6]{label=(\arabic*),leftmargin=0.3cm}
\setlist[instructions,7]{label=(\roman*),leftmargin=0.3cm}
	...
	\begin{multicols}{2}
	  ...
	  \declaration{3.29}
		...
		\declaration{wed2108191408}
		  The notation $\ln_n(x)$, where $x$ is a complex number, will be used as a shorthand for $\ln_n(1+\frac{x-1}{x+1})-\ln_n(1-\frac{x-1}{x+1})$.
