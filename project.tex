...
\begin{document}
	...
	\mfigure
		...
		\end{minipage}
		\begin{minipage}[c]{0.35\textwidth}
			A plot of the lists of complex numbers $(\frac{[0:40]}{10})_{15}^{\frac{1}{2}}$ and $\frac{1}{2}(\frac{[0:40]}{10})_{15}^{\frac{1}{2}-1}$. Note that the steepness of $(\frac{[0:40]}{10})_{15}^{\frac{1}{2}}$ is approximately given by the y-coordinates of $\frac{1}{2}(\frac{[0:40]}{10})_{15}^{\frac{1}{2}-1}$. Hence as the x-coordinate increases, the y-coordinate of $(\frac{[0:40]}{10})_{15}^{\frac{1}{2}}$ increases at a decreasing rate, and the y-coordinate of $\frac{1}{2}(\frac{[0:40]}{10})_{15}^{\frac{1}{2}-1}$ decreases.
		\end{minipage}
	\begin{multicols}{2}
	  \declaration{3.30}
