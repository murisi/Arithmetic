		...
		\procedure{thu2208191610}
		  ...
		  \implementation
		    \begin{instructions}
		      \item Execute the following in post-order:
		      \begin{instructions}
		        \item Execute \procedurehr{mon1908191207} on $\langle q_7,q_3,q_4,q_8,q_5,q_6\rangle$ and let $\langle e_3,e_4,e_5,e_6,e_7,q_1,q_2\rangle$ receive.
		        \begin{instructions}
		          ...
		          \begin{instructions}
		            ...
		            \item Execute \procedurehr{tue2008191001} on $\langle-1,q_{13},q_{14}\rangle$ and let $\langle q_{33},q_{34}\rangle$.
		      ...
		      \begin{instructions}
		        ...
		        \item Hence verify that $0$
		        \begin{instructions}
		          \item $\equiv[(1+(1+(-2)(x+1)^{-1}))_n^f\cdot(-f)(1-(1+(-2)(x+1)^{-1}))_n^{-f-1}\cdot(-1)(0+(-2)(-1)(x+1)^{-2}(1+0))]+[f(1+(1+(-2)(x+1)^{-1}))_n^{f-1}\cdot(0+(-2)(-1)(x+1)^{-2}(1+0))\cdot(1-(1+(-2)(x+1)^{-1}))_n^{-f}]\err{e_3}$
		          \item $=[2f(1+\frac{x-1}{x+1})_n^f\cdot(1-\frac{x-1}{x+1})_n^{-f-1}(x+1)^{-2}]+[2f(1+\frac{x-1}{x+1})_n^{f-1}\cdot(1-\frac{x-1}{x+1})_n^{-f}(x+1)^{-2}]$
