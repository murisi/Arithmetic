		...
		\procedure{3.03}
			...
			\implementation
				\begin{enumerate}
					...
					\item \textbf{Hence show that $i^{4a}=(i^4)^a=1^a=1$.}
					\item \textbf{Hence show that $i^{4a+1}=i^{4a}i=1i=i$.}
					\item \textbf{Hence show that $i^{4a+2}=i^{4a+1}i=i^2=-1$.}
					\item \textbf{Hence show that $i^{4a+3}=i^{4a+2}i=(-1)i=-i$.}
				\end{enumerate}
