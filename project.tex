...
\newglossaryentry{perplexk}{name=\ensuremath{k},description={perplex positive diagonal}}
	...
	\part{Rational Arithmetic}
	  ...
	  \chapter{Perplex Arithmetic}
		    ...
		    \procedure{thu0602201510}
			    \objective
				    The objective of the following instructions is to show that $j^{2}=1$, $k^2=k$, $\conj{k}^2=\conj{k}$, $k\conj{k}=0$, and $k+\conj{k}=1$.
			    \implementation
				    \begin{enumerate}
					    \item \textbf{Show that $j^2=1$}.
					    \item \textbf{Show that $k^2=k$}.
					    \item \textbf{Show that $\conj{k}^2=\conj{k}$}.
					    \item \textbf{Show that $k\conj{k}=0$}.
					    \item \textbf{Show that $k+\conj{k}=1$.}
				    \end{enumerate}
				\procedure{sat0802201559}
			    \objective
				    Choose rational numbers $a,b,c,d$. The objective of the following instructions is to show that $(ak+b\conj{k})+(ck+d\conj{k})=(a+c)k+(b+d)\conj{k}$.
			    \implementation
				    \begin{enumerate}
				      \item Show that $(ak+b\conj{k})+(ck+d\conj{k})=(a+c)k+(b+d)\conj{k}$.
				    \end{enumerate}\procedure{sat0802201559}
			    \objective
				    Choose rational numbers $a,b,c,d$. The objective of the following instructions is to show that $(ak+b\conj{k})(ck+d\conj{k})=ack+bd\conj{k}$.
			    \implementation
				    \begin{enumerate}
				      \item Show that $(ak+b\conj{k})(ck+d\conj{k})$
				      \begin{enumerate}
				        \item $=ak(ck+d\conj{k})+b\conj{k}(ck+d\conj{k})$
				        \item $=akck+akd\conj{k}+b\conj{k}ck+b\conj{k}d\conj{k}$
				        \item $=ack+0ad+0bc+bd\conj{k}$
				        \item $=ack+bd\conj{k}$.
				      \end{enumerate}
				    \end{enumerate}
	    \end{multicols*}
