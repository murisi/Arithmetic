	...
	\begin{multicols}{2}
	  ...
	  \declaration{3.29}
		...
		\procedure{wed2108191603}
		  \objective
		    Choose two rational numbers $X,\epsilon$ such that $0<\epsilon<1$ and $X\ge 0$. The objective of the following instructions is to construct rational numbers $a,b,c,d$, a procedure $p(x,n)$ to show that $\lVert\frac{1}{x}\rVert^2\le c^2$ when a complex number $x$ and a positive integer $n$ such that $\Re(x)\ge\epsilon$, $\lVert x\rVert^2\le X^2$, and $n>d$ are chosen, and a procedure $q(x,n,\delta)$ to show that $\Delta_{y=x}^{+\delta}\ln(y)\equiv\frac{1}{x}\err{\frac{a}{n}+b\{\delta\}}$ when in addition a complex number $\delta$ such that $0<\lVert\delta\rVert^2\le e^2$ is chosen.
		  \implementation
		    \begin{instructions}
		  ...
		  \objective
		    ...
		    \begin{enumerate}
		      \item A non-negative rational number $A$.
				...
				The objective of the following instructions is to construct the following:
				\begin{enumerate}
				  \item Non-negative rational numbers $a,b$.
				  \item A procedure $p(R,n)$ to show that $\int_r^Rf'_n(r)\delta_r\equiv f_n(R_{\lvert R\rvert-1})-f_n(R_0)\err{\frac{a}{n}+b\max(\{\Delta R\})}$ when an integer $n$ and a non-empty list of complex numbers $R$ such that $P(R_t)$ and $0<\lVert R_{t+1}-R_t\rVert^2<{d_1}^2$ for $t\in[0:\lvert R\rvert-1]$, $\int_r^R\{\delta_r\}\le A$, and $n>c_1$ are chosen.
				\end{enumerate}
		  \implementation
		    \begin{enumerate}
		      \item Let $a=a_1A$.
		  ...
		  \objective
		    ...
		    \begin{enumerate}
		      \item A non-negative rational number $A$.
				...
				\begin{enumerate}
				  \item Non-negative rational numbers $a,b$.
				  \item A procedure $p(R,n)$ to show that $\int_r^{g(R)}f_n(r)\delta_r\equiv\int_r^Rf_n(g_n(r))g'_n(r)\delta_r\err{\frac{a}{n}+b\max(\{\Delta R\})}$ when an integer $n$ and a non-empty list of complex numbers $R$ such that $P(R_t)$ and $0<\lVert R_{t+1}-R_t\rVert^2<{d_1}^2$ for $t\in[0:\lvert R\rvert-1]$, $\int_r^R\{\delta_r\}\le A$, and $n>c_1$ are chosen.
				\end{enumerate}
			\implementation
			  \begin{enumerate}
			    \item Let $a=a_1a_2A$.
			    ...
			    \item Let $p(R,n)$ be the following procedure:
			    \begin{enumerate}
			      \item Using procedures $q_1,q_2,q_3$, verify that $\int_r^{g(R)}f(r)\delta_r$
			      \begin{enumerate}
			        \item $=\sum_k^{[0:\lvert R\rvert-1]}f(g(R_k))(g(R_{k+1})-g(R_k))$
			        \item $=\sum_k^{[0:\lvert R\rvert-1]}f(g(R_k))\Delta_{y=R_k}^{R_{k+1}-R_k}g(y)(R_{k+1}-R_k)$
			        \item $\equiv\sum_k^{[0:\lvert R\rvert-1]}f(g(R_k))g'(R_k)(R_{k+1}-R_k)$
			        \begin{enumerate}
			          ...
			          \item $\err{\frac{a}{n}+b\max(\{\Delta R\})}$
			        \end{enumerate}
			        \item $=\int_r^Rf(g(r))g'(r)\delta_r$.
			      \end{enumerate}
			      \item \textbf{Hence verify that $\int_r^{g(R)}f(r)\delta_r\equiv\int_r^Rf(g(r))g'(r)\delta_r\err{\frac{a}{n}+b\max(\{\Delta R\})}$.}
			    \end{enumerate}
			    \item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
			  \end{enumerate}
	\end{multicols}
