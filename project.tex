		 ...
		 \procedure{3.27}
			...
			\implementation
				\begin{enumerate}
					...
					\item Let $q(x,n,\delta)$ be the following procedure:
					\begin{enumerate}
						\item Verify that $2(\lVert ix\rVert^2+\lVert i\delta\rVert^2)=2(\lVert x\rVert^2+\lVert \delta\rVert^2)\le X$.
						\item Verify that $\lVert i\delta\rVert^2=\lVert \delta\rVert^2\le X$.
						\item Hence execute procedure $q$ on $\langle ix,i\delta,n\rangle$.
						\item Hence verify that $\lVert\frac{\exp_n(ix+i\delta)-\exp_n(ix)}{i\delta}-\exp_n(ix)\rVert^2\le\frac{a}{n^2}+b\lVert i\delta\rVert^2$.
						\item Verify that $2(\lVert -ix\rVert^2+\lVert -i\delta\rVert^2)=2(\lVert x\rVert^2+\lVert \delta\rVert^2)\le X$.
						\item Verify that $\lVert -i\delta\rVert^2=\lVert \delta\rVert^2\le X$.
						\item Hence execute procedure $q$ on $\langle -ix,-i\delta,n\rangle$.
						\item Hence verify that $\lVert\frac{\exp_n(-ix-i\delta)-\exp_n(-ix)}{-i\delta}-\exp_n(-ix)\rVert^2\le\frac{a}{n^2}+b\lVert -i\delta\rVert^2$.
						\item Using \procedurehr{3.04}, verify that $\lVert\cos_n(x+\delta)-\cos_n(x)+\sin_n(x)\delta\rVert^2$
						\begin{enumerate}
							\item $=\lVert\frac{\exp_n(i(x+\delta))+\exp_n(-i(x+\delta))}{2}-\frac{\exp_n(ix)+\exp_n(-ix)}{2}+\frac{\delta\exp_n(ix)-\delta\exp_n(-ix)}{2i}\rVert^2$
							\item $\le\frac{\lVert\exp_n(ix+i\delta)-\exp_n(ix)-i\delta\exp_n(ix)\rVert^2}{2}+\frac{\lVert\exp_n(-ix-i\delta)-\exp_n(-ix)-(-i\delta)\exp_n(-ix)\rVert^2}{2}$
							\item $\le\frac{\lVert i\delta\rVert^2(\frac{a}{n^2}+b\lVert i\delta\rVert^2)}{2}+\frac{\lVert -i\delta\rVert^2(\frac{a}{n^2}+b\lVert -i\delta\rVert^2)}{2}$
							\item $=\lVert \delta\rVert^2(\frac{a}{n^2}+b\lVert \delta\rVert^2)$.
						\end{enumerate}
						\item \textbf{Therefore verify that $\lVert\diff_{y=x}^{+\delta}\cos_n(y)+\sin_n(x)\rVert^2\le\frac{a}{n^2}+b\lVert \delta\rVert^2$.}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,d,p\rangle$.}
				\end{enumerate}
		\procedure{3.28}
