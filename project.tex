	...
	\part{Rational Arithmetic}
	  ...
	  \chapter{Polynomial Sign Changes}
        ...
        \procedure{sat0102201050}
		    ...
		    \procedure{2.17}
			    \objective
				    Choose a polynomial $f$ and rational numbers $a,b,B$ such that $a\le b$, $\Lambda(f,a)\Lambda(f,b)\le 0$, and $B>0$. The objective of the following instructions is to construct a rational number $d$ such that $a\le d\le b$ and $\lVert f(d)\rVert<B$.
			    \implementation
				    \begin{enumerate}
