					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\begin{enumerate}
								...
								\item Hence verify that $\lVert z_j-z'_k\rVert^2\ge {a_2}^2$.
								\item Hence verify that ${a_2}^2\lVert\Lambda(q_k,z_j)\rVert^2$
								\item $\le\lVert z_j-z'_k\rVert^2\lVert\Lambda(q_k,z_j)\rVert^2$
								\item $=\lVert(z_j-z'_k)\Lambda(q_k,z_j)\rVert^2$
								\item $=\lVert\Lambda(q_{k+1},z_j)-\Lambda(q_{k+1},z'_k)\rVert^2$
