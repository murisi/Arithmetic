...
\begin{document}
	...
	\section{Integer Arithmetic}
		...
		\procedure{1.52}
			...
			\implementation
				\begin{enumerate}
					...
					\item Therefore verify that $0\le h_{i,j}<[a,b]=[a,b](a,b)=ab$ for $1\le i\le a$, for $1\le j\le b$.
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Therefore using \procedurehr{1.42}, verify that $i-1\equiv\chi_{a,b}(i-1,j-1)=\chi_{a,b}(k-1,l-1)\equiv k-1(\mod a)$.
							\item Therefore verify that $i=k$.
							\item Also using \procedurehr{1.42}, verify that $j-1\equiv\chi_{a,b}(i-1,j-1)=\chi_{a,b}(k-1,l-1)\equiv l-1(\mod b)$.
		...
		\procedure{1.59}
			\objective
				Choose a list of primes $a$. Let $b$ be the list of distinct primes in $a$. Let $c$ be a list such that $c_i$ is the multiplicity of $b_i$ in $a$ for $i=1$ to $i=\lvert b\rvert$. The objective of the following instructions is to show that either $0<0$ or $\lvert\phi(a_*)\rvert=\prod_{i=1}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.65}
			\objective
				Choose a non-negative integer $a$ and a prime $b$. The objective of the following instructions is to show that either $0\ne 0$ or the $\mathbb{Z}[x]$ $\sum_{r=0}^a\binom{a}{r}x^r\equiv\sum_{r=0}^a\binom{a\div b}{r\div b}\binom{a\mod b}{r\mod b}x^r(\mod b)$.
			\implementation
				\begin{enumerate}
