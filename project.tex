...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\procedure{3.10}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a>1,b$, and a procedure, $p$, to show that $\exp_n(x)\le a^2$ when given a rational number $x$ and a positive integer $n\ge b$ such that $x^2\le X^2$.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.13}
			\objective
				Choose a rational number $X\ge 0$. The objective of the following instructions is to construct rational numbers $a>1,b$ and a procedure, $p(x,n)$, to show that $\lVert\exp_n(x)\rVert^2\le a^2$ when a complex number $x$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
					\item Let $c=2X+X^2$.
		...
		\procedure{thu2507191307}
		  \objective
		    Choose a rational number $X\ge 0$. The objective of the following instructions is to construct rational numbers $a,b$ such that $a>0$, and a procedure $p(x,y,n)$ to show that $\lVert\exp_n(y)-\exp_n(x)\rVert^2\le\lVert x-y\rVert^2a^2$ when two complex numbers $x,y$ and a positive integer $n>b$ such that $\lVert x\rVert^2\le X$ and $\lVert y\rVert^2\le X$ are chosen.
		  \implementation
		    \begin{enumerate}
	...
	\begin{multicols}{2}
	  ...
	  \procedure{fri2607191210}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct rational numbers $G>0$, $D>1$, $K>0$, and a procedure $p(x,k,n)$ to show that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{GD^n}{k})^2$ when a complex number $x$, and positive integers $n,k$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $n>1$, and $k>K$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{thu2507190752} on $\langle X\rangle$ and let $\langle G,D,K,q\rangle$ receive.
	        \item Let $p(x,k,n)$ be the following procedure:
	        \begin{enumerate}
	          \item Using \procedurehr{sun2107190619}, verify that $(1+x)_k^1=(1+x)^1=1+x$.
	          \item Execute procedure $q$ on $\langle x,\frac{1}{n},n,k\rangle$.
	          \item Hence verify that $\lVert(1+x)_k^1-((1+x)_k^{\frac{1}{n}})^n\rVert^2\le(\frac{GD^n}{k})^2$.
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(\frac{GD^n}{k})^2$.
	           \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle G,D,K,p\rangle$.}
	      \end{enumerate}
	  ...
	  \procedure{fri2607191450}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct a rational number $A>0$ and a procedure $p(x,k,n)$ to show that $\lVert\ln_k(1+x)-n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le(\frac{A}{n})^2$ when positive integers $n,k$ and a complex number $x$ such that $\lVert x\rVert^2\le 1$ and $\Re(x)+1\ge X$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Let $A=\frac{1}{X}$.
	        \item Let $p(x,k,n)$ be the following procedure:
	  ...
	  \procedure{fri2607191801}
	    \objective
	      Choose a rational number $X>0$. The objective of the following instructions is to construct rational numbers $G>0$, $D>1$, $K>0$, $L>0$, $N$, and a procedure $p(x,k,n)$ to show that $\lVert\exp_n(\ln_k(1+x))-(1+x)\rVert^2\le(\frac{GD^n}{k}+\frac{L}{n})^2$ when positive integers $k,n$, and a complex number $x$ such that $\lVert x\rVert^2\le 1$, $\Re(x)+1\ge X$, $n>N$, and $k>K$ are chosen.
	    \implementation
	      \begin{enumerate}
	        \item Execute \procedurehr{fri2607191243} on $\langle X\rangle$ and let $\langle A,q\rangle$ receive.
	        \item Execute \procedurehr{fri2607191736} on $\langle X\rangle$ and let $\langle B,r\rangle$ receive.
	        \item Execute \procedurehr{thu2507191307} on $\langle\max(A,B)\rangle$ and let $\langle C,N,t\rangle$ receive.
	        \item Execute \procedurehr{fri2607191450} on $\langle X\rangle$ and let $\langle E,u\rangle$ receive.
	        \item Execute \procedurehr{fri2607191210} on $\langle X\rangle$ and let $\langle G,D,K,v\rangle$ receive.
	        \item Let $L=EC$.
	        \item Let $p(x,k,n)$ be the following procedure:
	        \begin{enumerate}
	          \item Execute procedure $q$ on $\langle x,k,n\rangle$.
	          \item Hence verify that $\lVert n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le A^2$.
	          \item Execute procedure $r$ on $\langle x,k\rangle$.
	          \item Hence verify that $\lVert\ln_k(1+x)\rVert^2\le B^2$.
	          \item Execute procedure $u$ on $\langle x,k,n\rangle$.
	          \item Hence verify that $\lVert\ln_k(1+x)-n((1+x)_k^{\frac{1}{n}}-1)\rVert^2\le(\frac{E}{n})^2$.
	          \item Execute procedure $t$ on $\langle\ln_k(1+x),n((1+x)_k^{\frac{1}{n}}-1),n\rangle$.
	          \item Hence verify that $\lVert\exp_n(\ln_k(1+x))-\exp_n(n((1+x)_k^{\frac{1}{n}}-1))\rVert^2\le(\frac{E}{n})^2C^2=(\frac{L}{n})^2$.
	          \item Execute procedure $v$ on $\langle x,k,n\rangle$.
	          \item Hence verify that $\lVert\exp_n(n((1+x)_k^{\frac{1}{n}}-1))-(1+x)\rVert^2\le(\frac{GD^n}{k})^2$.
	          ...
	          \begin{enumerate}
	            ...
	            \item $\le(\frac{L}{n}+\frac{GD^n}{k})^2$.
	          \end{enumerate}
	        \end{enumerate}
	        \item \textbf{Yield the tuple $\langle G,D,K,L,N,p\rangle$.}
	      \end{enumerate}
		\declaration{3.33}
