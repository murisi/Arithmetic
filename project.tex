		...
		\procedure{sat0308191134}
		  \objective
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_1(x,n,\delta)$ to show that $\frac{p_n(x+\delta)-p_n(x)}{\delta}\equiv p'_n(x)\err{\frac{a_1}{n}+b_1\{\delta\}}$ when two complex numbers $x,\delta$ and a positive integer $n$ such that $P(x)$, $n>b_0$, and $\lVert\delta\rVert^2<{c_1}^2$ are chosen
		      ...
		      \item A procedure $q_3(x,n,\delta)$ to show that $\frac{t_n(x+\delta)-t_n(x)}{\delta}\equiv t'_n(x)\err{\frac{a_3}{n}+b_3\{\delta\}}$ when two complex numbers $x,\delta$ and a positive integer $n$ such that $R(x)$, $n>b_2$, and $\lVert\delta\rVert^2<{c_3}^2$ are chosen
		    ...
		    \begin{enumerate}
		      ...
		      \item A procedure $q_6(x,n,\delta)$ to show that $\frac{p_n(t_n(x+\delta))-p_n(t_n(x))}{\delta}\equiv p'_n(t_n(x))t'_n(x)\err{\frac{a_6}{n}+b_6\{\delta\}}$ when two complex numbers $x,dx$ such that $R(x)$, $n>b_5$, and $\lVert\delta\rVert^2<{c_6}^2$ are chosen.
		    \end{enumerate}
		  \implementation
		    \begin{enumerate}
		      \item Let $a_5=a_0a_2$.
