		    ...
		    \begin{instructions}
		      ...
		      \begin{instructions}
		        ...
		        \begin{instructions}
		          ...
		          \item $=\lVert\Delta_{y=x}^{+\delta}(\ln_n(1+(1+(-2)(y+1)^{-1}))+(-1)\ln_n(1+(-1)(1+(-2)(y+1)^{-1})))-((1+(1+(-2)(x+1)^{-1}))^{-1}(0+(-2)(-1)(x+1)^{-2}(1+0)+(-1)((1+(-1)(1+(-2)(x+1)^{-1}))^{-1}\cdot(0+(-1)(0+(-2)(-1)(x+1)^{-2}(1+0)))))^2$
		          \item $\le(\frac{a}{n}+b\{\delta\})^2$.
		        \end{instructions}
		      \end{instructions}
		...
		\procedure{thu2208191610}
		  ...
		  \implementation
		    \begin{instructions}
		      \item Execute the following in post-order:
		      \begin{instructions}
		        \item Execute \procedurehr{mon1908191207} on $\langle q_7,q_3,q_4,q_8,q_5,q_6\rangle$ and let $\langle q_1,q_2\rangle$ receive.
		        \begin{instructions}
