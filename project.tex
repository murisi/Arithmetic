		...
		\procedure{thu2507191359}
		  ...
		  \implementation
		    \begin{enumerate}
		      ...
		      \item Let $p(x,y,n)$ be the following procedure:
		      \begin{enumerate}
		        \item Using procedures $q,r,t$, verify that $\exp_n(x-y)$
		        \begin{enumerate}
		        ...
		        \end{enumerate}
		        \item \textbf{Hence verify that $\exp_n(x-y)\equiv\frac{\exp_n(x)}{\exp_n(y)}\err{\frac{cX^2}{n}+\frac{gcX^2}{en}}\err{\frac{a}{n}}$.}
		      \end{enumerate}
		      \item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
		    \end{enumerate}
		\procedure{3.16}
