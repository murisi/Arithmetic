			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence using \procedurehr{3.08} and \procedurehr{3.09}, verify that $(1+\frac{x}{n})^r$
						\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence execute procedure $q$ on $\langle -2x,r,n\rangle$.
						\item Therefore verify that $(1+\frac{-2x}{n})^r\le c^2$.
						...
						\item Hence verify that $(1+\frac{x}{n})^r$
						\begin{enumerate}
							\item $=(\frac{n+x}{n})^r$
							\item $=(\frac{n}{n+x})^{-r}$
							\item $=(1-\frac{x}{n+x})^{-r}$
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Hence execute procedure $q$ on $\langle x,r,n\rangle$.
							\item \textbf{Hence verify that $(1+\frac{x}{n})^r\ge c^2\ge a^2$.}
						\end{enumerate}
						\item Otherwise do the following:
						\begin{enumerate}
							\item Verify that $x\ge 0$.
							\item \textbf{Using \procedurehr{2.07}, verify that $(1+\frac{x}{n})^r\ge 1+\frac{rx}{n}\ge 1\ge a^2$.}
						\end{enumerate}
					\end{enumerate}
					\item \textbf{Yield the tuple $\langle a,b,p\rangle$.}
				\end{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence execute procedure $q$ on $\langle y,r,n\rangle$.
						\item Hence verify that $(1+\frac{y}{n})^r\le a^2$.
						\item Now using \procedurehr{3.02} verify that $\lVert(1+\frac{x}{n})^r\rVert^2$
						\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence execute procedure $q$ on $\langle -y,r,n\rangle$.
						\item Hence verify that $(1+\frac{-y}{n})^r\ge a^2$.
						\item Also, verify that $n>b\ge c\ge y$.
						\item Hence verify that $\lVert(1+\frac{x}{n})^r\rVert^2$
						\begin{enumerate}
							\item $=(1+\frac{x}{n})^r\conj{(1+\frac{x}{n})^r}$
							\item $=(1+\frac{x}{n})^r(1+\frac{\conj{x}}{n})^r$
							\item $=(1+\frac{2\Re(x)}{n}+\frac{\lVert x\rVert^2}{n^2})^r$
