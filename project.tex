...
\newglossaryentry{binomialseries}{name=\ensuremath{(1+x)_n^a},description={binomial series}}
\newglossaryentry{naturallogarithm}{name=\ensuremath{\ln_k(1+x)},description={natural logarithm}}
...
\begin{document}
	...
	\mfigure
		\begin{minipage}[c]{0.65\textwidth}
			\begin{tikzpicture}[scale=1,every node/.style={scale=0.9}]
				\draw[step=1,help lines] (-5.000000,-5.000000) grid (5.000000,3.000000);
				\draw[->] (-5.000000,0) -- (5.000000,0);
				\draw[->] (0,-5.000000) -- (0,3.000000);
				\draw (-5.000000, 0.100000) -- (-5.000000,-0.100000);
				...
				\draw (3.000000, 0.100000) -- (3.000000,-0.100000);
				\draw (4.000000, 0.100000) -- (4.000000,-0.100000);
				\draw (0.100000, -5.000000) -- (-0.100000,-5.000000);
				\draw (0.100000, -4.000000) -- (-0.100000,-4.000000);
				...
				\draw (1.000000,0.000000) node[anchor=south west,fill=white]{$(1+\frac{6i}{10})^{0}$};
				\filldraw (1.000000,0.000000) circle (2pt);
				\draw (1.000000,0.000000) -- (1.000000,0.600000);
				\filldraw (1.000000,0.600000) circle (2pt);
				\draw (1.000000,0.600000) node[anchor=south west,fill=white]{$(1+\frac{6i}{10})^{1}$};
				\filldraw (1.000000,0.600000) circle (2pt);
				\draw (1.000000,0.600000) -- (0.640000,1.200000);
				\filldraw (0.640000,1.200000) circle (2pt);
				\draw (0.640000,1.200000) node[anchor=south west,fill=white]{$(1+\frac{6i}{10})^{2}$};
				\filldraw (0.640000,1.200000) circle (2pt);
				\draw (0.640000,1.200000) -- (-0.080000,1.584000);
				\filldraw (-0.080000,1.584000) circle (2pt);
				\draw (-0.080000,1.584000) node[anchor=south east,fill=white]{$(1+\frac{6i}{10})^{3}$};
				\filldraw (-0.080000,1.584000) circle (2pt);
				\draw (-0.080000,1.584000) -- (-1.030400,1.536000);
				\filldraw (-1.030400,1.536000) circle (2pt);
				\draw (-1.030400,1.536000) node[anchor=south east,fill=white]{$(1+\frac{6i}{10})^{4}$};
				\filldraw (-1.030400,1.536000) circle (2pt);
				\draw (-1.030400,1.536000) -- (-1.952000,0.917760);
				\filldraw (-1.952000,0.917760) circle (2pt);
				\draw (-1.952000,0.917760) node[anchor=south east,fill=white]{$(1+\frac{6i}{10})^{5}$};
				\filldraw (-1.952000,0.917760) circle (2pt);
				\draw (-1.952000,0.917760) -- (-2.502656,-0.253440);
				\filldraw (-2.502656,-0.253440) circle (2pt);
				\draw (-2.502656,-0.253440) node[anchor=north east,fill=white]{$(1+\frac{6i}{10})^{6}$};
				\filldraw (-2.502656,-0.253440) circle (2pt);
				\draw (-2.502656,-0.253440) -- (-2.350592,-1.755034);
				\filldraw (-2.350592,-1.755034) circle (2pt);
				\draw (-2.350592,-1.755034) node[anchor=north east,fill=white]{$(1+\frac{6i}{10})^{7}$};
				\filldraw (-2.350592,-1.755034) circle (2pt);
				\draw (-2.350592,-1.755034) -- (-1.297572,-3.165389);
				\filldraw (-1.297572,-3.165389) circle (2pt);
				\draw (-1.297572,-3.165389) node[anchor=north east,fill=white]{$(1+\frac{6i}{10})^{8}$};
				\filldraw (-1.297572,-3.165389) circle (2pt);
				\draw (-1.297572,-3.165389) -- (0.601661,-3.943932);
				\filldraw (0.601661,-3.943932) circle (2pt);
				\draw (0.601661,-3.943932) node[anchor=north west,fill=white]{$(1+\frac{6i}{10})^{9}$};
				\filldraw (0.601661,-3.943932) circle (2pt);
				\draw (0.601661,-3.943932) -- (2.968021,-3.582935);
				\filldraw (2.968021,-3.582935) circle (2pt);
				\draw (2.968021,-3.582935) node[anchor=north west,fill=white]{$(1+\frac{6i}{10})^{10}$};
				\filldraw (2.968021,-3.582935) circle (2pt);
			\end{tikzpicture}
		\end{minipage}
		\begin{minipage}[c]{0.35\textwidth}
			A plot of the list of complex numbers $(1+\frac{6i}{10})^{[0:11]}$. Notice that each multiplication of a complex number by $1+\frac{6i}{10}$ results in an anti-clockwise rotation about the origin and a small radial movement outwards. This can be seen to reflect the computation $(1+\frac{6i}{10})a=1a+\frac{6}{10}(ai)$ after one notes that $ai$ is perpendicular to $a$.
		\end{minipage}
	\begin{multicols}{2}
		\declaration{3.17}
		...
		\procedure{3.26}
			\objective
				 Choose a rational number $X\ge 0$. The objective of the following instructions is to construct two rational numbers $a,b$, and a procedure, $p$, to show that $\lVert\cos_n(x)^2+\sin_n(x)^2-1\rVert^2\le\frac{a^2\lVert x\rVert^4}{n^2}$ when a complex number $x$ and a positive integer $n$ such that $\lVert x\rVert^2\le X^2$ are chosen.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.15} on $\langle X\rangle$ and let $\langle a,b,q\rangle$ receive.
					\item Let $p(x,n)$ be the following procedure:
		...
		\declaration{sun2107190610}
			The notation \gls{binomialseries}, where $x,a$ are complex numbers and $n$ is a positive integer, will be used as a shorthand for $\sum_r^{[0:n]}\binom{a}{r}x^r$.
    ...
    \declaration{fri2607191453}
	    The notation \gls{naturallogarithm} will be used as a shorthand for $\sum_r^{[1:k]}\frac{(-1)^{r-1}}{r}x^r$.
	...
	\mfigure
		\begin{minipage}[c]{0.65\textwidth}
			\begin{tikzpicture}[scale=1.25,every node/.style={scale=0.9}]
				...
				\draw (1,-0.100000) node[anchor=north,fill=white]{$1$};
				\draw (-0.100000,1) node[anchor=east,fill=white]{$i$};
				\draw (1.000000,0.000000) node[anchor=south west,fill=white]{$\exp_{30}(\frac{0}{10}\tau_{20}i)$};
				\filldraw (1.000000,0.000000) circle (2pt);
				\draw (0,0) -- (1.000000,0.000000);
				\draw (0.802961,0.607738) node[anchor=south west,fill=white]{$\exp_{30}(\frac{1}{10}\tau_{20}i)$};
				\filldraw (0.802961,0.607738) circle (2pt);
				\draw (0,0) -- (0.802961,0.607738);
				\draw (0.279873,0.989544) node[anchor=south west,fill=white]{$\exp_{30}(\frac{2}{10}\tau_{20}i)$};
				\filldraw (0.279873,0.989544) circle (2pt);
				\draw (0,0) -- (0.279873,0.989544);
				\draw (-0.385515,0.992634) node[anchor=south east,fill=white]{$\exp_{30}(\frac{3}{10}\tau_{20}i)$};
				\filldraw (-0.385515,0.992634) circle (2pt);
				\draw (0,0) -- (-0.385515,0.992634);
				\draw (-0.949568,0.590148) node[anchor=south east,fill=white]{$\exp_{30}(\frac{4}{10}\tau_{20}i)$};
				\filldraw (-0.949568,0.590148) circle (2pt);
				\draw (0,0) -- (-0.949568,0.590148);
				\draw (-1.185604,-0.102004) node[anchor=north east,fill=white]{$\exp_{30}(\frac{5}{10}\tau_{20}i)$};
				\filldraw (-1.185604,-0.102004) circle (2pt);
				\draw (0,0) -- (-1.185604,-0.102004);
				\draw (-0.961134,-0.851123) node[anchor=north east,fill=white]{$\exp_{30}(\frac{6}{10}\tau_{20}i)$};
				\filldraw (-0.961134,-0.851123) circle (2pt);
				\draw (0,0) -- (-0.961134,-0.851123);
				\draw (-0.293406,-1.372598) node[anchor=north east,fill=white]{$\exp_{30}(\frac{7}{10}\tau_{20}i)$};
				\filldraw (-0.293406,-1.372598) circle (2pt);
				\draw (0,0) -- (-0.293406,-1.372598);
				\draw (0.635110,-1.419124) node[anchor=north west,fill=white]{$\exp_{30}(\frac{8}{10}\tau_{20}i)$};
				\filldraw (0.635110,-1.419124) circle (2pt);
				\draw (0,0) -- (0.635110,-1.419124);
				\draw (1.511058,-0.871522) node[anchor=north west,fill=white]{$\exp_{30}(\frac{9}{10}\tau_{20}i)$};
				\filldraw (1.511058,-0.871522) circle (2pt);
				\draw (0,0) -- (1.511058,-0.871522);
			\end{tikzpicture}
		\end{minipage}
		\begin{minipage}[c]{0.35\textwidth}
			A plot of the list of complex numbers $\exp_{30}(\frac{[0:11]}{10}\tau_{20}i)$. Notice that when measurements are done relative to the complex number $1$, $\exp_{30}(\frac{1}{10}\tau_{20}i)$ is roughly $\frac{1}{10}$\textsuperscript{th} of a revolution, and also that each complex number has an angle that is roughly an integral multiple of that of $\exp_{30}(\frac{1}{10}\tau_{20}i)$.
		\end{minipage}
	\begin{multicols}{2}
		\procedure{3.90}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Hence verify that\footnote{Certain techniques were used to construct instructions (ii), (iii), and (iv); these techniques go by the name of "the chain rule" and "the product rule".} $\lVert dx\diff_{z=x}^{dx}(z\exp_n(-y(z)))\rVert^2$
						\begin{enumerate}
