...
\begin{document}
	...
	\section{Integer Arithmetic}
		...
		\procedure{1.19}
			...
			\implementation
				...
				\end{enumerate}
		\notation{1.04}
			Let us use the notation $(a_1,a_2,\cdots,a_n)$ as a shorthand for "either $(a_1,(a_2,a_3,\cdots,a_n))$ or $((a_1,a_2),(a_3,a_4,\cdots,a_n))$ or $\cdots$ or $((a_1,a_2,\cdots,a_{n-1}),a_n)$".
		\procedure{1.20}
			\objective
		...
		\notation{1.07}
			Let us use the notation $a_*$ as a shorthand for "$1\cdot a_1a_2\cdots a_{\lvert a\rvert}$".
		\notation{1.08}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Verify that $b_*\equiv a_*\equiv 0 (\mod a_1)$.
						\item Execute \procedurehr{1.25} on $\langle a_1, b\rangle$ and let $\langle k\rangle$ receive.
						\item Therefore verify that $b_k=a_1$.
						\item Now verify $(a_{[2:\lvert a\rvert+1]})_*=(b_{[1:k]^\frown[k+1:\lvert b\rvert+1]})_*$.
						\item Now execute \procedurehr{1.26} on $\langle a_{[2:\lvert a\rvert+1]},b_{[1:k]^\frown[k+1:\lvert b\rvert+1]}\rangle$.
						\item Now verify that $a_{[2:\lvert a\rvert+1]}$ is included in $b_{[1:k]^\frown[k+1:\lvert b\rvert+1]}\rangle$.
		...
		\procedure{1.28}
			\objective
				Choose a positive integer $a$. The objective of the following instructions is to construct a prime $b$ such that $b>a$ and $c$ is not prime for $c=a+1$ up to $c=b-1$.
			\implementation
				\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Now verify that $a_*=dc=dh_*=dh_1(h_{[2:\vert h\rvert+1]})_*\equiv 0(\mod h_1)$.
						\item Execute \procedurehr{1.25} on $\langle h_1,a\rangle$ and let $\langle k\rangle$ receive.
						\item Now verify that $b_*=ec=eh_*=eh_1(h_{[2:\vert h\rvert+1]})_*\equiv 0(\mod h_1)$.
						\item Execute \procedurehr{1.25} on $\langle h_1,b\rangle$ and let $\langle m\rangle$ receive.
						\item \textbf{Therefore verify that $a_k=b_m$.}
						\item \textbf{Abort procedure.}
					\end{enumerate}
					\item Otherwise do the following:
					\begin{enumerate}
		...
		\procedure{1.33}
			\objective
				Choose two positive integers $a,b$. The objective of the following instructions is to show that $[a,b]=[b,a]$.
			\implementation
				\begin{enumerate}
					\item Verify that $(a,b)>0$.
					\item Verify that $[a,b](a,b)=ab=ba=[b,a](b,a)=[b,a](a,b)$.
					\item \textbf{Therefore verify that $[a,b]=[b,a]$.}
				\end{enumerate}
		\procedure{1.34}
			\objective
				Choose an integer $a$ and two positive integers $b,c$. The objective of the following instructions is to show that $[ca,cb]=c[a,b]$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.35}
			\objective
				Choose an integer $a$ and two positive integers $b,c$. The objective of the following instructions is to show that $[[a,b],c]=[a,[b,c]]$.
			\implementation
				\begin{enumerate}
					\item Verify that $(a,b)(ab,(ac,bc))(b,c)[[a,b],c]$
					\begin{enumerate}
		...
		\procedure{1.36}
			\objective
				Choose three positive integers $a,b,c$. The objective of the following instructions is to show that $([a,b],c)=[(a,c),(b,c)]$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.40}
			\objective
				Choose two integers $a,c$ and two positive integers $b,d$ in such a way that $a\equiv c(\mod(b,d))$. The objective of the following instructions is to show that $\chi_{b,d}(a,c)=\chi_{d,b}(c,a)$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{1.09} on $\langle b,d\rangle$ and let $\langle f,g,h,i,j\rangle$ receive.
		...
		\procedure{1.42}
			\objective
				Choose three integers $x,a,c$ and two positive integers $b,d$ such that $a\equiv c(\mod(b,d))$ and $x\equiv\chi_{b,d}(a,c)(\mod[b,d])$. The objective of the following instructions is to show that $x\equiv a(\mod b)$ and $x\equiv c(\mod d)$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{1.41} on $\langle x,a,c,b,d\rangle$.
					\item \textbf{Therefore verify that $x\equiv a(\mod b)$.}
					\item Now verify that $x\equiv\chi_{b,d}(a,c)\equiv\chi_{d,b}(c,a)(\mod[d,b])$
		...
		\procedure{1.44}
			\objective
				Choose two integers $a,c$ and three positive integers $b,d,e$ such that $a\equiv c(\mod(eb,ed))$. The objective of the following instructions is to show that $\chi_{eb,fd}(a,c)\mod[b,d]=\chi_{b,d}(a,c)$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.45}
			\objective
				Choose three integers $a,c,e$ and three positive integers $b,d,f$ such that $a\equiv e(\mod(b,f))$, and $c\equiv e(\mod(d,f))$. The objective of the following instructions is to show that $\chi_{b,d}(a,c)\equiv e(\mod([b,d],f))$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.46}
			...
			\implementation
				...
				\end{enumerate}
		\notation{1.13}
			Let us use the notation $\chi_{b_1,b_2,\cdots,b_n}(a_1,a_2,\cdots,a_n)$ as a shorthand for "either $\chi_{b_1,[b_2,b_3,\cdots,b_n]}(a_1,\chi_{b_2,b_3,\cdots,b_n}(a_2,a_3,\cdots,a_n))$ or $\chi_{[b_1,b_2],[b_3,b_4,\cdots,b_n]}(\chi_{b_1,b_2}(a_1,a_2),\chi_{b_3,b_4,\cdots,b_n}(a_3,a_4,\cdots,a_n)$ or $\cdots$ or $\chi_{[b_1,b_2,\cdots,b_{n-1}],b_n}(\chi_{b_1,b_2,\cdots,b_{n-1}}(a_1,a_2,\cdots,a_{n-1}),a_n)$".
		\notation{1.14}
			Let us use the notation $\phi(n)$ as a shorthand for "the list of distinct non-negative integers less than $n$ where each integer $x$ is such that $(x,n)=1$".
		\procedure{1.47}
			\objective
				Choose an integer $a$ and a positive integer $b$ such that $(a,b)=1$. The objective of the following instructions is to show that each element of $a\phi(b)\mod b$ is in $\phi(b)$.
			\implementation
				\begin{enumerate}
					\item Verify that $(a,b)=1$.
					\item For $i=1$ to $i=\phi(b)$, do the following:
					\begin{enumerate}
						...
						\item Executee \procedurehr{1.17} on $\langle a\phi(b)_i\mod b,a\phi(b)_i,b\rangle$.
		...
		\procedure{1.48}
			\objective
				Choose an integer $a$ and a positive integer $b$ such that $(a,b)=1$. The objective of the following instructions is to show that each element of $a\phi(b)\mod b$ is distinct.
			\implementation
				\begin{enumerate}
					...
					\item Now for $i=1$ to $i=\lvert\phi(b)\rvert$, do the following:
					\begin{enumerate}
						\item For $j=i+1$ to $j=\lvert\phi(b)\rvert$, do the following:
						\begin{enumerate}
		...
		\procedure{1.49}
			\objective
				Choose an integer $a$ and a positive integer $b$ such that $(a,b)=1$. The objective of the following instructions is to show that $a\phi(b)\mod b$ is a rearrangement of $\phi(b)$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.50}
			\objective
				Choose an integer $a$ and a positive integer $b$ such that $(a,b)=1$. The objective of the following instructions is to show that $a^{\lvert\phi(b)\rvert}\equiv 1(\mod b)$.
			\implementation
				\begin{enumerate}
					\item For $i=1$ to $i=\lvert\phi(b)\rvert$, do the following:
					\begin{enumerate}
					...
					\end{enumerate}
					\item Therefore using \procedurehr{1.49}, verify that $\prod_{i=1}^{\lvert\phi(b)\rvert}\phi(b)_i\equiv\prod_{i=1}^{\lvert\phi(b)\rvert}a\phi(b)_i\equiv a^{\lvert\phi(b)\rvert}\prod_{i=1}^{\lvert\phi(b)\rvert}\phi(b)_i(\mod b)$.
					\item \textbf{Therefore verify that $1\equiv\prod_{i=1}^{\lvert\phi(b)\rvert}(v_i\phi(b)_i)=\prod_{i=1}^{\lvert\phi(b)\rvert}v_i\prod_{i=1}^{\lvert\phi(b)\rvert}\phi(b)_i\equiv a^{\lvert\phi(b)\rvert}\prod_{i=1}^{\lvert\phi(b)\rvert}\phi(b)_i\prod_{i=1}^{\lvert\phi(b)\rvert}v_i\equiv a^{\lvert\phi(b)\rvert}(\mod b)$.}
				\end{enumerate}
		\notation{1.15}
			Let us use the notation $a\times b$ as a shorthand for "the $\lvert a\rvert\times\lvert b\rvert$ matrix such that for $1\le i\le\lvert a\rvert$, for $1\le j\le\lvert b\rvert$, $(a\times b)_{i,j}=\langle a_i,b_j\rangle$".
		\procedure{1.52}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\item Verify that $c=(a,b)=1$.
					\item Therefore verify that $b=ce=(1)e=e$.
					\item Therefore verify that $0\le h_{i,j}<[a,b]=ae=ab$ for $1\le i\le a$, for $1\le j\le b$.
					\item \textbf{Therefore verify that each entry of $h$ is in $[0:ab]$.}
				\end{enumerate}
		\procedure{1.53}
			\objective
				Choose two positive integers $a,b$ such that $(a,b)=1$. The objective of the following instructions is to show that each entry of $\chi_{a,b}([0:a]\times[0:b])$ is distinct.
			\implementation
				\begin{enumerate}
					\item Let $h=\chi_{a,b}([0:a]\times[0:b])$.
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Verify that $\chi_{a,b}(i-1,j-1)=\chi_{a,b}(k-1,l-1)$.
							\item Therefore verify that $i-1\equiv\chi_{a,b}(i-1,j-1)=\chi_{a,b}(k-1,l-1)\equiv k-1(\mod a)$.
							\item Therefore verify that $i=k$.
							\item Also verify that $j-1\equiv\chi_{a,b}(i-1,j-1)=\chi_{a,b}(k-1,l-1)\equiv l-1(\mod b)$.
		...
		\procedure{1.54}
			\objective
				Choose two positive integers $a,b$ such that $(a,b)=1$. The objective of the following instructions is to show that $\chi_{a,b}([0:a]\times[0:b])$ is a rearrangement $[0:ab]$.
			\implementation
				\begin{enumerate}
					\item Let $h=\chi_{a,b}([0:a]\times[0:b])$.
		...
		\procedure{1.55}
			\objective
				Choose two positive integers $a,b$ such that $(a,b)=1$. The objective of the following instructions is to show that each entry of $\chi_{a,b}(\phi(a)\times\phi(b))$ is in $\phi(ab)$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.56}
			\objective
				Choose two positive integers $a,b$ such that $(a,b)=1$. The objective of the following instructions is to show that each entry of $\phi(ab)$ is in $\chi_{a,b}(\phi(a)\times\phi(b))$.
			\implementation
				\begin{enumerate}
					\item For $i=1$ to $i=\lvert\phi(ab)\rvert$, do the following:
					\begin{enumerate}
						\item Verify that $(\phi(ab)_i,ab)=1$.
						\item Verify that $\phi(ab)_i\equiv\phi(ab)_i\mod a(\mod a)$.
						\item Therefore verify that $(\phi(ab)_i\mod a,a)=(\phi(ab)_i,a)=1$.
						...
						\item Also verify that $(\phi(ab)_i\mod b,b)=(\phi(ab)_i,b)=1$.
						...
						\item Also using (b) and (f), verify that $\phi(ab)_i\equiv\chi_{a,b}(\phi(ab)_i\mod a,\phi(ab)_i\mod b)(\mod[a,b]=[a,b](a,b)=ab)$.
		...
		\procedure{1.57}
			\objective
				Choose two positive integers $a,b$ such that $(a,b)=1$. The objective of the following instructions is to show that $\phi(ab)$ is a rearrangement of $\chi_{a,b}(\phi(a)\times\phi(b))$ and that $\lvert\phi(ab)\rvert=\lvert\phi(a)\rvert\lvert\phi(b)\rvert$.
			\implementation
				\begin{enumerate}
		...
		\procedure{1.58}
			\objective
				Choose a positive integer $a$ and a prime $b$. The objective of the following instructions is to show that $\lvert\phi(b^a)\rvert=b^a-b^{a-1}$.
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{1.21}, verify that $\sum_{r=0}^{b^a-1}[(r,b^a)=1]\le\sum_{r=0}^{b^a-1}[(r,b)=1]$.
					\item Using \procedurehr{1.20}, verify that $\sum_{r=0}^{b^a-1}[(r,b)=1]\le\sum_{r=0}^{b^a-1}[(r,b^a)=1]$.
					\item Therefore verify that $\sum_{r=0}^{b^a-1}[(r,b^a)=1]=\sum_{r=0}^{b^a-1}[(r,b)=1]$.
					\item Using \procedurehr{1.13}, verify that $\sum_{r=0}^{b^a-1}[(r,b)=1]\le\sum_{r=0}^{b^a-1}[r\mod b\ne 0]$.
					\item Using \procedurehr{1.22}, verify that $\sum_{r=0}^{b^a-1}[r\mod b\ne 0]\le\sum_{r=0}^{b^a-1}[(r,b)=1]$.
					\item Therefore verify that $\sum_{r=0}^{b^a-1}[(r,b)=1]=\sum_{r=0}^{b^a-1}[r\mod b\ne 0]$.
					\item \textbf{Therefore using (3) and (6), verify that $\lvert\phi(b^a)\rvert=\sum_{r=0}^{b^a-1}[(r,b^a)=1]=\sum_{r=0}^{b^a-1}[(r,b)=1]=\sum_{r=0}^{b^a-1}[r\mod b\ne 0]=\sum_{r=0}^{b^a-1}(1-[r\mod b=0])=b^a-b^{a-1}$.}
				\end{enumerate}
		\procedure{1.59}
			\objective
				Choose a list of primes $a$. Let $b$ be the list of distinct primes in $a$. Let $c$ be a list such that $c_i$ is the multiplicity of $b_i$ in $a$ for $i=1$ to $i=\lvert b\rvert$. The objective of the following instructions is to show that $\lvert\phi(a_*)\rvert=\prod_{i=1}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})$.
			\implementation
				\begin{enumerate}
					\item If $a=\langle\rangle$, then do the following:
					\begin{enumerate}
						\item Verify that $\lvert b\rvert=\lvert a\rvert=0$.
						\item \textbf{Therefore verify that $\phi(a_*)=\phi(1)=1=\prod_{i=1}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})$.}
					\end{enumerate}
					\item Otherwise, do the following:
					\begin{enumerate}
						\item Verify that $a_*=\prod_{i=1}^{\lvert b\rvert} {b_i}^{c_i}$.
						\item Verify that $\lvert a\rvert>0$.
						\item Therefore verify that $\lvert c\rvert=\lvert b\rvert>0$.
						\item Therefore using \procedurehr{1.30}, verify that $({b_1}^{c_1},\prod_{i=2}^{\lvert b\rvert}{b_i}^{c_i})=1$.
						\item Let $d$ be the list $a$ with all instances of $a_1$ removed.
						\item Verify that $\lvert d\rvert<\lvert a\rvert$.
						\item Now execute \procedurehr{1.59} on $\langle d\rangle$.
						\item Hence verify that $\phi(d_*)=\phi(\prod_{i=2}^{\lvert b\rvert}{b_i}^{c_i})=\prod_{i=2}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})$.
						\item \textbf{Therefore using (d), (h), \procedurehr{1.57} and \procedurehr{1.58}, verify that $\lvert\phi(a_*)\rvert=\lvert\phi(\prod_{i=1}^{\lvert b\rvert} {b_i}^{c_i})\rvert=\lvert\phi({b_1}^{c_1}\prod_{i=2}^{\lvert b\rvert}{b_i}^{c_i})\rvert=\lvert\phi({b_1}^{c_1})\rvert\lvert\phi(\prod_{i=2}^{\lvert b\rvert}{b_i}^{c_i})\rvert=({b_1}^{c_1}-{b_1}^{c_1-1})\lvert\phi(\prod_{i=2}^{\lvert b\rvert}{b_i}^{c_i})\rvert=({b_1}^{c_1}-{b_1}^{c_1-1})\prod_{i=2}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})=\prod_{i=1}^{\lvert b\rvert}({b_i}^{c_i}-{b_i}^{c_i-1})$.}
					\end{enumerate}
				\end{enumerate}
		\notation{1.17}
		...
		\procedure{1.63}
			\objective
				Choose a non-negative integer $a$. The objective of the following instructions is to show that the $\mathbb{Z}[x]$ $(1+x)^a=\sum_{r=0}^a\binom{a}{r}x^r$.
			\implementation
				\begin{enumerate}
					\item If $a=0$, then do the following:
					\begin{enumerate}
						\item \textbf{Verify that $(1+x)^a=(1+x)^0=1=\sum_{r=0}^0\binom{0}{r}x^r=\sum_{r=0}^a\binom{a}{r}x^r$.}
					\end{enumerate}
					\item Otherwise, do the following:
					\begin{enumerate}
						...
						\item Therefore verify that $(1+x)^{a-1}=\sum_{r=0}^{a-1}\binom{a-1}{r}x^r$.
						\item Therefore using \procedurehr{1.62}, verify that $(1+x)^a$
						\begin{enumerate}
							\item $=(1+x)(1+x)^{a-1}$
							\item $=(1+x)\sum_{r=0}^{a-1}\binom{a-1}{r}x^r$
							\item $=\sum_{r=0}^{a-1}\binom{a-1}{r}x^r+\sum_{r=0}^{a-1}\binom{a-1}{r}x^{r+1}$
							\item $=\sum_{r=0}^{a}\binom{a-1}{r}x^r+\sum_{r=1}^{a}\binom{a-1}{r-1}x^{r}$
							\item $=1+\sum_{r=1}^{a}(\binom{a-1}{r}+\binom{a-1}{r-1})x^{r}$
							\item $=1+\sum_{r=1}^{a}\binom{a}{r}x^{r}$
							\item $=\sum_{r=0}^{a}\binom{a}{r}x^{r}$.
						\end{enumerate}
					\end{enumerate}
				\end{enumerate}
		\procedure{1.64}
		...
		\procedure{1.65}
			\objective
				Choose a non-negative integer $a$ and a prime $b$. The objective of the following instructions is to show that the $\mathbb{Z}[x]$ $\sum_{r=0}^a\binom{a}{r}x^r\equiv\sum_{r=0}^a\binom{a\div b}{r\div b}\binom{a\mod b}{r\mod b}x^r(\mod b)$.
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{1.02}, \procedurehr{1.63}, and \procedurehr{1.64}, verify that $\sum_{r=0}^a\binom{a}{r}x^r$
					\begin{enumerate}
						\item $=(1+x)^a$
						\item $=(1+x)^{(a\div b)b+a\mod b}$
						\item $=(1+x)^{(a\div b)b}(1+x)^{a\mod b}$
						\item $=((1+x)^b)^{a\div b}(1+x)^{a\mod b}$
						\item $=(\sum_{u=0}^b\binom{b}{u}x^u)^{a\div b}(\sum_{t=0}^{a\mod b}\binom{a\mod b}{t}x^t)$
						\item $\equiv(1+x^b)^{a\div b}(\sum_{t=0}^{a\mod b}\binom{a\mod b}{t}x^t)$
						\item $=(\sum_{u=0}^{a\div b}(x^b)^u\binom{a\div b}{u})(\sum_{t=0}^{a\mod b}\binom{a\mod b}{t}x^t)$
						\item $=\sum_{u=0}^{a\div b}\sum_{t=0}^{a\mod b}\binom{a\div b}{u}\binom{a\mod b}{t}x^{ub+t}$
						\item $=\sum_{u=0}^{a\div b}\sum_{t=0}^{a\mod b}\binom{a\div b}{(ub+t)\div b}\binom{a\mod b}{(ub+t)\mod b}x^{ub+t}$
						\item $=\sum_{r=0}^{a}\binom{a\div b}{r\div b}\binom{a\mod b}{r\mod b}x^{r}(\mod b)$.
					\end{enumerate}
				\end{enumerate}
	\section{Rational Arithmetic}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Execute \procedurehr{2.0} on the formal polynomial $f$ and let the tuple $\langle G\rangle$ receive the result.
						\item Let $x$ be an indeterminate.
		...
		\procedure{2.05}
			\objective
				Execute \procedurehr{2.04} and let $\langle s,q,g,h\rangle$ receive. Execute \procedurehr{2.0} on $s$ and let $\langle G\rangle$ receive the result. Choose $\mathbb{Q}$s $c$ and $d$ in such a way that:
				\begin{enumerate}
		...
		\procedure{2.09}
			\objective
				Execute \procedurehr{2.04} and let $\langle s,q,g,h\rangle$ receive. Let $m=\lvert s\rvert-1$. The objective of the following instructions is to either show that $0<0$ or to construct two lists of rational numbers $c,d$ such that $c_1<d_1\le c_2<d_2\le\cdots\le c_m<d_m$ and $\sgn(s_m(c_i))=-\sgn(s_m(d_i))$ for $i=1$ to $i=m$.
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{2.0} on $s$ and let $\langle G\rangle$ receive the result.
					...
					\begin{enumerate}
						\item Execute \procedurehr{2.05} on the tuple $\langle e_i,e_{i+1}\rangle$.
						\item If $J_m(c)\ne J_m(d)$, then do the following:
						\begin{enumerate}
							\item Append $e_i$ to $c$.
							\item Append $e_{i+1}$ to $d$.
							\item Cognizant of \procedurehr{2.05}, verify that $\lvert J_m(d)-J_m(c)\rvert=1$.
	...
	\section{Matrix Arithmetic}
				...
				\begin{enumerate}
					...
					\item Now do the following:
						...
						\begin{enumerate}
							...
							\item Apply \procedurehr{3.0} on this submatrix.
					...
					\item Apply \procedurehr{3.01} on the submatrix $A_{[2:m+1],[2:n+1]}$.
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							\item Execute \procedurehr{3.0} on the submatrix of $A'$ formed by selecting row $1$ and columns $1$ and $j$ as if there were nothing in between.
						\end{enumerate}
		...
		\procedure{3.09}
			...
			\implementation
				\begin{enumerate}
					\item Apply \procedurehr{3.01} on matrix $A$.
					...
					\begin{enumerate}
						...
						\item Let $\langle M,N\rangle$ receive the results of executing \procedurehr{3.03} on the pair $\langle m,n\rangle$ and the following procedure:
						\begin{enumerate}
							\item Apply \procedurehr{3.07} on the submatrix of $A'$ containing rows $j$ to $m$ and columns $j$ to $n$, and let $\langle u\rangle$ receive.
						\end{enumerate}
		...
		\procedure{3.10}
			...
			\implementation
				\begin{enumerate}
					...
					\item Otherwise, do the following:
					\begin{enumerate}
						\item \textbf{Yield the tuple $\langle\sum_{r=1}^m (-1)^{r-1}A_{r,1}\det(A_{[1:r]^\frown[r+1,m+1],[2:m+1]})\rangle$.}
					\end{enumerate}
				\end{enumerate}
		\procedure{3.11}
			\objective
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item \textbf{Therefore using \procedurehr{3.10}, verify that $(C_k(I_m))_{\ul{I},\ul{J}}=\det((I_m)_{I,J})=\det(I_k)=1$.}
						\end{enumerate}
						\item Otherwise, do the following:
						\begin{enumerate}
							\item Verify that $I\ne J$.
							...
							\item \textbf{Therefore using \procedurehr{3.10}, verify that $(C_k(I_m))_{\ul{I},\ul{J}}=\det((I_m)_{I,J})=0$.}
						\end{enumerate}
					\end{enumerate}
				...
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item For each column label $J$: Using \procedurehr{3.11}, verify that ${C_k(AB)}_{\ul{I},\ul{J}}=\det((AB)_{I,J})=\det(B_{I,J})+p*\det(B_{I',J})$.
							\item If $j\in I$, then do the following:
							\begin{enumerate}
								\item Verify that the sequence $I'$ contains two $j$s.
								\item For each column label $J$: Using \procedurehr{3.13} verify that $\det(B_{I',J})=0$.
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							\item Using \procedurehr{3.15}, verify that every element of $I$ is less than or equal to $\min(m,n)$.
							\item Let $A_0=A$.
							\item For $i=1$ to $i=k$: Let $A_i$ equal $A_{i-1}$ but with position $(I_i,I_i)$ set to $1$.
							\item For each column label $J$: Repeatedly using \procedurehr{3.11}, verify that ${C_k(AB)}_{I,J}$
							\begin{enumerate}
								\item $=\det((AB)_{I,J})$
								\item $=\det((A_0B)_{I,J})$
						...
						\begin{enumerate}
							...
							\item Therefore using \procedurehr{3.10}, for each column label $J$: verify that ${C_k(AB)}_{I,J}=\det((AB)_{I,J})=0$.
		...
		\procedure{3.19}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.17} on matrices $A$ and $I_m$. Let $D$ be the matrix constructed.
					\item Using \procedurehr{3.16}, verify that $C_k(A)=C_k(AI_m)=DC_k(I_m)=DI_{\binom{m}{k}}=D$.
					\item Execute \procedurehr{3.17} on matrices $A$ and $B$. Let $D'$ be the matrix constructed.
			...
			\textbf{Using \procedurehr{3.18}, make a procedure similar to the above but that only instead allows for a diagonal matrix of $\mathbb{Q}[x]$s, $A$, to be chosen.}
		\procedure{3.20}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\item Let $\langle M,N\rangle$ receive the results of executing \procedurehr{3.03} on the pair $\langle m,n\rangle$ and the following procedure:
						\begin{enumerate}
							\item Execute \procedurehr{3.09} on the matrix $D$ and let $\langle v\rangle$ receive.
						\end{enumerate}
		...
		\procedure{3.21}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on $A$ and let $\langle M,D,,N\rangle$ receive.
					\item Using repeated applications of \procedurehr{3.19}, verify that $C_k(AB)$
					\begin{enumerate}
		...
		\procedure{3.22}
			\objective
				Choose a $\mathcal{M}_{m,m}(\mathbb{Q}[x])$, $A$. Let $D$ be a copy of $A$. Execute \procedurehr{3.09} on $D$. The objective of the following instructions is to show that $\det(A)$ is the product of the diagonal entries of $D$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on $A$ and let $\langle M,D,,N\rangle$ receive.
					\item Using \procedurehr{3.10} and \procedurehr{3.21}, verify that $\det(A)$
					\begin{enumerate}
						\item $=C_m(A)$
						...
						\item $=\det(D)$.
					\end{enumerate}
					\item \textbf{Using \procedurehr{3.10}, verify that $\det(D)$ is the product of the diagonal entries of $D$.}
				\end{enumerate}
		\procedure{3.23}
			\objective
			...
			\implementation
				...
				\end{enumerate}
		\notation{3.09}
			Let us use the notation $A^T$ for the result yielded by executing \procedurehr{3.23} on $A$.
		\procedure{3.24}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						\item For $j=1$ to $j=m$:
						\begin{enumerate}
							\item Using \procedurehr{3.23}, verify that $(B^TA^T)_{i,j}=\sum_{l=0}^n B_{l,i}A_{j,l}=\sum_{l=0}^n A_{j,l}B_{l,i}=(AB)_{j,i}=((AB)^T)_{i,j}$.
						\end{enumerate}
					\end{enumerate}
		...
		\procedure{3.25}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on $A$ and let $\langle M,D,,N\rangle$ receive.
					\item Therefore using procedures \procedurehr{3.22} and \procedurehr{3.24}, verify that $\det(A^T)$
					\begin{enumerate}
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							\item Using \procedurehr{3.25}, verify that $(C_k(A^T))_{\ul{I},\ul{J}}=\det((A^T)_{I,J})=\det(A_{J,I})=(C_k(A))_{\ul{J},\ul{I}}$.
						\end{enumerate}
					\end{enumerate}
		...
		\procedure{3.27}
			...
			\implementation
				\begin{enumerate}
					...
					\item Let $E$ be $NC$.
					\item \textbf{Therefore using \procedurehr{3.05}, verify that $AE=M^{-1}DN^{-1}E=M^{-1}DN^{-1}NC=M^{-1}DI_nC=M^{-1}DC=M^{-1}MB=I_mB=B$.}
					\item \textbf{Yield the tuple $\langle E\rangle$.}
				\end{enumerate}
		\notation{3.10}
			The notation $A\backslash B$ shall be used to refer to the result yielded by executing \procedurehr{3.27} on matrices $A$ and $B$.
		\notation{3.11}
		...
		\procedure{3.28}
			\objective
				Choose a $\mathcal{M}_{m,n}(\mathbb{Q})$, $A$, a $\mathcal{M}_{n,p}(\mathbb{Q})$, $E$, and a $\mathcal{M}_{m,p}(\mathbb{Q})$, $B$ such that $AE=B$. Execute \procedurehr{3.20} on $A$ and let $\langle M,D,,N\rangle$ receive the result. If the indices of the rows of $D$ that are entirely zero are not also the indices of the rows of $M_*B$ that are entirely zero, then the objective of the following instructions is to show that $0\ne 0$.
			\implementation
				\begin{enumerate}
		...
		\procedure{3.29}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on $B$ and let $\langle M,D,,N\rangle$ receive the result.
					\item Verify that $B={M^{-1}}_*D{N^{-1}}_*$.
					\item If $D$ has a zero on its diagonal, then do the following:
					\begin{enumerate}
						\item Using \procedurehr{3.22}, verify that $\det(I_m)=\det(AB)=\det(A)\det(B)=\det(A)\det(D)=\det(A)*0=0$.
						\item Using \procedurehr{3.10}, verify that $\det(I_m)=1^m=1$.
		...
		\procedure{3.31}
			...
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{3.30} on $\langle M,B\rangle$ and let $\langle Q_1,R_1\rangle$ receive.
					\item Verify that $M=(xI_m-B)Q_1+R_1$.
					\item Execute \procedurehr{3.30} on $\langle N^{-1},A\rangle$ and let $\langle Q_2,R_2\rangle$ receive.
					...
					\item Execute \procedurehr{3.30} on $\langle M^{-1},A\rangle$ and let $\langle Q_3,R_3\rangle$ receive.
					...
					\item \textbf{Therefore using \procedurehr{3.29}, verify that $R_3R_1=I_m$.}
		...
		\procedure{3.33}
			...
			\implementation
				\begin{enumerate}
					\item Let $A$ be our working matrix.
					\item Use \procedurehr{3.32} to negate the $i^{th}$ row and swap it with the $j^{th}$ row.
					\item Use \procedurehr{3.32} to negate the $i^{th}$ column and swap it with the $j^{th}$ column.
		...
		\procedure{3.35}
			\objective
				Choose a $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Execute \procedurehr{3.09} on the polynomial matrix $xI-A$ and let $\langle B\rangle$ be the result. The objective of the following instructions is to show that either none of the diagonal entries of $B$ are equal to zero, or $1=0$.
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{3.10}, verify that $\det(xI-A)$ is a monic polynomial of degree $m$.
					\item Therefore using \procedurehr{3.22}, verify that $\det(B)=\det(xI-A)$.
					...
					\begin{enumerate}
						\item Using \procedurehr{3.10}, verify that $\det(B)=B_{1,1}B_{2,2}\cdots B_{m,m}=0$.
		...
		\procedure{3.36}
			\objective
				Choose a list of $\mathcal{M}_{*}(\mathbb{Q})$, $C$. Let $m=\sum_{i=1}^{\lvert C\rvert}\cols(C_i)$. The objective of the following instructions is to construct a $\mathcal{M}_{m,m}(\mathbb{Q})$, $\bdiag(C)$.
			\implementation
				\begin{enumerate}
				...
				\end{enumerate}
		\notation{3.15}
			Let us use the notation $\bdiag(C)$ as a shorthand for the result yielded by executing \procedurehr{3.36} on $C$.
		\procedure{3.37}
			\objective
				Choose a positive integer $m$ and an $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Execute \procedurehr{3.20} on the polynomial matrix $xI_m-A$ and let $\langle ,B,v,\rangle$ be the result. The objective of the following instructions is to either show that $0<0$ or to construct an integer $a$ such that $\sum_{i=a}^m\deg(B_{i,i})=m$, $\deg(B_{i,i})>0$ for $i=a$ to $i=m$, and $\deg(B_{i,i})=0$ for $i=1$ to $i=a-1$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.35} on $A$.
		...
		\procedure{3.38}
			...
			\implementation
				...
				\end{enumerate}
		\notation{3.16}
			Let us use $\rcan(p)$ as a shorthand for the result yielded by executing \procedurehr{3.38} on $p$.
		\procedure{3.39}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\item For $i=2$ going up to $i=k$, negate row $i-1$ and exchange it with row $i$ using \procedurehr{3.32}.
		...
		\procedure{3.40}
			...
			\implementation
				\begin{enumerate}
					...
					\item Rearrange the diagonal of $F$ so that $\mon(B_{i,i})$ is at the $i^{th}$ position on the diagonal for $i=a$ to $i=m$ by doing pairwise swaps. In general, swap the $i^{th}$ and $j^{th}$ diagonal entries using \procedurehr{3.33}.
					\item For $i=1$ to $i=m-1$, do the following:
					\begin{enumerate}
						\item Let $k=\frac{x^{\deg(B_{i,i})}\circ B_{i,i}}{x^{\deg(F_{i,i})}\circ F_{i,i}}$.
						\item Scale $B_{i,i}$ by $k$ and $B_{i+1,i+1}$ by $\frac{1}{k}$ using \procedurehr{3.34}.
		...
		\procedure{3.41}
			\objective
				Choose a $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Execute \procedurehr{3.37} on $A$ and let $\langle a\rangle$ receive the result. Let $E_i=\rcan(\mon(B_{a-1+i,a-1+i}))$ for $i=1$ to $i=m+1-a$. The objective of the following instructions is to either show that $0=1$ or to construct $\mathcal{M}_{m,m}(\mathbb{Q})$s $R,T$ such that $A=R\bdiag(E)T$, $RT=I_m$, and $TR=I_m$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on the polynomial matrix $xI_m-A$ and let $\langle P,B,,Q\rangle$ be the result.
					\item Verify that $P_*(xI_m-A)Q_*=B$.
					\item Verify that $xI_m-A={P^{-1}}_*B{Q^{-1}}_*$.
					\item Let $Z$ be a variant of \procedurehr{3.20} where every occurence of \procedurehr{3.09} in its instructions is replaced with \procedurehr{3.40}, and where every mention of $v$ is ignored.
					...
					\item Execute \procedurehr{3.31} on the matrices $\langle A,{P}^{-1}M,\bdiag(E),N{Q}^{-1}\rangle$. Let the tuple $\langle R,T\rangle$ be the result.
		...
		\procedure{3.43}
			...
			\implementation
				\begin{enumerate}
					\item For $i=0$ up to $i=t$, by repeated applications of \procedurehr{3.08}, verify that $\bdiag(A)^i$ evaluates to $\bdiag(A^i)$ (where the exponentiation is done element-wise).
		...
		\procedure{3.44}
			\objective
				Choose a $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$, and a $\mathbb{Q}[x]$, $r$. Execute \procedurehr{3.41} on the matrix $A$ and let the tuple $\langle R_1,E,R_3\rangle$ receive the result. The objective of the following instructions is to show that $r(A)=R_1\bdiag(r(E))R_3$ (where $r$ is applied element-wise).
			\implementation
				\begin{enumerate}
					\item Verify that $R_3R_1=I_m$.
					\item Using \procedurehr{3.42}, verify that $r(A)=r(R_1\bdiag(E)R_3)=R_1r(\bdiag(E))R_3$.
					\item Using \procedurehr{3.43}, verify that $r(\bdiag(E))=\bdiag(r(E))$ (where $r$ is applied element-wise).
		...
		\procedure{3.46}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on the polynomial matrix $xI_m-A$ and let the tuple $\langle,B,,\rangle$ receive the result.
					\item Execute \procedurehr{3.35} on $A$.
					\item Verify that $B_{m,m}\ne 0$.
					\item Yield $\langle B_{m,m}\rangle$.
				\end{enumerate}
		\notation{3.20}
			Let us use the notation $\last_A$ as a shorthand for the result of executing \procedurehr{3.46} on $A$.
		\procedure{3.47}
			\objective
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on the matrix $A$ and let the tuple $\langle M,B,v,N\rangle$ receive the result.
					\item Execute \procedurehr{3.37} on $A$ and let $\langle a\rangle$ receive.
					\item Execute \procedurehr{3.41} on $A$ and let $\langle R,E,T\rangle$ receive.
					...
					\begin{enumerate}
						...
						\item Therefore using \procedurehr{3.45} verify that $\last_A(E_j)=B_{m,m}(E_j)=B_{a-1+j,a-1+j}(\rcan(\mon(B_{a-1+j,a-1+j})))\cdot v_{a+j}(E_j)v_{a+j+1}(E_j)\cdots v_m(E_j)=0_{k\times k}v_{a+j}(E_j)v_{a+j+1}(E_j)\cdots v_m(E_j)=0_{k\times k}$.
					\end{enumerate}
					\item \textbf{Therefore using \procedurehr{3.44} verify that $\last_A(A)=R\bdiag(\last_A(E))T=R\bdiag(B_{m,m}(E))T=R0_{m\times m}T=0_{m\times m}$.}
				\end{enumerate}
		\procedure{3.48}
			\objective
		...
		\procedure{3.50}
			...
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{3.20} on $F$ and let $\langle M,D,,N\rangle$ receive the result.
					...
					\item Therefore using \procedurehr{3.45}, verify that $g(A)=N_{1,1}(A)p(A)+N_{2,1}(A)\last_A(A)=N_{1,1}(A)0_{m\times m}+N_{2,1}(A)0_{m\times m}=0_{m\times m}$.
					\item Execute \procedurehr{3.41} on the matrix $A$ and let the tuple $\langle R_1,E,R_3\rangle$ receive the result.
					\item Using \procedurehr{3.44}, and \procedurehr{3.41}, verify that $\bdiag(g(E))=I_m\bdiag(g(E))I_m=R_3R_1\bdiag(g(E))R_3R_1=R_3g(A)R_1=R_30_{m\times m}R_1=0_{m\times m}$.
					\item Let $G=\rcan(\mon(\last_A))$.
					\item Verify that $g(G)=g(E_{\lvert E\rvert})=\bdiag(g(E))_{[m-u+1:m+1],[m-u+1:m+1]}=0_{u\times u}$.
					\item If $w<u$, then:
					\begin{enumerate}
						\item Using \procedurehr{3.48}, verify that $g(G)\ne 0_{u\times u}$.
						\item \textbf{Abort procedure.}
					\end{enumerate}
					\item Otherwise, do the following:
					\begin{enumerate}
						\item Verify that $w=u$.
						\item Using \procedurehr{3.49}, verify that $g=g_0\last_A$.
		...
		\procedure{3.51}
			...
			\implementation
				...
				\end{enumerate}
		\notation{3.21}
			Let us use the notation $\pows(A)$ as a shorthand for the result yielded by executing \procedurehr{3.51} on $A$.
		\procedure{3.52}
			\objective
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Therefore verify that 0=2.
						\item \textbf{Abort procedure.}
					\end{enumerate}
				\end{enumerate}
		\procedure{3.53}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.50} on $A$ and $p$ and let $f$ receive.
		...
		\procedure{3.54}
			\objective
				Choose a $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Execute \procedurehr{3.20} on $\pows(A)$ and let the tuple $\langle M,D,,N\rangle$ receive the result. Let $t=\cols(\pows(A))$. The objective of the following instructions is to show that either $0<0$ or to show that ${C_t(D)}={C_t(D)}_{1,1}e_1\ne 0$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on $\pows(A)$ and let the tuple $\langle M,D,,N\rangle$ receive the result.
					\item Verify that $M_*\pows(A)N_*=D$.
					\item Using \procedurehr{3.05}, verify that $M^{-1}MFN=I_{m^2}FN=FN=M^{-1}D$.
					...
					\begin{enumerate}
						...
						\item Execute \procedurehr{3.52} on ${N^{-1}}_*$ and $N_*$.
						\item Therefore verify that $p\ne 0$.
						\item Execute \procedurehr{3.53} on $A$ and $p$.
						\item \textbf{Abort procedure.}
					\end{enumerate}
					\item Otherwise, do the following:
					\begin{enumerate}
						\item Execute \procedurehr{3.18} on $D,I_t,t$ and let $E$ receive.
		...
		\notation{3.24}
			Let us use the notation $\lVert A\rVert^2$ as a shorthand for "$\sum_{i=1}^{\rows(A)}\sum_{j=1}^{\cols(A)}{A_{i,j}}^2$".
		\procedure{3.56}
			\objective
			...
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{3.26} and \procedurehr{3.55}, verify that $C_t(\pows(A)^T\pows(A))=C_t(\pows(A)^T)C_t(\pows(A))={C_t(\pows(A))}^TC_t(\pows(A))=\lVert C_t(\pows(A))\rVert^2>0$.
				...
				\end{enumerate}
		\notation{3.25}
			Let us use the notation $\sel_A$ as a shorthand for the result yielded by executing \procedurehr{3.56} on $A$.
		\notation{3.26}
		...
		\procedure{3.58}
			...
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{3.57} and \procedurehr{3.56}, verify that $\tr(u(A)\sel_A(A))$
					\begin{enumerate}
		...
		\procedure{3.59}
			...
			\implementation
				\begin{enumerate}
					...
					\item Execute \procedurehr{3.20} on $G$ and let the tuple $\langle M,D,,N\rangle$ receive.
					...
					\begin{enumerate}
						...
						\item Execute \procedurehr{3.58} on $A$ and $u$.
			...
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\item Execute \procedurehr{3.61} on $s,q,k+1$ and let the tuple $\langle g_1,h_1\rangle$ receive.
						\item Verify that $s_{k+1}=g_1s_{m-1}+h_1s_m$.
						\item Verify that $\deg(g_1)=m-1-(k+1)=m-k-2$.
						\item Verify that $\deg(h_1)=m-2-(k+1)=m-k-3$.
						\item Execute \procedurehr{3.61} on $s,q,k+2$ and let the tuple $\langle g_2,h_2\rangle$ receive.
		...
		\procedure{3.62}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.59} on $A$ and let $\langle u,s_{t+1}\rangle$ receive the result.
					\item Verify that $us_t+s_{t+1}\sel_A=1$.
					\item Execute \procedurehr{3.60} on the tuple $\langle s_{t+1},s_t\rangle$. Let the tuple $\langle q_t,s_{t-1}\rangle$ receive the result.
					...
					\item Therefore using \procedurehr{3.58}, verify that $\frac{x^{t-1}\circ s_{t-1}}{x^t\circ s_t}=\tr(s_{t-1}(A)\sel_A(A))=\tr(I_{m,m})=m>0$.
					\item For $i=t-1$ down to $i=1$, do the following:
					\begin{enumerate}
						\item Execute \procedurehr{3.60} on the tuple $\langle -s_{i+1},-s_i\rangle$. Let the tuple $\langle q_i,s_{i-1}\rangle$ receive the result.
						...
						\item Therefore verify that $q_is_i-s_{i+1}=s_{i-1}$.
						\item Execute \procedurehr{3.61} on the tuple $\langle s,q,i-1\rangle$ and let $\langle p,j\rangle$ receive.
		...
		\procedure{3.63}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.62} on the matrix $A$ and let the tuple $\langle s,q\rangle$ receive the result.
		...
		\procedure{3.64}
			\objective
				Choose a symmetric $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Let $t=\deg(\last_A)$. Execute \procedurehr{3.63} on $A$ and let the tuple $\langle c,d\rangle$ receive the result. Execute \procedurehr{3.20} on $A$ and let the tuple $\langle,,u,\rangle$ receive the result. The objective of the following instructions is to either show that $1=-1$ or to construct a list of non-negative integers $k$ such that $\sgn(u_{k_i}(c_i))=-\sgn(u_{k_i}(d_i))$ for $i=1$ to $i=t$.
			\implementation
				\begin{enumerate}
					...
					\begin{enumerate}
						...
						\begin{enumerate}
							...
							\item Cognizant of the execution of \procedurehr{2.08}, verify that $\sgn(s_t(c_i))=-\sgn(s_t(d_i))$.
		...
		\procedure{3.67}
			...
			\implementation
				\begin{enumerate}
					\item Using \procedurehr{3.10}, verify that $C_n(M_0A_0)=C_n(I_n)=1$.
					...
					\begin{enumerate}
						...
						\item Using \procedurehr{3.10}, verify that $C_n(N_i)=1\ne 0$.
		...
		\procedure{3.68}
			\objective
				Choose integers $m\ge n\ge 0$. Choose a $\mathcal{M}_{n,m}(\mathbb{Q}[x])$, $M$, and a $\mathcal{M}_{m,n}(\mathbb{Q}[x])$, $A_0$, such that $MA_0=I_n$. Execute \procedurehr{3.67} on $M$ and $A_0$ and let the tuple $\langle A_1,\cdots,A_n\rangle$ receive the result. The objective of the following instructions is to either show that $1=0$ or to show that $({A_i}^TA_i)_{[1:i+1],[1:i+1]}$ is a $\mathcal{D}_{i,i}(\mathbb{Q}[x])$ and ${A_i}^TA_i=\bdiag(({A_i}^TA_i)_{[1:i+1],[1:i+1]},({A_i}^TA_i)_{[i+1:n+1],[i+1:n+1]})$ for $i=1$ to $i=n$.
			\implementation
				\begin{enumerate}
					\item For $i=1$ to $i=n$, do the following:
					\begin{enumerate}
						...
						\item Now using \procedurehr{3.08}, verify that ${A_i}^TA_i$ and ${A_{i-1}}^TA_{i-1}$ are the same modulo the bottom-right $(n-i+1)\times(n-i+1)$ block.
		...
		\procedure{3.71}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.67} on $M$ and $A_0$ and let the tuple $\langle A_0,A_1,\cdots,A_n\rangle$ receive the result.
					\item Let $i=n$.
					...
					\end{enumerate}
					\item Otherwise, do the following:
					\item Using \procedurehr{3.69}, verify that $(1\lVert A_0e_1\rVert^2\cdots\lVert A_{\min(i,j-1)-1}e_{\min(i,j-1)}\rVert^2)^2=({e_j}^TM(x)A_i(x)e_j)^2<\frac{1}{a^{(2i)!!*2i}}\le 1$.
		...
		\procedure{3.72}
			\objective
				Choose a symmetric $\mathcal{M}_{m,m}(\mathbb{Q})$, $A$. Execute \procedurehr{3.64} on the matrix $A$ and let the tuple $\langle k\rangle$ receive the result. The objective of the following instructions is to either show that $0<0$ or to show that $\sum_{i=1}^t(m+1-k_i)=m$.
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.20} on the matrix $A$ and let the tuple $\langle,D,u,\rangle$.
					\item Using \procedurehr{3.65}, verify that $\sum_{i=1}^t(m+1-k_i)$
					\begin{enumerate}
		...
		\procedure{3.73}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.63} on the matrix $A$ and let the tuple $\langle c,d\rangle$ receive the result.
				...
				\end{enumerate}
		\notation{3.30}
			Let us use the notation $\disc(A)$ to refer to the result yielded by executing \procedurehr{3.73} on the matrix $A$.
		\procedure{3.74}
			\objective
		...
		\procedure{3.75}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.63} on the matrix $A$ and let the tuple $\langle c,d\rangle$ receive the result.
					\item Execute \procedurehr{3.20} with $xI_m-A$ as the choice matrix. Let the tuple $\langle M,D,u,N\rangle$ receive the result.
					...
					\item Execute \procedurehr{3.74} on $\langle k,m,N\rangle$ and let the tuple $\langle\langle K_1,E_1\rangle,\langle K_2,E_2\rangle,\cdots,\langle K_{\lvert k\rvert},E_{\lvert k\rvert}\rangle\rangle$ receive.
					\item \textbf{Using \procedurehr{3.72}, verify that $\sum_{p=1}^{\lvert k\rvert}\cols(K_p)=\sum_{p=1}^{\lvert k\rvert} m+1-k_p=m$.}
					...
					\begin{enumerate}
						...
						\item Execute \procedurehr{2.02} on the formal polynomial $u_{k_i}$, interval $(c_i, d_i)$, and target of $\frac{b}{U'}$. Let $\langle g_i\rangle$ receive the result.
		...
		\procedure{3.76}
			...
			\implementation
				\begin{enumerate}
					\item Execute \procedurehr{3.75} on matrix $A$ and rational $\epsilon$. Let the tuple $\langle\delta,K',K,g\rangle$ receive the result.
